...
As you may note, this is different from the usual Lifecycles from MLOps. LLMs have many new reqtestsuirements, as Prompting, different techniques to improve quality (Fine-Tuning, RAG, Meta-Prompts), different assessment and responsability with responsible AI, lastly, new evaluation metrics (Quality, Harm, Honesty, Cost and Latency).
