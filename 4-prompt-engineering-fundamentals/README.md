...
1. Describe the components of a prompt and how they are used.
1. Learn best practices and techniques for prompt engineering.
1. Apply learned techniques to real examples, using an OpenAI endpoint.
