...
[![画像生成アプリケーションの構築](../../images/09-lesson-banner.png)](TBD)
...
![Edu4Allスタートアップ、モニュメントに関する授業、エッフェル塔](../../images/startup.png)
...
[DALL-E](https://openai.com/dall-e-2)と[Midjourney](https://www.midjourney.com/)は、最もポピュラーな画像生成モデルの2つで、プロンプトを使って画像を生成することができます。

### DALL-E

DALL-Eから始めましょう。DALL-Eは、テキスト記述から画像を生成する生成AIモデルです。

> [DALL-EはCLIPとdiffused attentionという2つのモデルの組み合わせです](https://towardsdatascience.com/openais-dall-e-and-clip-101-a-brief-introduction-3a4367280d4e)。 
...
まず、[DALL-E](https://arxiv.org/pdf/2102.12092.pdf)。DALL-E は、*自己回帰変換器* を用いた変換器アーキテクチャに基づく生成 AI モデルです。 
...
![ロリポップを持った馬上のウサギ、バージョン1](../../images/v1-generated-image.png)

同じ画像が2度表示されないことを確認するために、同じプロンプトを実行してみよう：

![馬に乗ったウサギの生成画像](../../images/v2-generated-image.png)
...
レッスン10では、[ローコードでAIアプリケーションを構築する](../../../10-building-low-code-ai-applications/translations/ja/README.md)方法を見ていきます。
