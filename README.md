...
1. **Visit Azure Portal:**
   Go to the [Azure portal](https://portal.azure.com/?utm_source=example_source&utm_medium=example_medium&utm_campaign=example_campaign).
...
- **Azure Documentation:** For more detailed information, refer to the [Azure OpenAI Service documentation](https://learn.microsoft.com/azure/ai-services/openai/?utm_source=example_source&utm_medium=example_medium&utm_campaign=example_campaign).
