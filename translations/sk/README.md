...
### 21 lekcií, ktoré vás naučia všetko, čo potrebujete vedieť na začatie tvorby aplikácií Generatívnej AI
...
[![GitHub rozvety](https://img.shields.io/github/forks/microsoft/Generative-AI-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/Generative-AI-For-Beginners/network/?WT.mc_id=academic-105485-koreyst)
[![GitHub hviezdy](https://img.shields.io/github/stars/microsoft/Generative-AI-For-Beginners.svg?style=social&label=Star)](https://GitHub.com/microsoft/Generative-AI-For-Beginners/stargazers/?WT.mc_id=academic-105485-koreyst)
...
Naučte sa základy tvorby aplikácií Generatívnej AI s naším komplexným kurzom pozostávajúcim z 21 lekcií od Microsoft Cloud Advocates.

## 🌱 Začíname

Tento kurz obsahuje 21 lekcií. Každá lekcia pokrýva vlastnú tému, takže začnite kdekoľvek chcete!

Lekcie sú označené buď ako "Learn" — lekcie vysvetľujúce koncept Generatívnej AI, alebo "Build" — lekcie, ktoré vysvetľujú koncept a príklady kódu v **Pythone** a **TypeScripte**, ak je to možné.

Pre .NET vývojárov odporúčame [Generatívnu AI pre začiatočníkov (.NET edícia)](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)!

Každá lekcia tiež obsahuje sekciu "Keep Learning" s ďalšími vzdelávacími nástrojmi.
...
- Základné znalosti Pythonu alebo TypeScriptu sú užitočné - \*Pre úplných začiatočníkov skúste tieto [Python](https://aka.ms/genai-beginners/python?WT.mc_id=academic-105485-koreyst) a [TypeScript](https://aka.ms/genai-beginners/typescript?WT.mc_id=academic-105485-koreyst) kurzy
- GitHub účet na [forknutie celého tohto repozitára](https://aka.ms/genai-beginners/github?WT.mc_id=academic-105485-koreyst) do vášho vlastného GitHub účtu

Vytvorili sme lekciu **[Nastavenie kurzu](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)**, ktorá vám pomôže s nastavením vývojového prostredia.

Nezabudnite [označiť tento repozitár hviezdičkou (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst), aby ste ho neskôr ľahšie našli.
...
Pridajte sa na náš [oficiálny Discord Azure AI Foundry](https://aka.ms/genai-discord?WT.mc_id=academic-105485-koreyst), kde sa môžete stretnúť a spojiť s ostatnými študentmi tohto kurzu a získať podporu.
...
Navštívte [Microsoft for Startups](https://www.microsoft.com/startups) a zistite, ako začať používaním Azure kreditov už dnes.

## 🙏 Chcete pomôcť?

Máte návrhy alebo ste našli pravopisné či programátorské chyby? [Nahláste problém](https://github.com/microsoft/generative-ai-for-beginners/issues?WT.mc_id=academic-105485-koreyst) alebo [vytvorte pull request](https://github.com/microsoft/generative-ai-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Odkazy na doplnkové zdroje na pokračovanie vo vzdelávaní

## 🗃️ Lekcie

| #   | **Odkaz na lekciu**                                                                                                                          | **Popis**                                                                                     | **Video**                                                                   | **Doplnkové učenie**                                                           |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 00  | [Nastavenie kurzu](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **Naučte sa:** Ako nastaviť svoje vývojové prostredie                                        | Video čoskoro                                                                | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 01  | [Úvod do Generatívnej AI a veľkých jazykových modelov (LLMs)](./01-introduction-to-genai/README.md?WT.mc_id=academic-105485-koreyst)            | **Naučte sa:** Pochopenie čo je Generatívna AI a ako fungujú veľké jazykové modely (LLMs).    | [Video](https://aka.ms/gen-ai-lesson-1-gh?WT.mc_id=academic-105485-koreyst) | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 02  | [Preskúmanie a porovnanie rôznych veľkých jazykových modelov (LLMs)](./02-exploring-and-comparing-different-llms/README.md?WT.mc_id=academic-105485-koreyst) | **Naučte sa:** Ako vybrať správny model pre váš prípad použitia                              | [Video](https://aka.ms/gen-ai-lesson2-gh?WT.mc_id=academic-105485-koreyst)  | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 03  | [Používanie Generatívnej AI zodpovedne](./03-using-generative-ai-responsibly/README.md?WT.mc_id=academic-105485-koreyst)                        | **Naučte sa:** Ako zodpovedne tvoriť aplikácie generatívnej AI                               | [Video](https://aka.ms/gen-ai-lesson3-gh?WT.mc_id=academic-105485-koreyst)  | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 04  | [Pochopenie základov prompt engineering](./04-prompt-engineering-fundamentals/README.md?WT.mc_id=academic-105485-koreyst)             | **Naučte sa:** Praktické osvedčené postupy v prompt engineeringu                                    | [Video](https://aka.ms/gen-ai-lesson4-gh?WT.mc_id=academic-105485-koreyst)  | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 05  | [Tvorba pokročilých promptov](./05-advanced-prompts/README.md?WT.mc_id=academic-105485-koreyst)                                                | **Naučte sa:** Ako aplikovať techniky prompt engineeringu, ktoré zlepšujú výsledky vašich promptov | [Video](https://aka.ms/gen-ai-lesson5-gh?WT.mc_id=academic-105485-koreyst)  | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 13  | [Zabezpečenie vašich generatívnych AI aplikácií](./13-securing-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                     | **Naučte sa:** Hrozby a riziká pre AI systémy a metódy zabezpečenia týchto systémov              | [Video](https://aka.ms/gen-ai-lesson13-gh?WT.mc_id=academic-105485-koreyst) | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 14  | [Životný cyklus generatívnej AI aplikácie](./14-the-generative-ai-application-lifecycle/README.md?WT.mc_id=academic-105485-koreyst)             | **Naučte sa:** Nástroje a metriky na správu životného cyklu LLM a LLMOps                        | [Video](https://aka.ms/gen-ai-lesson14-gh?WT.mc_id=academic-105485-koreyst) | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 15  | [Retrieval Augmented Generation (RAG) a vektorové databázy](./15-rag-and-vector-databases/README.md?WT.mc_id=academic-105485-koreyst)           | **Vytvorte:** Aplikáciu využívajúcu rámec RAG na vyhľadávanie embeddings vo vektorových databázach | [Video](https://aka.ms/gen-ai-lesson15-gh?WT.mc_id=academic-105485-koreyst) | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 18  | [Ladenie LLM](./18-fine-tuning/README.md?WT.mc_id=academic-105485-koreyst)                                                                     | **Naučte sa:** Čo, prečo a ako doladiť LLM                                                   | [Video](https://aka.ms/gen-ai-lesson18-gh?WT.mc_id=academic-105485-koreyst) | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 19  | [Tvorba s malými jazykovými modelmi](./19-slm/README.md?WT.mc_id=academic-105485-koreyst)                                                       | **Naučte sa:** Výhody tvorby s malými jazykovými modelmi                                     | Video čoskoro | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 20  | [Tvorba s Mistral modelmi](./20-mistral/README.md?WT.mc_id=academic-105485-koreyst)                                                            | **Naučte sa:** Funkcie a rozdiely modelov rodiny Mistral                                      | Video čoskoro | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 21  | [Tvorba s Meta modelmi](./21-meta/README.md?WT.mc_id=academic-105485-koreyst)                                                                  | **Naučte sa:** Funkcie a rozdiely modelov rodiny Meta                                        | Video čoskoro | [Viac informácií](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
[**Bernhardovi Merkleovi**](https://www.linkedin.com/in/bernhard-merkle-738b73/) za kľúčové príspevky ku každej lekcii, ktoré zlepšili skúsenosť študentov a kvalitu kódu. 
...
Ak sa zaseknete alebo máte akékoľvek otázky ohľadom tvorby AI aplikácií, pripojte sa k ostatným študentom a skúseným vývojárom v diskusiách o MCP. Je to podporujúca komunita, kde sú otázky vítané a znalosti sa zdieľajú slobodne.
