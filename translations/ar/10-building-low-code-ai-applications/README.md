...
[![بناء تطبيقات الذكاء الاصطناعي منخفضة الكود](../../../translated_images/ar/10-lesson-banner.a01ac8fe3fd86310.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![وصف التطبيق الذي تريد بناءه](../../../translated_images/ar/copilot-chat-prompt-powerapps.84250f341d060830.png)
...
1. سيقترح مساعد الذكاء الاصطناعي Copilot جدول Dataverse مع الحقول التي تحتاجها لتخزين البيانات التي تريد تتبعها وبعض البيانات النموذجية. يمكنك بعد ذلك تخصيص الجدول لتلبية احتياجاتك باستخدام ميزة مساعد الذكاء الاصطناعي Copilot من خلال خطوات حوارية.
   ...
   ![الحقول المقترحة في الجدول الجديد](../../../translated_images/ar/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.png)
...
![إضافة حقل جديد](../../../translated_images/ar/copilot-new-column.35e15ff21acaf274.png)
...
![إضافة شاشة جديدة عبر تعليمات نصية](../../../translated_images/ar/copilot-new-screen.2e0bef7132a17392.png)
...
![اختيار جدول جديد](../../../translated_images/ar/describe-new-table.0792373eb757281e.png)
...
![وصف الجدول](../../../translated_images/ar/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.png)
...
![جدول Dataverse المقترح](../../../translated_images/ar/copilot-dataverse-table.b3bc936091324d9d.png)
...
![نماذج AI Builder](../../../translated_images/ar/ai-builder-models.8069423b84cfc47f.png)
...
2. استخدم منطقة النص في الشاشة الرئيسية لوصف سير العمل الذي تريد بناءه. على سبيل المثال، **_معالجة فاتورة عند وصولها إلى صندوق البريد الخاص بي_**. انقر على زر **إرسال** لإرسال الطلب إلى AI Copilot.
   ...
   ![Copilot في Power Automate](../../../translated_images/ar/copilot-chat-prompt-powerautomate.f377e478cc8412de.png)
...
8. قم بإزالة إجراء **الشرط** من التدفق لأنك لن تستخدمه. يجب أن يبدو كما في لقطة الشاشة التالية:
   ...
   ![Power Automate، إزالة الإجراءات](../../../translated_images/ar/powerautomate-remove-actions.7216392fe684ceba.png)
...
11. اختر الجدول الذي أنشأته سابقًا. على سبيل المثال، يمكنك اختيار جدول **معلومات الفاتورة**. اختر المحتوى الديناميكي من الإجراء السابق لملء الحقول التالية:
    ...
    ![Power Automate، إضافة صف](../../../translated_images/ar/powerautomate-add-row.5edce45e5dd3d51e.png)
...
![إنشاء طلب](../../../translated_images/ar/create-prompt-gpt.69d429300c2e870a.png)
