...
[![مقدمة إلى الذكاء الاصطناعي التوليدي ونماذج اللغة الكبيرة](../../../translated_images/ar/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![خمسة طلاب شباب ينظرون إلى شاشة - صورة بواسطة DALLE2](../../../translated_images/ar/students-by-DALLE2.b70fddaced1042ee.png)
...
![الذكاء الاصطناعي، التعلم الآلي، التعلم العميق والذكاء الاصطناعي التوليدي](../../../translated_images/ar/AI-diagram.c391fa518451a40d.png)
...
![مثال على التجزئة](../../../translated_images/ar/tokenizer-example.80a5c151ee7d1bd4.png)
...
- **تعليمات** تحدد نوع المخرج الذي نتوقعه من النموذج. قد تتضمن هذه التعليمات أحيانًا بعض الأمثلة أو بيانات إضافية.
  ...
  1. تلخيص مقال، كتاب، مراجعات منتجات وأكثر، مع استخراج الأفكار من البيانات غير المنظمة.
    ...
    ![مثال على التلخيص](../../../translated_images/ar/summarization-example.7b7ff97147b3d790.png)
  
  2. توليد أفكار إبداعية وتصميم مقال، مقال، مهمة أو أكثر.
      
     ![مثال على الكتابة الإبداعية](../../../translated_images/ar/creative-writing-example.e24a685b5a543ad1.png)

- **سؤال** يُطرح في شكل محادثة مع وكيل.
  
  ![مثال على المحادثة](../../../translated_images/ar/conversation-example.60c2afc0f595fa59.png)

- جزء من **النص لإكماله**، وهو طلب ضمني للحصول على مساعدة في الكتابة.
  
  ![مثال على إكمال النص](../../../translated_images/ar/text-completion-example.cbb0f28403d42752.png)

- جزء من **الكود** مع طلب شرحه وتوثيقه، أو تعليق يطلب توليد قطعة كود تؤدي مهمة معينة.
  
  ![مثال على البرمجة](../../../translated_images/ar/coding-example.50ebabe8a6afff20.png)
