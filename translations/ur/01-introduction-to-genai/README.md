...
[![جنریٹو اے آئی اور بڑے لینگویج ماڈلز کا تعارف](../../../translated_images/ur/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![پانچ نوجوان طلباء ایک مانیٹر کو دیکھ رہے ہیں - تصویر DALLE2 کے ذریعے](../../../translated_images/ur/students-by-DALLE2.b70fddaced1042ee.png)
...
![اے آئی، ایم ایل، ڈی ایل اور جنریٹو اے آئی](../../../translated_images/ur/AI-diagram.c391fa518451a40d.png)
...
![ٹوکینائزیشن کی مثال](../../../translated_images/ur/tokenizer-example.80a5c151ee7d1bd4.png)
...
- ایک **ہدایات** جو ماڈل سے متوقع آؤٹپٹ کی قسم کی وضاحت کرتی ہے۔ یہ ہدایات کبھی کبھار کچھ مثالیں یا کچھ اضافی ڈیٹا شامل کر سکتی ہیں۔
  ...
  1. کسی مضمون، کتاب، پروڈکٹ کے جائزے وغیرہ کا خلاصہ، ساتھ ہی غیر ساختہ ڈیٹا سے بصیرت نکالنا۔
    ...
    ![خلاصہ کی مثال](../../../translated_images/ur/summarization-example.7b7ff97147b3d790.png)
  
  2. کسی مضمون، مضمون، اسائنمنٹ یا مزید کے تخلیقی خیالات اور ڈیزائن۔
      
     ![تخلیقی تحریر کی مثال](../../../translated_images/ur/creative-writing-example.e24a685b5a543ad1.png)

- ایک **سوال**، جو کسی ایجنٹ کے ساتھ گفتگو کی شکل میں پوچھا گیا ہو۔
  
  ![گفتگو کی مثال](../../../translated_images/ur/conversation-example.60c2afc0f595fa59.png)

- ایک **متن کا حصہ مکمل کرنا**، جو بالواسطہ طور پر تحریری مدد کی درخواست ہے۔
  
  ![متن مکمل کرنے کی مثال](../../../translated_images/ur/text-completion-example.cbb0f28403d42752.png)
...
- ایک **کوڈ کا حصہ**، ساتھ ہی اس کی وضاحت اور دستاویزات کی درخواست، یا ایک تبصرہ جو کسی مخصوص کام کو انجام دینے والے کوڈ کے ٹکڑے کو تیار کرنے کی درخواست کرتا ہے۔
  ...
  ![کوڈنگ کی مثال](../../../translated_images/ur/coding-example.50ebabe8a6afff20.png)
