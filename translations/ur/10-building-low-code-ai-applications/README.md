...
[![کم کوڈ اے آئی ایپلیکیشنز بنانا](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.ur.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![ایپ کو بیان کریں جو آپ بنانا چاہتے ہیں](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.ur.png)
...
1. اے آئی کوپائلٹ آپ کے ڈیٹا کو ٹریک کرنے کے لیے درکار فیلڈز کے ساتھ ایک ڈیٹا ورس ٹیبل تجویز کرے گا اور کچھ نمونہ ڈیٹا فراہم کرے گا۔ آپ پھر گفتگو کے مراحل کے ذریعے اے آئی کوپائلٹ اسسٹنٹ فیچر کا استعمال کرتے ہوئے ٹیبل کو اپنی ضروریات کے مطابق حسب ضرورت بنا سکتے ہیں۔
   ...
   ![آپ کے نئے ٹیبل میں تجویز کردہ فیلڈز](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.ur.png)
...
![ایک نیا فیلڈ شامل کرنا](../../../translated_images/copilot-new-column.35e15ff21acaf274.ur.png)
...
![پرامپٹ ہدایت کے ذریعے ایک نیا اسکرین شامل کرنا](../../../translated_images/copilot-new-screen.2e0bef7132a17392.ur.png)
...
![نیا ٹیبل منتخب کریں](../../../translated_images/describe-new-table.0792373eb757281e.ur.png)
...
![ٹیبل بیان کریں](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.ur.png)
...
![تجویز کردہ ڈیٹا ورس ٹیبل](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.ur.png)
...
![AI بلڈر ماڈلز](../../../translated_images/ai-builder-models.8069423b84cfc47f.ur.png)
...
2. ہوم اسکرین پر ٹیکسٹ ایریا استعمال کریں تاکہ اس ورک فلو کو بیان کریں جو آپ بنانا چاہتے ہیں۔ مثال کے طور پر، **_جب انوائس میرے میل باکس میں آئے تو اسے پروسیس کریں_**۔ **Send** بٹن پر کلک کریں تاکہ پرامپٹ کو AI کوپائلٹ کو بھیجا جا سکے۔
   ...
   ![کوپائلٹ پاور آٹومیٹ](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.ur.png)
...
8. فلو سے **Condition** ایکشن کو ہٹا دیں کیونکہ آپ اسے استعمال نہیں کریں گے۔ یہ درج ذیل اسکرین شاٹ کی طرح نظر آنا چاہیے:
   ...
   ![پاور آٹومیٹ، ایکشنز ہٹائیں](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.ur.png)
...
11. وہ **Table** منتخب کریں جو آپ نے پہلے بنایا تھا۔ مثال کے طور پر، آپ **Invoice Information** ٹیبل منتخب کر سکتے ہیں۔ پچھلے ایکشن سے ڈائنامک مواد کا استعمال کرتے ہوئے درج ذیل فیلڈز کو پُر کریں:
    ...
    ![پاور آٹومیٹ نیا رو شامل کریں](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.ur.png)
...
![پرامپٹ بنائیں](../../../translated_images/create-prompt-gpt.69d429300c2e870a.ur.png)
