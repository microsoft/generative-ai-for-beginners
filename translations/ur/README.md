...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:31:43+00:00",
...
یہ کورس 21 اسباق پر مشتمل ہے۔ ہر سبق ایک منفرد موضوع کا احاطہ کرتا ہے، لہذا جہاں سے چاہیں شروع کریں!

اسباق کو "Learn" کے طور پر لیبل کیا گیا ہے جو جنریٹو اے آئی کے تصور کی وضاحت کرتے ہیں یا "Build" کے طور پر جو تصور اور کوڈ کے نمونے Python اور TypeScript میں فراہم کرتے ہیں، جہاں ممکن ہو۔
...
- Python اور TypeScript کوڈ نمونے جو Azure OpenAI اور OpenAI API کو سپورٹ کرتے ہیں
...
| 15  | [ریٹریول آگمینٹڈ جنریشن (RAG) اور ویکٹر ڈیٹا بیس](./15-rag-and-vector-databases/README.md?WT.mc_id=academic-105485-koreyst)        | **بنائیں:** ایک ایپلیکیشن جو RAG فریم ورک کا استعمال کرتے ہوئے ویکٹر ڈیٹا بیس سے ایمبیڈنگز کو ریٹریو کرتی ہے  | [ویڈیو](https://aka.ms/gen-ai-lesson15-gh?WT.mc_id=academic-105485-koreyst) | [مزید جانیں](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
اگر آپ کو پروڈکٹ کے بارے میں فیڈبیک دینا ہو یا ایپلیکیشن بنانے کے دوران کوئی غلطی ہو تو وزٹ کریں:
