...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-12T08:10:38+00:00",
...
اگر آپ مزید جدید کوڈ نمونوں کی تلاش میں ہیں، تو ہمارے [جنریٹو اے آئی کوڈ نمونوں کا مجموعہ](https://aka.ms/genai-beg-code?WT.mc_id=academic-105485-koreyst) دیکھیں جو Python اور TypeScript دونوں میں دستیاب ہیں۔

## 🗣️ دیگر سیکھنے والوں سے ملیں، مدد حاصل کریں

ہمارے [آفیشل Azure AI Foundry Discord سرور](https://aka.ms/genai-discord?WT.mc_id=academic-105485-koreyst) میں شامل ہوں تاکہ اس کورس کو لینے والے دیگر سیکھنے والوں سے ملاقات کریں اور نیٹ ورکنگ کریں۔

ہمارے [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum) پر GitHub میں سوالات پوچھیں یا پروڈکٹ کے بارے میں رائے دیں۔
...
| 02  | [مختلف LLMs کا جائزہ اور موازنہ](./02-exploring-and-comparing-different-llms/README.md?WT.mc_id=academic-105485-koreyst)             | **سیکھیں:** اپنے استعمال کے کیس کے لیے صحیح ماڈل کا انتخاب کیسے کریں                                      | [ویڈیو](https://aka.ms/gen-ai-lesson2-gh?WT.mc_id=academic-105485-koreyst)  | [مزید سیکھیں](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 05  | [ایڈوانسڈ پرامپٹس بنانا](./05-advanced-prompts/README.md?WT.mc_id=academic-105485-koreyst)                                                | **سیکھیں:** پرامپٹ انجینئرنگ تکنیکوں کا اطلاق کیسے کریں جو آپ کے پرامپٹس کے نتائج کو بہتر بناتی ہیں۔ | [ویڈیو](https://aka.ms/gen-ai-lesson5-gh?WT.mc_id=academic-105485-koreyst)  | [مزید جانیں](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 08  | [سرچ ایپلیکیشنز بنانا وییکٹر ڈیٹابیسز کے ساتھ](./08-building-search-applications/README.md?WT.mc_id=academic-105485-koreyst)                        | **بنائیں:** ایک سرچ ایپلیکیشن جو ڈیٹا کی تلاش کے لیے ایمبیڈنگز کا استعمال کرتی ہے۔                        | [ویڈیو](https://aka.ms/gen-ai-lesson8-gh?WT.mc_id=academic-105485-koreyst)  | [مزید جانیں](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 12  | [AI ایپلیکیشنز کے لیے UX ڈیزائن کرنا](./12-designing-ux-for-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                         | **سیکھیں:** جنریٹو AI ایپلیکیشنز تیار کرتے وقت UX ڈیزائن اصولوں کا اطلاق کیسے کریں۔         | [ویڈیو](https://aka.ms/gen-ai-lesson12-gh?WT.mc_id=academic-105485-koreyst) | [مزید جانیں](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 15  | [ریٹریول آگمینٹڈ جنریشن (RAG) اور وییکٹر ڈیٹابیسز](./15-rag-and-vector-databases/README.md?WT.mc_id=academic-105485-koreyst)        | **بنائیں:** ایک ایپلیکیشن جو RAG فریم ورک کا استعمال کرتے ہوئے وییکٹر ڈیٹابیسز سے ایمبیڈنگز کو ریٹریو کرتی ہے۔  | [ویڈیو](https://aka.ms/gen-ai-lesson15-gh?WT.mc_id=academic-105485-koreyst) | [مزید جانیں](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
خصوصی شکریہ [**جان عزیز**](https://www.linkedin.com/in/john0isaac/) جنہوں نے تمام GitHub ایکشنز اور ورک فلو بنائے۔

[**برنہارڈ مرکل**](https://www.linkedin.com/in/bernhard-merkle-738b73/) جنہوں نے ہر سبق میں اہم تعاون کیا تاکہ سیکھنے والے اور کوڈ کے تجربے کو بہتر بنایا جا سکے۔
