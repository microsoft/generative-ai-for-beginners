...
1. AI Copilot 會建議一個包含所需欄位的 Dataverse 表格，用於存儲您希望追蹤的數據以及一些範例數據。您可以透過對話步驟使用 AI Copilot 助理功能來自訂表格。
   ...
   ![新表格中的建議欄位](../../../translated_images/zh-MO/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.webp)
...
![透過提示指令新增畫面](../../../translated_images/zh-MO/copilot-new-screen.2e0bef7132a17392.webp)
...
![選擇新表](../../../translated_images/zh-MO/describe-new-table.0792373eb757281e.webp)

3. 在 **Describe the new Table** 屏幕上，使用文本區域描述您想要創建的表。例如，**_我想創建一個表來存儲發票信息_**。點擊 **Send** 按鈕將提示發送給 AI Copilot。

![描述表](../../../translated_images/zh-MO/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.webp)

4. AI Copilot 會建議一個包含您需要的字段的 Dataverse 表以及一些示例數據。然後您可以使用 AI Copilot 助手功能通過對話步驟自定義表。

![建議的 Dataverse 表](../../../translated_images/zh-MO/copilot-dataverse-table.b3bc936091324d9d.webp)
...
![AI Builder 模型](../../../translated_images/zh-MO/ai-builder-models.8069423b84cfc47f.webp)
...
8. 從流程中移除 **Condition** 操作，因為您不會使用它。流程應如下圖所示：
   ...
   ![Power Automate，移除操作](../../../translated_images/zh-MO/powerautomate-remove-actions.7216392fe684ceba.webp)
...
11. 選擇您之前創建的 **Table**。例如，您可以選擇 **Invoice Information** 表。從之前的操作中選擇動態內容來填充以下字段：
    ...
    ![Power Automate 添加行](../../../translated_images/zh-MO/powerautomate-add-row.5edce45e5dd3d51e.webp)
...
![創建提示](../../../translated_images/zh-MO/create-prompt-gpt.69d429300c2e870a.webp)
