...
[![ജനറേറ്റീവ് എഐയും വലിയ ഭാഷാ മോഡലുകളും പരിചയം](../../../translated_images/01-lesson-banner.2424cfd092f43366.ml.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![അഞ്ചു യുവ വിദ്യാർത്ഥികൾ മോണിറ്റർ നോക്കുന്നു - DALLE2 ചിത്രീകരണം](../../../translated_images/students-by-DALLE2.b70fddaced1042ee.ml.png)
...
![എഐ, എംഎൽ, ഡിഎൽ, ജനറേറ്റീവ് എഐ](../../../translated_images/AI-diagram.c391fa518451a40d.ml.png)
...
![ടോക്കനൈസേഷന്റെ ഉദാഹരണം](../../../translated_images/tokenizer-example.80a5c151ee7d1bd4.ml.png)
...
- മോഡലിൽ നിന്നു പ്രതീക്ഷിക്കുന്ന ഔട്ട്പുട്ടിന്റെ തരം വ്യക്തമാക്കുന്ന **നിർദ്ദേശം**. ചിലപ്പോൾ ഈ നിർദ്ദേശം ഉദാഹരണങ്ങൾ അല്ലെങ്കിൽ അധിക ഡാറ്റ ഉൾക്കൊള്ളാം.
  ...
  1. ലേഖനം, പുസ്തകം, ഉൽപ്പന്ന അവലോകനങ്ങൾ എന്നിവയുടെ സംഗ്രഹം, അസംഘടിത ഡാറ്റയിൽ നിന്നുള്ള洞察ങ്ങൾ എടുക്കൽ.
    ...
    ![സംഗ്രഹത്തിന്റെ ഉദാഹരണം](../../../translated_images/summarization-example.7b7ff97147b3d790.ml.png)
  
  2. ലേഖനം, പ്രബന്ധം, അസൈൻമെന്റ് എന്നിവയുടെ സൃഷ്ടിപരമായ ആശയവിനിമയം, രൂപകൽപ്പന.
      
     ![സൃഷ്ടിപരമായ എഴുത്തിന്റെ ഉദാഹരണം](../../../translated_images/creative-writing-example.e24a685b5a543ad1.ml.png)

- ഏജന്റുമായി സംഭാഷണ രൂപത്തിൽ ചോദിക്കുന്ന **ചോദ്യം**.
  
  ![സംഭാഷണത്തിന്റെ ഉദാഹരണം](../../../translated_images/conversation-example.60c2afc0f595fa59.ml.png)

- എഴുതേണ്ട **ടെക്സ്റ്റിന്റെ ഒരു ഭാഗം**, ഇത് എഴുതൽ സഹായത്തിനുള്ള അഭ്യർത്ഥനയാണ്.
  
  ![ടെക്സ്റ്റ് പൂർത്തീകരണത്തിന്റെ ഉദാഹരണം](../../../translated_images/text-completion-example.cbb0f28403d42752.ml.png)
...
- **കോഡ്** ഒരു ഭാഗം, അതിന്റെ വിശദീകരണവും ഡോക്യുമെന്റേഷനും ആവശ്യപ്പെടൽ, അല്ലെങ്കിൽ ഒരു പ്രത്യേക ജോലി ചെയ്യുന്ന കോഡ് സൃഷ്ടിക്കാൻ അഭ്യർത്ഥന.
  ...
  ![കോഡിംഗ് ഉദാഹരണം](../../../translated_images/coding-example.50ebabe8a6afff20.ml.png)
