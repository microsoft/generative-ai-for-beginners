...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-25T16:57:18+00:00",
...
Các script chuẩn bị dữ liệu phiên âm tải xuống bản phiên âm video YouTube và chuẩn bị chúng để sử dụng với mẫu Tìm kiếm Ngữ nghĩa với OpenAI Embeddings và Functions.

Các script chuẩn bị dữ liệu phiên âm đã được kiểm tra trên các phiên bản mới nhất của Windows 11, macOS Ventura và Ubuntu 22.04 (và cao hơn).

## Tạo các tài nguyên cần thiết cho Dịch vụ Azure OpenAI
...
1. Tạo một tài nguyên Dịch vụ Azure OpenAI.
...
Các biến môi trường sau đây là cần thiết để chạy các script chuẩn bị dữ liệu phiên âm YouTube.

### Trên Windows

Khuyến nghị thêm các biến vào `user` environment variables.
...
Khuyến nghị thêm các lệnh xuất sau vào file `~/.bashrc` or `~/.zshrc`.
...
1. Cài đặt [git client](https://git-scm.com/downloads?WT.mc_id=academic-105485-koreyst) nếu nó chưa được cài đặt.
...
Tài liệu này đã được dịch bằng dịch vụ dịch thuật AI [Co-op Translator](https://github.com/Azure/co-op-translator). Mặc dù chúng tôi cố gắng đảm bảo độ chính xác, xin lưu ý rằng các bản dịch tự động có thể chứa lỗi hoặc không chính xác. Tài liệu gốc bằng ngôn ngữ bản địa của nó nên được coi là nguồn thông tin có thẩm quyền. Đối với thông tin quan trọng, khuyến nghị sử dụng dịch vụ dịch thuật chuyên nghiệp bởi con người. Chúng tôi không chịu trách nhiệm về bất kỳ sự hiểu lầm hoặc giải thích sai nào phát sinh từ việc sử dụng bản dịch này.