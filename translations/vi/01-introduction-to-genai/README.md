...
[![Giới thiệu về AI Tạo Sinh và Mô Hình Ngôn Ngữ Lớn](../../../translated_images/vi/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![Năm học sinh trẻ đang nhìn vào màn hình - hình ảnh bởi DALLE2](../../../translated_images/vi/students-by-DALLE2.b70fddaced1042ee.png)
...
![AI, ML, DL và AI Tạo Sinh](../../../translated_images/vi/AI-diagram.c391fa518451a40d.png)
...
![Ví dụ về tokenization](../../../translated_images/vi/tokenizer-example.80a5c151ee7d1bd4.png)
...
- Một **hướng dẫn** chỉ định loại đầu ra mà chúng ta mong đợi từ mô hình. Hướng dẫn này đôi khi có thể bao gồm một số ví dụ hoặc một số dữ liệu bổ sung.
  ...
  1. Tóm tắt một bài báo, sách, đánh giá sản phẩm và hơn thế nữa, cùng với việc trích xuất thông tin từ dữ liệu không có cấu trúc.
    ...
    ![Ví dụ về tóm tắt](../../../translated_images/vi/summarization-example.7b7ff97147b3d790.png)
  
  2. Tư duy sáng tạo và thiết kế một bài báo, bài luận, bài tập hoặc hơn thế nữa.
      
     ![Ví dụ về viết sáng tạo](../../../translated_images/vi/creative-writing-example.e24a685b5a543ad1.png)

- Một **câu hỏi**, được hỏi dưới dạng cuộc trò chuyện với một tác nhân.
  
  ![Ví dụ về cuộc trò chuyện](../../../translated_images/vi/conversation-example.60c2afc0f595fa59.png)

- Một đoạn **văn bản để hoàn thành**, mà ngầm hiểu là yêu cầu hỗ trợ viết.
  
  ![Ví dụ về hoàn thành văn bản](../../../translated_images/vi/text-completion-example.cbb0f28403d42752.png)
...
- Một đoạn **mã** cùng với yêu cầu giải thích và tài liệu hóa nó, hoặc một bình luận yêu cầu tạo một đoạn mã thực hiện một nhiệm vụ cụ thể.
  ...
  ![Ví dụ về mã hóa](../../../translated_images/vi/coding-example.50ebabe8a6afff20.png)
