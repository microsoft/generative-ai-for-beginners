...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-25T09:04:02+00:00",
...
- To run Python applications from the command line, follow assignment-specific instructions to ensure you select the right files and provide required arguments.
...
1. Click the **Model deployments** option in the sidebar (left menu) for the Azure OpenAI resource.
