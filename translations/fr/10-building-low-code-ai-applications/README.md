...
[![Construire des applications IA à faible code](../../../translated_images/fr/10-lesson-banner.a01ac8fe3fd86310.webp)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Décrire l'application que vous souhaitez créer](../../../translated_images/fr/copilot-chat-prompt-powerapps.84250f341d060830.webp)
...
![Ajout d'un nouveau champ](../../../translated_images/fr/copilot-new-column.35e15ff21acaf274.webp)
...
![Ajout d'un nouvel écran via une instruction de prompt](../../../translated_images/fr/copilot-new-screen.2e0bef7132a17392.webp)
...
![Sélectionner une nouvelle table](../../../translated_images/fr/describe-new-table.0792373eb757281e.webp)
...
![Décrire la table](../../../translated_images/fr/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.webp)
...
![Table Dataverse suggérée](../../../translated_images/fr/copilot-dataverse-table.b3bc936091324d9d.webp)
...
![Modèles AI Builder](../../../translated_images/fr/ai-builder-models.8069423b84cfc47f.webp)
...
8. Supprimez l'action **Condition** du flux, car vous ne l'utiliserez pas. Cela devrait ressembler à la capture d'écran suivante :
   ...
   ![power automate, supprimer des actions](../../../translated_images/fr/powerautomate-remove-actions.7216392fe684ceba.webp)
...
11. Sélectionnez la **Table** que vous avez créée précédemment. Par exemple, vous pouvez sélectionner la table **Informations sur les factures**. Choisissez le contenu dynamique de l'action précédente pour remplir les champs suivants :
    ...
    ![power automate ajouter une ligne](../../../translated_images/fr/powerautomate-add-row.5edce45e5dd3d51e.webp)
...
![créer une invite](../../../translated_images/fr/create-prompt-gpt.69d429300c2e870a.webp)
