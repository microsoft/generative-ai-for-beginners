...
[![Construire des applications de chat alimentées par l'IA générative](../../../translated_images/07-lesson-banner.a279b937f2843833.fr.png)](https://youtu.be/R9V0ZY1BEQo?si=IHuU-fS9YWT8s4sA)
...
![Paramètres d'instructions personnalisées dans ChatGPT](../../../translated_images/custom-instructions.b96f59aa69356fcf.fr.png)
...
![Une invite dans ChatGPT pour un plan de cours sur les listes chaînées](../../../translated_images/lesson-plan-prompt.cc47c488cf1343df.fr.png)
