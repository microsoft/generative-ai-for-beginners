...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-26T03:10:11+00:00",
...
Chacun de ces modèles est disponible gratuitement sur le marché des modèles Github. Le code dans ce notebook utilisera ces modèles pour exécuter le code. Voici plus de détails sur l'utilisation des modèles Github pour [prototyper avec des modèles d'IA](https://docs.github.com/en/github-models/prototyping-with-ai-models?WT.mc_id=academic-105485-koreyst). 
...
- Performance multilingue accrue - les langues incluent : anglais, français, allemand, espagnol, italien, portugais, néerlandais, russe, chinois, japonais, coréen, arabe et hindi.
...
- *Appel de fonction* - ce modèle a un appel de fonction natif qui permet l'intégration avec des outils externes et des API. Ces appels peuvent être effectués à la fois en parallèle ou successivement dans un ordre séquentiel. 
...
L'invite envoyée au modèle Mistral inclut à la fois les questions et les fragments récupérés qui sont similaires à la question. Le modèle fournit ensuite une réponse en langage naturel. 
...
## Mistral Small 
Mistral Small est un autre modèle de la famille des modèles Mistral sous la catégorie premier/entreprise. Comme son nom l'indique, ce modèle est un Small Language Model (SLM). Les avantages de l'utilisation de Mistral Small sont : 
- Économies de coûts par rapport aux LLM de Mistral comme Mistral Large et NeMo - baisse de prix de 80%
...
- Les applications où des demandes fréquentes sont faites en raison de son efficacité en termes de coûts 
...
Vous devriez voir une différence dans les temps de réponse entre 3 et 5 secondes. Notez également la longueur et le style des réponses pour la même invite.  
...
Les deux exemples prennent la même invite mais vous devriez voir que NeMo retourne moins de tokens par rapport à Mistral Large. 
