...
[![Bygga AI-applikationer med låg kod](../../../translated_images/sv/10-lesson-banner.a01ac8fe3fd86310.webp)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Lägga till ett nytt fält](../../../translated_images/sv/copilot-new-column.35e15ff21acaf274.webp)
...
![Lägga till en ny skärm via en promptinstruktion](../../../translated_images/sv/copilot-new-screen.2e0bef7132a17392.webp)
...
![Välj ny tabell](../../../translated_images/sv/describe-new-table.0792373eb757281e.webp)
...
![Beskriv tabellen](../../../translated_images/sv/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.webp)
...
![Föreslagen Dataverse-tabell](../../../translated_images/sv/copilot-dataverse-table.b3bc936091324d9d.webp)
...
![AI Builder-modeller](../../../translated_images/sv/ai-builder-models.8069423b84cfc47f.webp)
...
8. Ta bort åtgärden **Condition** från flödet eftersom du inte kommer att använda den. Det bör se ut som följande skärmdump:
   ...
   ![Power Automate, ta bort åtgärder](../../../translated_images/sv/powerautomate-remove-actions.7216392fe684ceba.webp)
...
11. Välj den **Table** du skapade tidigare. Till exempel kan du välja tabellen **Invoice Information**. Välj det dynamiska innehållet från den tidigare åtgärden för att fylla i följande fält:
    ...
    ![Power Automate lägg till rad](../../../translated_images/sv/powerautomate-add-row.5edce45e5dd3d51e.webp)
...
![Skapa en prompt](../../../translated_images/sv/create-prompt-gpt.69d429300c2e870a.webp)
