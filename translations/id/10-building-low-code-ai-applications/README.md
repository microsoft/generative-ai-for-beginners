...
[![Membangun Aplikasi AI dengan Kode Rendah](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.id.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Deskripsikan aplikasi yang ingin Anda bangun](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.id.png)
...
1. AI Copilot akan menyarankan Tabel Dataverse dengan bidang yang Anda perlukan untuk menyimpan data yang ingin Anda lacak serta beberapa data contoh. Anda kemudian dapat menyesuaikan tabel untuk memenuhi kebutuhan Anda menggunakan fitur asisten AI Copilot melalui langkah-langkah percakapan.
   ...
   ![Bidang yang disarankan dalam tabel baru Anda](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.id.png)
...
![Menambahkan bidang baru](../../../translated_images/copilot-new-column.35e15ff21acaf274.id.png)
...
![Menambahkan layar baru melalui instruksi prompt](../../../translated_images/copilot-new-screen.2e0bef7132a17392.id.png)
...
![Pilih tabel baru](../../../translated_images/describe-new-table.0792373eb757281e.id.png)
...
![Deskripsikan tabel](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.id.png)
...
![Tabel Dataverse yang disarankan](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.id.png)
...
![Model AI builder](../../../translated_images/ai-builder-models.8069423b84cfc47f.id.png)
...
2. Gunakan area teks di layar utama untuk menjelaskan alur kerja yang ingin Anda bangun. Misalnya, **_Proses faktur saat tiba di kotak masuk saya_**. Klik tombol **Send** untuk mengirimkan perintah ke AI Copilot.
   ...
   ![Copilot power automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.id.png)
...
8. Hapus tindakan **Condition** dari alur kerja karena Anda tidak akan menggunakannya. Alur kerja Anda seharusnya terlihat seperti tangkapan layar berikut:
   ...
   ![power automate, hapus tindakan](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.id.png)
...
11. Pilih **Table** yang Anda buat sebelumnya. Misalnya, Anda dapat memilih tabel **Invoice Information**. Pilih konten dinamis dari tindakan sebelumnya untuk mengisi bidang berikut:
    ...
    ![power automate tambahkan baris](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.id.png)
...
![buat perintah](../../../translated_images/create-prompt-gpt.69d429300c2e870a.id.png)
