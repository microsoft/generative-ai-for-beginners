...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:21:57+00:00",
...
Pripravili smo lekcijo **[Course Setup](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)**, ki vam bo pomagala pri nastavitvi razvojnega okolja.
...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 00  | [Course Setup](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)                                                                 | **Learn:** Kako nastaviti razvojno okolje                                                     | Video prihaja kmalu                                                                 | [Več o tem](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 11  | [Integracija zunanjih aplikacij z uporabo klicanja funkcij](./11-integrating-with-function-calling/README.md?WT.mc_id=academic-105485-koreyst) | **Gradnja:** Kaj je klicanje funkcij in primeri uporabe v aplikacijah                          | [Video](https://aka.ms/gen-ai-lesson11-gh?WT.mc_id=academic-105485-koreyst) | [Več informacij](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 18  | [Prilagajanje LLM-jev](./18-fine-tuning/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **Učenje:** Kaj, zakaj in kako prilagoditi LLM-je                                            | [Video](https://aka.ms/gen-ai-lesson18-gh?WT.mc_id=academic-105485-koreyst) | [Več informacij](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
- [Obvladovanje GitHub Copilota za AI programiranje v paru](https://aka.ms/GitHubCopilotAI)
- [Obvladovanje GitHub Copilota za C#/.NET razvijalce](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers)
