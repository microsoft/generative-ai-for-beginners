...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-18T01:21:55+00:00",
...
[![Изградња апликација за генерисање слика](../../../translated_images/09-lesson-banner.906e408c741f4411.sr.png)](https://youtu.be/B5VP0_J7cs8?si=5P3L5o7F_uS_QcG9)
...
![Edu4All стартап, час о споменицима, Ајфелова кула](../../../translated_images/startup.94d6b79cc4bb3f5a.sr.png)
...
<div style="display: flex; justify-content: space-between; align-items: center; margin: 20px 0;">
  <img src="../../../translated_images/sunlit_lounge.a75a0cb61749db0e.sr.png" style="width: 30%; max-width: 200px; height: auto;">
  <img src="../../../translated_images/mask.1b2976ccec9e011e.sr.png" style="width: 30%; max-width: 200px; height: auto;">
  <img src="../../../translated_images/sunlit_lounge_result.76ae02957c0bbeb8.sr.png" style="width: 30%; max-width: 200px; height: auto;">
</div>
...
![Зец на коњу држи лизалицу, верзија 1](../../../translated_images/v1-generated-image.a295cfcffa3c13c2.sr.png)

Сада покренимо исти промпт само да видимо да нећемо добити исту слику два пута:

![Генерисана слика зеца на коњу](../../../translated_images/v2-generated-image.33f55a3714efe61d.sr.png)
...
- ![Температура 0, в1](../../../translated_images/v1-temp-generated-image.a4346e1d2360a056.sr.png)
- ![Температура 0 , в2](../../../translated_images/v2-temp-generated-image.871d0c920dbfb0f1.sr.png)
...
Ово можемо урадити помоћу _мета промптова_. Мета промптови су текстуални промптови који се користе за контролу излазног резултата генеративног AI модела. На пример, можемо користити мета промптове за контролу излазног резултата и осигурати да генерисане слике буду прикладне за радно окружење или за децу.
