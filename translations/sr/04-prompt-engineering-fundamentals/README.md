...
[![Основе инжењеринга упутстава](../../../translated_images/04-lesson-banner.a2c90deba7fedacd.sr.png)](https://youtu.be/GElCu2kUlRs?si=qrXsBvXnCW12epb8)
...
![Илустровани водич за инжењеринг упутстава](../../../translated_images/04-prompt-engineering-sketchnote.d5f33336957a1e4f.sr.png)
...
![Токенизација](../../../translated_images/04-tokenizer-example.e71f0a0f70356c5c.sr.png)
...
![Завршетак четовања основног LLM-а](../../../translated_images/04-playground-chat-base.65b76fcfde0caa67.sr.png)
...
![Завршетак четовања LLM-а подешеног за инструкције](../../../translated_images/04-playground-chat-instructions.b30bbfbdf92f2d05.sr.png)
...
![Odgovor 1](../../../translated_images/04-fabrication-oai.5818c4e0b2a2678c.sr.png)

> **Odgovor 2**: Azure OpenAI Playground (GPT-35)

![Odgovor 2](../../../translated_images/04-fabrication-aoai.b14268e9ecf25caf.sr.png)

> **Odgovor 3**: Hugging Face Chat Playground (LLama-2)

![Odgovor 3](../../../translated_images/04-fabrication-huggingchat.faf82a0a51278956.sr.png)
