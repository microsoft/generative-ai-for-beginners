...
[![Увод у генеративну вештачку интелигенцију и моделе великог језика](../../../translated_images/01-lesson-banner.2424cfd092f43366.sr.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![Пет младих ученика гледа монитор - слика од DALLE2](../../../translated_images/students-by-DALLE2.b70fddaced1042ee.sr.png)
...
![AI, ML, DL и генеративна AI](../../../translated_images/AI-diagram.c391fa518451a40d.sr.png)
...
![Пример токенизације](../../../translated_images/tokenizer-example.80a5c151ee7d1bd4.sr.png)
...
- **Инструкцију** која прецизира врсту излаза коју очекујемо од модела. Ова инструкција понекад може садржати примере или додатне податке.
  ...
  1. Сажетак чланка, књиге, рецензија производа и више, уз извлачење увида из неструктурираних података.
    ...
    ![Пример сажетка](../../../translated_images/summarization-example.7b7ff97147b3d790.sr.png)
  
  2. Креативно осмишљавање и писање чланка, есеја, задатка или другог.
      
     ![Пример креативног писања](../../../translated_images/creative-writing-example.e24a685b5a543ad1.sr.png)

- **Питање**, постављено у облику разговора са агентом.
  
  ![Пример разговора](../../../translated_images/conversation-example.60c2afc0f595fa59.sr.png)

- Део **текста за довршавање**, што имплицитно представља захтев за помоћ у писању.
  
  ![Пример довршавања текста](../../../translated_images/text-completion-example.cbb0f28403d42752.sr.png)
...
- Део **кода** заједно са захтевом за објашњење и документацију, или коментар који тражи генерисање дела кода који обавља одређени задатак.
  ...
  ![Пример кода](../../../translated_images/coding-example.50ebabe8a6afff20.sr.png)
