...
[![জেনারেটিভ এআই এবং বড় ভাষার মডেলের পরিচিতি](../../../translated_images/bn/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![পাঁচজন তরুণ শিক্ষার্থী একটি মনিটরের দিকে তাকিয়ে - DALLE2 দ্বারা তৈরি ছবি](../../../translated_images/bn/students-by-DALLE2.b70fddaced1042ee.png)
...
![এআই, এমএল, ডিএল এবং জেনারেটিভ এআই](../../../translated_images/bn/AI-diagram.c391fa518451a40d.png)
...
![টোকেনাইজেশনের উদাহরণ](../../../translated_images/bn/tokenizer-example.80a5c151ee7d1bd4.png)
...
- একটি **নির্দেশনা** যা মডেল থেকে আমরা যে ধরণের আউটপুট আশা করি তা নির্দিষ্ট করে। এই নির্দেশনায় কখনও কখনও কিছু উদাহরণ বা কিছু অতিরিক্ত ডেটা অন্তর্ভুক্ত থাকতে পারে।
  ...
  1. একটি নিবন্ধ, বই, পণ্য পর্যালোচনা এবং আরও অনেক কিছু সংক্ষেপণ, পাশাপাশি অগঠিত ডেটা থেকে অন্তর্দৃষ্টি বের করা।
    ...
    ![সংক্ষেপণের উদাহরণ](../../../translated_images/bn/summarization-example.7b7ff97147b3d790.png)
  
  2. একটি নিবন্ধ, প্রবন্ধ, অ্যাসাইনমেন্ট বা আরও কিছু সৃজনশীল ধারণা এবং ডিজাইন।
      
     ![সৃজনশীল লেখার উদাহরণ](../../../translated_images/bn/creative-writing-example.e24a685b5a543ad1.png)

- একটি **প্রশ্ন**, যা একটি এজেন্টের সাথে কথোপকথনের আকারে জিজ্ঞাসা করা হয়।
  
  ![কথোপকথনের উদাহরণ](../../../translated_images/bn/conversation-example.60c2afc0f595fa59.png)

- একটি **টেক্সট সম্পূর্ণ করার অংশ**, যা পরোক্ষভাবে লেখার সহায়তার জন্য একটি অনুরোধ।
  
  ![টেক্সট সম্পূর্ণ করার উদাহরণ](../../../translated_images/bn/text-completion-example.cbb0f28403d42752.png)
...
- একটি **কোডের অংশ** যা ব্যাখ্যা এবং ডকুমেন্ট করার জন্য অনুরোধ করা হয়, অথবা একটি নির্দিষ্ট কাজ সম্পাদন করার জন্য একটি কোড তৈরি করার জন্য একটি মন্তব্য।
  ...
  ![কোডিং উদাহরণ](../../../translated_images/bn/coding-example.50ebabe8a6afff20.png)
