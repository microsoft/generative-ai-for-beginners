...
আপনার কম্পিউটার বা কোডস্পেসে সবকিছু সেটআপ করার বিকল্প হলো [কন্টেইনার](https://en.wikipedia.org/wiki/Containerization_%28computing%29?WT.mc_id=academic-105485-koreyst) ব্যবহার। কোর্স রিপোজিটোরির বিশেষ `.devcontainer` ফোল্ডারটি VS Code কে প্রজেক্টটি কন্টেইনারের মধ্যে সেটআপ করার সুযোগ দেয়। Codespaces ছাড়া, এর জন্য Docker ইনস্টল করতে হবে, এবং কাজটি তুলনামূলক কঠিন, তাই আমরা কেবল কন্টেইনার নিয়ে কাজের অভিজ্ঞতা থাকা লোকদের জন্য এ পরামর্শ দিই।
