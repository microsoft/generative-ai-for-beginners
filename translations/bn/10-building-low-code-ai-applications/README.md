...
[![লো কোড AI অ্যাপ্লিকেশন তৈরি করা](../../../translated_images/bn/10-lesson-banner.a01ac8fe3fd86310.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![আপনি যে অ্যাপ তৈরি করতে চান তা বর্ণনা করুন](../../../translated_images/bn/copilot-chat-prompt-powerapps.84250f341d060830.png)
...
1. AI কোপাইলট একটি ডাটাভার্স টেবিল সাজেস্ট করবে যেখানে আপনার ট্র্যাক করতে চাওয়া ডেটা সংরক্ষণ করতে প্রয়োজনীয় ফিল্ডগুলো থাকবে এবং কিছু নমুনা ডেটা থাকবে। আপনি কথোপকথনের ধাপে AI কোপাইলট সহকারী ফিচার ব্যবহার করে টেবিলটি কাস্টমাইজ করতে পারেন।
   ...
   ![আপনার নতুন টেবিলে সাজেস্ট করা ফিল্ড](../../../translated_images/bn/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.png)
...
![একটি নতুন ফিল্ড যোগ করা](../../../translated_images/bn/copilot-new-column.35e15ff21acaf274.png)
...
![প্রম্পট নির্দেশনার মাধ্যমে একটি নতুন স্ক্রিন যোগ করা](../../../translated_images/bn/copilot-new-screen.2e0bef7132a17392.png)
...
![নতুন টেবিল নির্বাচন করুন](../../../translated_images/bn/describe-new-table.0792373eb757281e.png)
...
![টেবিল বর্ণনা করুন](../../../translated_images/bn/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.png)
...
![প্রস্তাবিত Dataverse টেবিল](../../../translated_images/bn/copilot-dataverse-table.b3bc936091324d9d.png)
...
![AI builder মডেল](../../../translated_images/bn/ai-builder-models.8069423b84cfc47f.png)
...
2. হোম স্ক্রিনে টেক্সট এরিয়া ব্যবহার করে আপনি যে ওয়ার্কফ্লো তৈরি করতে চান তা বর্ণনা করুন। উদাহরণস্বরূপ, **_আমার মেইলবক্সে ইনভয়েস আসলে তা প্রসেস করুন_**। **Send** বোতামে ক্লিক করে AI Copilot-এ প্রম্পট পাঠান।
   ...
   ![Copilot power automate](../../../translated_images/bn/copilot-chat-prompt-powerautomate.f377e478cc8412de.png)
...
8. ফ্লো থেকে **Condition** অ্যাকশন সরিয়ে ফেলুন কারণ আপনি এটি ব্যবহার করবেন না। এটি নিম্নলিখিত স্ক্রিনশটের মতো দেখতে হবে:
   ...
   ![power automate, অ্যাকশন সরান](../../../translated_images/bn/powerautomate-remove-actions.7216392fe684ceba.png)
...
11. আপনি আগে তৈরি করা টেবিলটি নির্বাচন করুন। উদাহরণস্বরূপ, আপনি **Invoice Information** টেবিলটি নির্বাচন করতে পারেন। পূর্ববর্তী অ্যাকশন থেকে ডায়নামিক কন্টেন্ট ব্যবহার করে নিম্নলিখিত ক্ষেত্রগুলো পূরণ করুন:
    ...
    ![power automate add row](../../../translated_images/bn/powerautomate-add-row.5edce45e5dd3d51e.png)
...
![প্রম্পট তৈরি করুন](../../../translated_images/bn/create-prompt-gpt.69d429300c2e870a.png)
