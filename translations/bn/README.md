...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-18T00:20:17+00:00",
  "source_file": "README.md",
  "language_code": "bn"
}
-->
![জেনারেটিভ এআই শিক্ষার্থীদের জন্য](../../translated_images/repo-thumbnailv4-fixed.11f1ce6a85d01461c33c11943bb61f2b6d6dcce3a3b25cd27e627031f41f8e00.bn.png)

### জেনারেটিভ এআই অ্যাপ্লিকেশন তৈরি শুরু করার জন্য প্রয়োজনীয় সবকিছু শেখার ২১টি পাঠ
...
# শিক্ষার্থীদের জন্য জেনারেটিভ এআই (সংস্করণ ৩) - একটি কোর্স
...
পাঠগুলি "Learn" হিসেবে লেবেল করা হয়েছে যা জেনারেটিভ এআই ধারণা ব্যাখ্যা করে অথবা "Build" পাঠ যা ধারণা এবং **Python** এবং **TypeScript**-এ কোড উদাহরণ ব্যাখ্যা করে।
...
- Python বা TypeScript এর মৌলিক জ্ঞান সহায়ক হবে - \*যদি আপনি সম্পূর্ণ নতুন হন তবে এই [Python](https://aka.ms/genai-beginners/python?WT.mc_id=academic-105485-koreyst) এবং [TypeScript](https://aka.ms/genai-beginners/typescript?WT.mc_id=academic-105485-koreyst) কোর্সগুলি দেখুন।
...
পরে সহজে খুঁজে পেতে এই রিপোজিটরিটিকে [স্টার (🌟) দিন](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst)।

## 🧠 প্রস্তুত ডিপ্লয় করার জন্য?

যদি আপনি আরও উন্নত কোড নমুনা খুঁজছেন, আমাদের [জেনারেটিভ এআই কোড নমুনার সংগ্রহ](https://aka.ms/genai-beg-code?WT.mc_id=academic-105485-koreyst) দেখুন যা **Python** এবং **TypeScript**-এ উপলব্ধ।

## 🗣️ অন্যান্য শিক্ষার্থীদের সাথে পরিচিত হন, সহায়তা পান

আমাদের [অফিসিয়াল Azure AI Foundry Discord সার্ভার](https://aka.ms/genai-discord?WT.mc_id=academic-105485-koreyst)-এ যোগ দিন, যেখানে আপনি এই কোর্সে অংশগ্রহণকারী অন্যান্য শিক্ষার্থীদের সাথে পরিচিত হতে পারেন এবং সহায়তা পেতে পারেন।

প্রশ্ন জিজ্ঞাসা করুন বা আমাদের [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum) এ GitHub-এ পণ্য সম্পর্কিত মতামত শেয়ার করুন।
...
আপনার কি কোনো পরামর্শ আছে বা বানান বা কোডের ত্রুটি খুঁজে পেয়েছেন? [একটি ইস্যু উত্থাপন করুন](https://github.com/microsoft/generative-ai-for-beginners/issues?WT.mc_id=academic-105485-koreyst) অথবা [একটি পুল রিকোয়েস্ট তৈরি করুন](https://github.com/microsoft/generative-ai-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)।
...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 00  | [কোর্স সেটআপ](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)                                                                 | **শিখুন:** আপনার ডেভেলপমেন্ট পরিবেশ কিভাবে সেটআপ করবেন                                            | ভিডিও শীঘ্রই আসছে                                                                 | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 02  | [বিভিন্ন LLMs অন্বেষণ এবং তুলনা করা](./02-exploring-and-comparing-different-llms/README.md?WT.mc_id=academic-105485-koreyst)             | **শিখুন:** আপনার ব্যবহারের ক্ষেত্রে সঠিক মডেল নির্বাচন করার উপায়                                      | [ভিডিও](https://aka.ms/gen-ai-lesson2-gh?WT.mc_id=academic-105485-koreyst)  | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 03  | [জেনারেটিভ এআই দায়িত্বশীলভাবে ব্যবহার করা](./03-using-generative-ai-responsibly/README.md?WT.mc_id=academic-105485-koreyst)                           | **শিখুন:** দায়িত্বশীলভাবে জেনারেটিভ এআই অ্যাপ্লিকেশন তৈরি করার উপায়                                  | [ভিডিও](https://aka.ms/gen-ai-lesson3-gh?WT.mc_id=academic-105485-koreyst)  | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 04  | [প্রম্পট ইঞ্জিনিয়ারিংয়ের মৌলিক বিষয়গুলি বোঝা](./04-prompt-engineering-fundamentals/README.md?WT.mc_id=academic-105485-koreyst)             | **শিখুন:** প্রম্পট ইঞ্জিনিয়ারিংয়ের সেরা অনুশীলনগুলি হাতে-কলমে                                           | [ভিডিও](https://aka.ms/gen-ai-lesson4-gh?WT.mc_id=academic-105485-koreyst)  | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 05  | [উন্নত প্রম্পট তৈরি করা](./05-advanced-prompts/README.md?WT.mc_id=academic-105485-koreyst)                                                | **শিখুন:** প্রম্পট ইঞ্জিনিয়ারিং কৌশলগুলি প্রয়োগ করার উপায় যা আপনার প্রম্পটের ফলাফল উন্নত করে। | [ভিডিও](https://aka.ms/gen-ai-lesson5-gh?WT.mc_id=academic-105485-koreyst)  | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 08  | [সার্চ অ্যাপ্লিকেশন তৈরি করা এবং ভেক্টর ডাটাবেস](./08-building-search-applications/README.md?WT.mc_id=academic-105485-koreyst)                        | **তৈরি করুন:** এম্বেডিং ব্যবহার করে ডেটা অনুসন্ধানের জন্য একটি সার্চ অ্যাপ্লিকেশন                        | [ভিডিও](https://aka.ms/gen-ai-lesson8-gh?WT.mc_id=academic-105485-koreyst)  | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 11  | [ফাংশন কলিংয়ের মাধ্যমে বাইরের অ্যাপ্লিকেশন সংহত করা](./11-integrating-with-function-calling/README.md?WT.mc_id=academic-105485-koreyst) | **তৈরি করুন:** ফাংশন কলিং কী এবং অ্যাপ্লিকেশনের জন্য এর ব্যবহার                          | [ভিডিও](https://aka.ms/gen-ai-lesson11-gh?WT.mc_id=academic-105485-koreyst) | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 15  | [রিট্রিভাল অগমেন্টেড জেনারেশন (RAG) এবং ভেক্টর ডাটাবেস](./15-rag-and-vector-databases/README.md?WT.mc_id=academic-105485-koreyst)        | **তৈরি করুন:** একটি RAG ফ্রেমওয়ার্ক ব্যবহার করে ভেক্টর ডাটাবেস থেকে এম্বেডিং পুনরুদ্ধার করার জন্য একটি অ্যাপ্লিকেশন  | [ভিডিও](https://aka.ms/gen-ai-lesson15-gh?WT.mc_id=academic-105485-koreyst) | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 19  | [SLMs দিয়ে তৈরি করা](./19-slm/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **শিখুন:** ছোট ভাষার মডেল দিয়ে তৈরি করার সুবিধা                                            | ভিডিও শীঘ্রই আসছে | [আরও জানুন](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
- [**নতুন** Edge AI for Beginners](https://github.com/microsoft/edgeai-for-beginners)
...
যদি আপনার কোনো পণ্য সম্পর্কিত মতামত বা তৈরি করার সময় কোনো ত্রুটি থাকে, দেখুন:
