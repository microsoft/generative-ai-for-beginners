...
[![探索與比較不同的大型語言模型](../../../translated_images/mo/02-lesson-banner.ef94c84979f97f60.png)](https://youtu.be/KIRUeDKscfI?si=8BHX1zvwzQBn-PlK)
...
![基礎模型與 LLM 的區別](../../../translated_images/mo/FoundationModel.e4859dbb7a825c94.png)
...
![基礎模型](../../../translated_images/mo/Multimodal.2c389c6439e0fc51.png)
...
![嵌入](../../../translated_images/mo/Embedding.c3708fe988ccf760.png)
...
![圖像生成](../../../translated_images/mo/Image.349c080266a763fd.png)
...
![文本與程式碼生成](../../../translated_images/mo/Text.a8c0cf139e5cc2a0.png)
...
![模型目錄](../../../translated_images/mo/AzureAIStudioModelCatalog.3cf8a499aa8ba031.png)

- 查看模型卡，包括詳細的用途描述和訓練數據、代碼範例以及內部評估庫中的評估結果。

![模型卡](../../../translated_images/mo/ModelCard.598051692c6e400d.png)
...
![模型基準](../../../translated_images/mo/ModelBenchmarks.254cb20fbd06c03a.png)

- 利用 Azure AI Studio 的實驗和追蹤功能，使用自定義訓練數據微調模型，以提高模型在特定工作負載中的性能。

![模型微調](../../../translated_images/mo/FineTuning.aac48f07142e36fd.png)
...
![模型部署](../../../translated_images/mo/ModelDeploy.890da48cbd0bccdb.png)
...
![LLM 部署](../../../translated_images/mo/Deploy.18b2d27412ec8c02.png)
