...
[![生成式 AI 和大型語言模型介紹](../../../translated_images/mo/08-lesson-banner.8fff48c566dad08a.png)](https://youtu.be/W0-nzXjOjr0?si=GcsqiTTvd7RKbo7V)
...
![問題「可以使用 rstudio 與 Azure ML 嗎？」的語義搜尋範例](../../../translated_images/mo/query-results.bb0480ebf025fac6.png)
...
![用戶輸入查詢的輸入框](../../../translated_images/mo/notebook-search.1e320b9c7fcbb0bc.png)
