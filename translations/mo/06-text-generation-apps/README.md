...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-17T23:28:32+00:00",
...
[![建立文字生成應用程式](../../../translated_images/mo/06-lesson-banner.a5c629f990a636c8.webp)](https://youtu.be/0Y5Luf5sRQA?si=t_xVg0clnAI4oUFZ)
...
現在你已經看到如何使用提示生成文字。你甚至已經有一個可以運行的程式，並可以修改和更改以生成不同類型的文字。
