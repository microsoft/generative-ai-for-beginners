...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:35:30+00:00",
...
- **CLIP**, एक मोडेल हो जसले छविहरू र पाठबाट संख्यात्मक प्रतिनिधित्वहरू (embeddings) निर्माण गर्छ।
...
- **python-dotenv**, यो पुस्तकालय प्रयोग गर्न सिफारिस गरिन्छ ताकि तपाईंको गोप्य जानकारीलाई _.env_ फाइलमा राख्न सकियोस्।
...
यदि पहिले नै गरिएको छैन भने, [Microsoft Learn](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/create-resource?pivots=web-portal) पृष्ठमा दिइएका निर्देशनहरू पालना गर्नुहोस्
Azure OpenAI स्रोत र मोडेल सिर्जना गर्न। मोडेलको रूपमा DALL-E 3 चयन गर्नुहोस्।  
...
1. _.env_ नामक फाइल सिर्जना गर्नुहोस् र निम्न सामग्री थप्नुहोस्:
   ...
   Azure OpenAI Foundry Portal मा "Deployments" खण्डमा आफ्नो स्रोतको लागि यो जानकारी खोज्नुहोस्।
...
अब, छवि निर्माण गर्ने कोडलाई थप विस्तारमा हेरौं:
...
- **prompt**, पाठ प्रम्प्ट हो जुन छवि निर्माण गर्न प्रयोग गरिन्छ। यस अवस्थामा, हामी "घोडामा खरायो, ललिपप समातेको, कुहिरो मैदानमा जहाँ डाफोडिलहरू उम्रन्छन्" प्रम्प्ट प्रयोग गर्दैछौं।
...
- **temperature**, एक प्यारामिटर हो जसले Generative AI मोडेलको उत्पादनको अनियमितता नियन्त्रण गर्छ। तापक्रम 0 देखि 1 को बीचको मान हो जहाँ 0 ले उत्पादन निर्धारणात्मक छ र 1 ले उत्पादन अनियमित छ भन्ने जनाउँछ। डिफल्ट मान 0.7 हो।

छविहरूसँग गर्न सकिने थप कार्यहरू हामी अर्को खण्डमा समेट्नेछौं।

## छवि निर्माणको थप क्षमताहरू

तपाईंले देख्नुभयो कि हामीले केही लाइनहरू Python मा प्रयोग गरेर छवि निर्माण गर्न सक्षम भयौं। तर, छविहरूसँग गर्न सकिने थप कार्यहरू पनि छन्।
...
यहाँ GPT Image प्रयोग गरेर उदाहरण छ:
  ...
  आधार छविमा केवल पूल भएको लाउन्ज हुनेछ तर अन्तिम छविमा फ्लेमिंगो हुनेछ:
...
- **भिन्नताहरू सिर्जना गर्नुहोस्**। विचार यो हो कि तपाईं अवस्थित छवि लिन्छन् र सोध्नुहुन्छ कि भिन्नताहरू सिर्जना गरियोस्। भिन्नता सिर्जना गर्न, तपाईं छवि र पाठ प्रम्प्ट प्रदान गर्नुहुन्छ र निम्न प्रकारको कोड प्रयोग गर्नुहुन्छ:
...
तापक्रम एक प्यारामिटर हो जसले Generative AI मोडेलको उत्पादनको अनियमितता नियन्त्रण गर्छ। तापक्रम 0 देखि 1 को बीचको मान हो जहाँ 0 ले उत्पादन निर्धारणात्मक छ र 1 ले उत्पादन अनियमित छ भन्ने जनाउँछ। डिफल्ट मान 0.7 हो।

तापक्रम कसरी काम गर्छ भन्ने उदाहरण हेरौं। यो प्रम्प्ट दुई पटक चलाउँदा:
...
जस्तो देखिन्छ, छविहरू समान छन्, तर उस्तै छैनन्। अब तापक्रम मानलाई 0.1 मा परिवर्तन गरौं र हेर्नुहोस् के हुन्छ:
...
अब हाम्रो कोड परिवर्तन गरौं र तापक्रमलाई 0 मा सेट गरौं, निम्न प्रकारले:
...
अब जब तपाईं यो कोड चलाउनुहुन्छ, तपाईंले यी दुई छविहरू प्राप्त गर्नुहुन्छ:
...
हाम्रो डेमोको साथ, हामी पहिले नै हाम्रा ग्राहकहरूको लागि छविहरू निर्माण गर्न सक्षम छौं। तर, हामीले हाम्रो अनुप्रयोगको लागि केही सीमा सिर्जना गर्न आवश्यक छ।

उदाहरणका लागि, हामीले कामको लागि सुरक्षित नभएका छविहरू वा बच्चाहरूका लागि उपयुक्त नभएका छविहरू निर्माण गर्न चाहँदैनौं।

हामी यो _मेटाप्रम्प्टहरू_ प्रयोग गरेर गर्न सक्छौं। मेटाप्रम्प्टहरू पाठ प्रम्प्टहरू हुन् जसले Generative AI मोडेलको उत्पादनलाई नियन्त्रण गर्न प्रयोग गरिन्छ। उदाहरणका लागि, हामी मेटाप्रम्प्टहरूको प्रयोग गरेर उत्पादनलाई नियन्त्रण गर्न सक्छौं र सुनिश्चित गर्न सक्छौं कि निर्माण गरिएका छविहरू कामको लागि सुरक्षित छन् वा बच्चाहरूका लागि उपयुक्त छन्।
...
अब, हाम्रो डेमोमा मेटाप्रम्प्टहरूको प्रयोग कसरी गर्न सकिन्छ हेर्नुहोस्।
...
माथिको प्रम्प्टबाट, तपाईं देख्न सक्नुहुन्छ कि निर्माण गरिएका सबै छविहरू मेटाप्रम्प्टलाई विचार गर्छन्।
...
विद्यार्थीहरूले आफ्नो मूल्याङ्कनका लागि स्मारकहरू समावेश गर्ने छविहरू निर्माण गर्नेछन्। कुन स्मारकहरू समावेश गर्ने भन्ने निर्णय विद्यार्थीहरूले गर्नेछन्। विद्यार्थीहरूलाई यस कार्यमा आफ्नो सिर्जनशीलता प्रयोग गर्न अनुरोध गरिएको छ ताकि यी स्मारकहरूलाई विभिन्न सन्दर्भहरूमा राख्न सकियोस्।

## समाधान

यहाँ सम्भावित समाधान प्रस्तुत गरिएको छ:
```python
import openai
import os
import requests
