...
तपाईंको कम्प्युटर वा Codespace मा सबै कुरा सेटअप गर्ने विकल्पको विकल्पका रूपमा, तपाईं [कन्टेनर](<https://en.wikipedia.org/wiki/Containerization_(computing)?WT.mc_id=academic-105485-koreyst>) प्रयोग गर्न सक्नुहुन्छ। कोर्स रिपोजिटरी भित्रको विशेष `.devcontainer` फोल्डरले VS Code लाई प्रोजेक्ट कन्टेनर भित्र सेटअप गर्न सक्षम बनाउँछ। Codespaces बाहिर, यो Docker इन्स्टल गर्न आवश्यक पर्छ, र केही काम लाग्छ, त्यसैले हामी यसलाई कन्टेनरसँग काम गर्ने अनुभव भएका मानिसहरूलाई मात्र सिफारिस गर्छौं।
