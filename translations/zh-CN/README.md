![初学者生成式人工智能](../../translated_images/zh-CN/repo-thumbnailv4-fixed.11f1ce6a85d01461.webp)
...
课程分为“学习”课程（讲解生成式人工智能概念）和“构建”课程（讲解概念并提供<strong>Python</strong>和<strong>TypeScript</strong>的代码示例，尽可能提供双语言）。
...
我们创建了一个<strong>[课程设置](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)</strong>课程，助你完成开发环境搭建。
...
如果你想要更高级的代码示例，请查看我们提供的[生成式人工智能代码示例合集](https://aka.ms/genai-beg-code?WT.mc_id=academic-105485-koreyst)，支持<strong>Python</strong>和<strong>TypeScript</strong>。
