...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:05:40+00:00",
...
LLM bukan hanya untuk penjanaan teks. Ia juga boleh digunakan untuk menjana imej daripada deskripsi teks. Mempunyai imej sebagai satu mod boleh menjadi sangat berguna dalam pelbagai bidang seperti MedTech, seni bina, pelancongan, pembangunan permainan, dan banyak lagi. Dalam bab ini, kita akan melihat dua model penjanaan imej yang paling popular, DALL-E dan Midjourney.
...
Sebagai sebahagian daripada pelajaran ini, kita akan terus bekerja dengan startup kita, Edu4All. Pelajar akan mencipta imej untuk penilaian mereka, jenis imej yang akan dihasilkan bergantung kepada pelajar, tetapi mereka boleh membuat ilustrasi untuk cerita dongeng mereka sendiri, mencipta watak baru untuk cerita mereka, atau membantu mereka menggambarkan idea dan konsep mereka.

Berikut adalah contoh imej yang boleh dihasilkan oleh pelajar Edu4All jika mereka sedang belajar tentang monumen:
...
Midjourney berfungsi dengan cara yang serupa dengan DALL-E, ia menjana imej daripada prompt teks. Midjourney juga boleh digunakan untuk menjana imej menggunakan prompt seperti "kucing memakai topi", atau "anjing dengan gaya rambut mohawk".
...
## Cipta dan gunakan model Azure OpenAI
...
- **prompt**, adalah teks prompt yang digunakan untuk menjana imej. Dalam kes ini, kita menggunakan prompt "Arnab di atas kuda, memegang lolipop, di padang berkabus di mana bunga daffodil tumbuh".
...
Berikut adalah contoh menggunakan GPT Image:
  ...
  Imej asas hanya mengandungi ruang santai dengan kolam tetapi imej akhir akan mempunyai flamingo:
...
> Prompt : "Arnab di atas kuda, memegang lolipop, di padang berkabus di mana bunga daffodil tumbuh"
