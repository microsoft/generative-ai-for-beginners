...
[![Pengenalan kepada AI Generatif dan Model Bahasa Besar](../../../translated_images/ms/01-lesson-banner.2424cfd092f43366.webp)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![Lima pelajar muda melihat monitor - imej oleh DALLE2](../../../translated_images/ms/students-by-DALLE2.b70fddaced1042ee.webp)
...
![AI, ML, DL dan AI Generatif](../../../translated_images/ms/AI-diagram.c391fa518451a40d.webp)
...
![Contoh pengekodan token](../../../translated_images/ms/tokenizer-example.80a5c151ee7d1bd4.webp)
...
- **Arahan** yang menentukan jenis output yang kita harapkan daripada model. Arahan ini kadang-kadang mungkin mengandungi beberapa contoh atau data tambahan.
  ...
  1. Ringkasan artikel, buku, ulasan produk dan banyak lagi, bersama dengan pengekstrakan pandangan daripada data tidak berstruktur.
    ...
    ![Contoh ringkasan](../../../translated_images/ms/summarization-example.7b7ff97147b3d790.webp)
  
  2. Ideasi kreatif dan reka bentuk artikel, esei, tugasan atau lebih lagi.
      
     ![Contoh penulisan kreatif](../../../translated_images/ms/creative-writing-example.e24a685b5a543ad1.webp)

- **Soalan**, yang ditanya dalam bentuk perbualan dengan agen.
  
  ![Contoh perbualan](../../../translated_images/ms/conversation-example.60c2afc0f595fa59.webp)

- Bahagian **teks untuk dilengkapkan**, yang secara tidak langsung adalah permintaan untuk bantuan penulisan.
  
  ![Contoh pelengkap teks](../../../translated_images/ms/text-completion-example.cbb0f28403d42752.webp)
...
- Bahagian **kod** bersama dengan permintaan untuk menjelaskan dan mendokumentasikannya, atau komen yang meminta untuk menghasilkan sekeping kod yang melaksanakan tugas tertentu.
  ...
  ![Contoh pengekodan](../../../translated_images/ms/coding-example.50ebabe8a6afff20.webp)
