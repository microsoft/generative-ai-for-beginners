...
-->
[![関数呼び出しとの統合](../../../translated_images/14-lesson-banner.066d74a31727ac12.ja.png)](https://youtu.be/ewtQY_RJrzs?si=dyJ2bjiljH7UUHCh)
...
![LLMOpsとMLOpsの比較](../../../translated_images/01-llmops-shift.29bc933cb3bb0080.ja.png)
...
![LLMOpsのインフォグラフィック](../../../translated_images/02-llmops.70a942ead05a7645.ja.png)
...
![LLMOpsのワークフロー](../../../translated_images/03-llm-stage-flows.3a1e1c401235a6cf.ja.png)
...
![Azure AIの可能性](../../../translated_images/04-azure-ai-platform.80203baf03a12fa8.ja.png)

Azure AIは、複数のリソースを使用して、運用、サービス、プロジェクト、ベクトル検索、データベースのニーズを管理できます。

![Azure AIによるLLMOps](../../../translated_images/05-llm-azure-ai-prompt.a5ce85cdbb494bdf.ja.png)
...
![PromptFlowによるLLMOps](../../../translated_images/06-llm-promptflow.a183eba07a3a7fdf.ja.png)
