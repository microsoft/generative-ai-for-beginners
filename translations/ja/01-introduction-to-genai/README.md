...
[![生成AIと大規模言語モデルの紹介](../../../translated_images/ja/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![モニターを見ている5人の若い学生 - DALLE2による画像](../../../translated_images/ja/students-by-DALLE2.b70fddaced1042ee.png)
...
![AI、ML、DL、生成AI](../../../translated_images/ja/AI-diagram.c391fa518451a40d.png)
...
![トークン化の例](../../../translated_images/ja/tokenizer-example.80a5c151ee7d1bd4.png)
...
- **指示**: モデルから期待する出力の種類を指定するもの。この指示には、例や追加データが含まれることがあります。
  ...
  1. 記事、書籍、製品レビューなどの要約、または非構造化データからの洞察の抽出。
    ...
    ![要約の例](../../../translated_images/ja/summarization-example.7b7ff97147b3d790.png)
  
  2. 記事、エッセイ、課題などの創造的なアイデアとデザイン。
      
     ![創造的な文章の例](../../../translated_images/ja/creative-writing-example.e24a685b5a543ad1.png)

- **質問**: エージェントとの会話形式で尋ねるもの。
  
  ![会話の例](../../../translated_images/ja/conversation-example.60c2afc0f595fa59.png)

- **補完するテキストの一部**: 暗黙的に執筆支援を求めるもの。
  
  ![テキスト補完の例](../../../translated_images/ja/text-completion-example.cbb0f28403d42752.png)

- **コードの一部**: 説明や文書化を求めるコメント、または特定のタスクを実行するコードの生成を求めるコメント。
  
  ![コーディングの例](../../../translated_images/ja/coding-example.50ebabe8a6afff20.png)
