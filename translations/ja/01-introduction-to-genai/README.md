...
[![生成AIと大規模言語モデルの紹介](../../../translated_images/ja/01-lesson-banner.2424cfd092f43366.webp)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![AI、ML、DL、生成AI](../../../translated_images/ja/AI-diagram.c391fa518451a40d.webp)
...
- **指示**: モデルから期待する出力の種類を指定するもの。この指示には、例や追加データが含まれることがあります。
  ...
  2. 記事、エッセイ、課題などの創造的なアイデアとデザイン。
     ...
     ![創造的な文章の例](../../../translated_images/ja/creative-writing-example.e24a685b5a543ad1.webp)

- **質問**: エージェントとの会話形式で尋ねるもの。
  
  ![会話の例](../../../translated_images/ja/conversation-example.60c2afc0f595fa59.webp)
...
- **コードの一部**: 説明や文書化を求めるコメント、または特定のタスクを実行するコードの生成を求めるコメント。
  ...
  ![コーディングの例](../../../translated_images/ja/coding-example.50ebabe8a6afff20.webp)
