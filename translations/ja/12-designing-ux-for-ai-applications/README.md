...
![AIにおけるUXの考慮事項を示す画像](../../../translated_images/ja/uxinai.d5b4ed690f5cefff.webp)
...
![AIアプリケーションの説明可能性を明確に示すアプリのランディングページ](../../../translated_images/ja/explanability-in-ai.134426a96b498fbf.webp)
...
![ペルソナに基づいて質問に回答するAI](../../../translated_images/ja/solving-questions.b7dea1604de0cbd2.webp)

説明可能性のもう1つの重要な部分は、説明を簡素化することです。学生や教師はAIの専門家ではないかもしれません。そのため、アプリケーションができることやできないことの説明は簡潔で理解しやすいものであるべきです。

![AIの能力に関する簡潔な説明](../../../translated_images/ja/simplified-explanations.4679508a406c3621.webp)
...
![プロンプトと出力を修正するオプションがあるBingの検索結果](../../../translated_images/ja/bing1.293ae8527dbe2789.webp)

また、Bingのもう1つの機能として、ユーザーがアプリケーションが使用するデータに対してオプトインやオプトアウトする能力があります。学校のアプリケーションでは、学生が自分のノートや教師のリソースを復習資料として使用したい場合があります。

![プロンプトと出力を修正するオプションがあるBingの検索結果](../../../translated_images/ja/bing2.309f4845528a88c2.webp)
...
![フィードバックの提供とエラー処理](../../../translated_images/ja/feedback-loops.7955c134429a9466.webp)
