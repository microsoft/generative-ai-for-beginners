...
[![ジェネレーティブAIを活用したチャットアプリケーションの構築](../../../translated_images/07-lesson-banner.a279b937f2843833.ja.png)](https://youtu.be/R9V0ZY1BEQo?si=IHuU-fS9YWT8s4sA)
...
![ChatGPTのカスタム指示設定](../../../translated_images/custom-instructions.b96f59aa69356fcf.ja.png)

この「プロファイル」は、ChatGPTにリンクリストに関するレッスンプランを作成するよう促します。ChatGPTは、ユーザーの経験に基づいてより詳細なレッスンプランを求めている可能性を考慮しています。

![リンクリストに関するレッスンプランのプロンプト](../../../translated_images/lesson-plan-prompt.cc47c488cf1343df.ja.png)
