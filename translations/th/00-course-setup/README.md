...
อีกทางเลือกหนึ่งนอกจากการตั้งค่าบนเครื่องหรือ Codespace คือการใช้ [container](<https://en.wikipedia.org/wiki/Containerization_(computing)?WT.mc_id=academic-105485-koreyst>) ไดเรกทอรีพิเศษ `.devcontainer` ในรีโพนี้ช่วยให้ VS Code ตั้งโปรเจกต์ใน container ได้
