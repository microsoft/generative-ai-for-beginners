...
[![การสร้างแอปพลิเคชัน AI แบบ Low Code](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.th.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![อธิบายแอปที่คุณต้องการสร้าง](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.th.png)
...
1. AI Copilot จะเสนอแนะตาราง Dataverse พร้อมฟิลด์ที่คุณต้องการเพื่อจัดเก็บข้อมูลที่คุณต้องการติดตามและตัวอย่างข้อมูลบางส่วน จากนั้นคุณสามารถปรับแต่งตารางให้ตรงกับความต้องการของคุณโดยใช้ฟีเจอร์ผู้ช่วย AI Copilot ผ่านขั้นตอนการสนทนา
   ...
   ![ฟิลด์ที่แนะนำในตารางใหม่ของคุณ](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.th.png)
...
![การเพิ่มฟิลด์ใหม่](../../../translated_images/copilot-new-column.35e15ff21acaf274.th.png)
...
![การเพิ่มหน้าจอใหม่ผ่านคำสั่ง](../../../translated_images/copilot-new-screen.2e0bef7132a17392.th.png)
...
![เลือกตารางใหม่](../../../translated_images/describe-new-table.0792373eb757281e.th.png)
...
![อธิบายตาราง](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.th.png)
...
![ตาราง Dataverse ที่แนะนำ](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.th.png)
...
![โมเดล AI Builder](../../../translated_images/ai-builder-models.8069423b84cfc47f.th.png)
...
2. ใช้พื้นที่ข้อความในหน้าหลักเพื่ออธิบายโฟลว์ที่คุณต้องการสร้าง เช่น **_ประมวลผลใบแจ้งหนี้เมื่อมันมาถึงในกล่องจดหมายของฉัน_** คลิกปุ่ม **Send** เพื่อส่งคำสั่งไปยัง AI Copilot
   ...
   ![Copilot power automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.th.png)
...
8. ลบการดำเนินการ **Condition** ออกจากโฟลว์เพราะคุณจะไม่ใช้มัน โฟลว์ควรมีลักษณะดังภาพด้านล่าง:
   ...
   ![power automate, ลบการดำเนินการ](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.th.png)
...
11. เลือก **Table** ที่คุณสร้างไว้ก่อนหน้านี้ เช่น คุณสามารถเลือกตาราง **Invoice Information** เลือกเนื้อหาไดนามิกจากการดำเนินการก่อนหน้าเพื่อเติมฟิลด์ต่อไปนี้:
    ...
    ![power automate add row](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.th.png)
...
![สร้างคำสั่ง](../../../translated_images/create-prompt-gpt.69d429300c2e870a.th.png)
