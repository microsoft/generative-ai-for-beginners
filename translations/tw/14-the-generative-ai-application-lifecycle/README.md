...
-->
[![與函數呼叫整合](../../../translated_images/tw/14-lesson-banner.066d74a31727ac12.png)](https://youtu.be/ewtQY_RJrzs?si=dyJ2bjiljH7UUHCh)
...
![LLMOps 與 MLOps 比較](../../../translated_images/tw/01-llmops-shift.29bc933cb3bb0080.png)
...
![LLMOps 資訊圖表](../../../translated_images/tw/02-llmops.70a942ead05a7645.png)
...
![LLMOps 工作流程](../../../translated_images/tw/03-llm-stage-flows.3a1e1c401235a6cf.png)
...
![Azure AI 可能性](../../../translated_images/tw/04-azure-ai-platform.80203baf03a12fa8.png)

Azure AI 允許您使用多種資源，管理您的運營、服務、專案、向量搜尋和資料庫需求。

![使用 Azure AI 的 LLMOps](../../../translated_images/tw/05-llm-azure-ai-prompt.a5ce85cdbb494bdf.png)
...
![使用 PromptFlow 的 LLMOps](../../../translated_images/tw/06-llm-promptflow.a183eba07a3a7fdf.png)
