...
[![建立生成式 AI 驅動的聊天應用程式](../../../translated_images/tw/07-lesson-banner.a279b937f2843833.webp)](https://youtu.be/R9V0ZY1BEQo?si=IHuU-fS9YWT8s4sA)
...
![ChatGPT 中的自定義指令設定](../../../translated_images/tw/custom-instructions.b96f59aa69356fcf.webp)

此「檔案」提示 ChatGPT 創建一個關於鏈表的課程計劃。注意 ChatGPT 根據使用者的經驗，提供了一個更深入的課程計劃。

![ChatGPT 中關於鏈表課程計劃的提示](../../../translated_images/tw/lesson-plan-prompt.cc47c488cf1343df.webp)
