...
[![探索與比較不同的LLM](../../../translated_images/tw/02-lesson-banner.ef94c84979f97f60.png)](https://youtu.be/KIRUeDKscfI?si=8BHX1zvwzQBn-PlK)
...
![基礎模型與LLM的區別](../../../translated_images/tw/FoundationModel.e4859dbb7a825c94.png)
...
![基礎模型](../../../translated_images/tw/Multimodal.2c389c6439e0fc51.png)
...
![嵌入](../../../translated_images/tw/Embedding.c3708fe988ccf760.png)
...
![圖像生成](../../../translated_images/tw/Image.349c080266a763fd.png)
...
![文本和代碼生成](../../../translated_images/tw/Text.a8c0cf139e5cc2a0.png)
...
![模型目錄](../../../translated_images/tw/AzureAIStudioModelCatalog.3cf8a499aa8ba031.png)

- 查看模型卡，包括詳細的用途描述和訓練數據、代碼示例以及內部評估庫的評估結果。

![模型卡](../../../translated_images/tw/ModelCard.598051692c6e400d.png)
...
![模型基準測試](../../../translated_images/tw/ModelBenchmarks.254cb20fbd06c03a.png)

- 利用 Azure AI Studio 的實驗和追蹤功能，基於自定義訓練數據微調模型，以提高模型在特定工作負載中的性能。

![模型微調](../../../translated_images/tw/FineTuning.aac48f07142e36fd.png)
...
![模型部署](../../../translated_images/tw/ModelDeploy.890da48cbd0bccdb.png)
...
![LLMs 部署](../../../translated_images/tw/Deploy.18b2d27412ec8c02.png)
