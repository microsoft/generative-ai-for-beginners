...
[![အနည်းဆုံးကုဒ် AI အက်ပလီကေးရှင်းများ တည်ဆောက်ခြင်း](../../../translated_images/my/10-lesson-banner.a01ac8fe3fd86310.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Select new table](../../../translated_images/my/describe-new-table.0792373eb757281e.png)
...
![Describe the table](../../../translated_images/my/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.png)
...
![Suggested Dataverse table](../../../translated_images/my/copilot-dataverse-table.b3bc936091324d9d.png)
...
![AI builder models](../../../translated_images/my/ai-builder-models.8069423b84cfc47f.png)
...
2. အိမ်စာမျက်နှာမှာရှိတဲ့ text area ကို အသုံးပြုပြီး သင့် workflow ကို ဖော်ပြပါ။ ဥပမာအားဖြင့် **_အင်ဗွိုင်းတစ်ခု mailbox ထဲရောက်လာတဲ့အခါ process လုပ်ပါ_**။ **Send** ခလုတ်ကို နှိပ်ပြီး AI Copilot ကို prompt ကို ပို့ပါ။
   ...
   ![Copilot power automate](../../../translated_images/my/copilot-chat-prompt-powerautomate.f377e478cc8412de.png)
...
8. flow ထဲက **Condition** action ကို ဖယ်ရှားပါ။ flow က အောက်ပါ screenshot လို ဖြစ်သင့်ပါတယ်-
   ...
   ![power automate, remove actions](../../../translated_images/my/powerautomate-remove-actions.7216392fe684ceba.png)
...
11. သင်ဖန်တီးထားတဲ့ ဇယားကို ရွေးပါ။ ဥပမာအားဖြင့် **Invoice Information** ဇယားကို ရွေးနိုင်ပါတယ်။ အောက်ပါ field တွေကို populate လုပ်ဖို့ dynamic content ကို ရွေးပါ-
    ...
    ![power automate add row](../../../translated_images/my/powerautomate-add-row.5edce45e5dd3d51e.png)
...
![create a prompt](../../../translated_images/my/create-prompt-gpt.69d429300c2e870a.png)
