...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-25T17:24:55+00:00",
...
- **Bildebehandling og syntese**. Du kan generere bilder for en rekke brukstilfeller, som bildebehandling og bildesyntese.

- **Anvendt i ulike industrier**. De kan også brukes til å generere bilder for en rekke industrier som MedTech, turisme, spillutvikling og mer.

## Scenario: Edu4All

Som en del av denne leksjonen vil vi fortsette å jobbe med vår oppstart, Edu4All. Studentene vil lage bilder for sine vurderinger, nøyaktig hvilke bilder er opp til studentene, men de kan være illustrasjoner for deres egen eventyrfortelling eller skape en ny karakter for historien sin eller hjelpe dem med å visualisere sine ideer og konsepter.

Her er hva Edu4Alls studenter kan generere for eksempel hvis de jobber i klassen med monumenter:
...
[DALL-E](https://openai.com/dall-e-2?WT.mc_id=academic-105485-koreyst) og [Midjourney](https://www.midjourney.com/?WT.mc_id=academic-105485-koreyst) er to av de mest populære modellene for bildegenerering, de lar deg bruke prompts for å generere bilder.
...
Midjourney fungerer på en lignende måte som DALL-E, det genererer bilder fra tekstprompts. Midjourney kan også brukes til å generere bilder ved hjelp av prompts som "en katt med hatt", eller en "hund med mohawk".
...
- **openai**, dette biblioteket er det du vil bruke for å interagere med OpenAI API.
- **pillow**, for å arbeide med bilder i Python.
- **requests**, for å hjelpe deg med å lage HTTP-forespørsler.
...
- Til slutt åpner vi bildet og bruker den standard bildeviseren for å vise det:
...
- **Utføre redigeringer**. Ved å gi et eksisterende bilde en maske og en prompt, kan du endre et bilde. For eksempel kan du legge til noe i en del av et bilde. Tenk deg vårt kaninbilde, du kan legge til en hatt på kaninen. Hvordan du ville gjort det er ved å gi bildet, en maske (identifisere delen av området for endringen) og en tekstprompt for å si hva som skal gjøres.
  ...
  Grunnbildet ville bare inneholde kaninen, men det endelige bildet ville ha hatten på kaninen.

- **Skape variasjoner**. Ideen er at du tar et eksisterende bilde og ber om at variasjoner blir opprettet. For å lage en variasjon, gir du et bilde og en tekstprompt og kode som så:
  ...
  > Merk, dette støttes bare på OpenAI
...
![Kanin på en hest holder en kjærlighet, versjon 1](../../../translated_images/v1-generated-image.a295cfcffa3c13c2432eb1e41de7e49a78c814000fb1b462234be24b6e0db7ea.no.png)
...
Som du kan se, bildene er like, men ikke de samme. La oss prøve å endre temperaturverdien til 0.1 og se hva som skjer:
...
Metaprompts er tekstprompts som brukes til å kontrollere outputen til en Generativ AI-modell, de er plassert før tekstprompten, og brukes til å kontrollere outputen til modellen og innebygd i applikasjoner for å kontrollere outputen til modellen. Innebygger prompt-inputen og metaprompt-inputen i en enkelt tekstprompt.
...
Fra prompten ovenfor kan du se hvordan alle bilder som blir opprettet tar hensyn til metaprompten.

## Oppgave - la oss sette studentene i gang

Vi introduserte Edu4All i begynnelsen av denne leksjonen. Nå er det på tide å sette studentene i stand til å generere bilder for sine vurderinger.
...
Gå videre til Leksjon 10 hvor vi skal se på hvordan man [bygger AI-applikasjoner med lav kode](../10-building-low-code-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)
