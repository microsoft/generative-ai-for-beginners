...
[![Düşük Kodlu Yapay Zeka Uygulamaları Oluşturma](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.tr.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Oluşturmak istediğiniz uygulamayı tanımlayın](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.tr.png)
...
1. Yapay zeka Copilot, takip etmek istediğiniz verileri depolamak için ihtiyaç duyduğunuz alanlarla bir Dataverse Tablosu ve bazı örnek veriler önerir. Daha sonra bu tabloyu, AI Copilot asistan özelliğini kullanarak konuşma adımlarıyla ihtiyaçlarınıza göre özelleştirebilirsiniz.
   ...
   ![Yeni tablonuzdaki önerilen alanlar](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.tr.png)
...
![Yeni bir alan ekleme](../../../translated_images/copilot-new-column.35e15ff21acaf274.tr.png)
...
![Bir istem talimatı ile yeni bir ekran ekleme](../../../translated_images/copilot-new-screen.2e0bef7132a17392.tr.png)
...
![Yeni tabloyu seçin](../../../translated_images/describe-new-table.0792373eb757281e.tr.png)
...
![Tabloyu tanımlayın](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.tr.png)
...
![Önerilen Dataverse tablosu](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.tr.png)
...
![AI builder modelleri](../../../translated_images/ai-builder-models.8069423b84cfc47f.tr.png)
...
2. Ana ekrandaki metin alanını kullanarak oluşturmak istediğiniz iş akışını açıklayın. Örneğin, **_Posta kutuma bir fatura geldiğinde işle_** yazabilirsiniz. AI Copilot'a isteği göndermek için **Gönder** düğmesine tıklayın.
   ...
   ![Copilot power automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.tr.png)
...
8. Akıştan **Koşul** eylemini kaldırın çünkü bunu kullanmayacaksınız. Şu ekran görüntüsüne benzemelidir:
   ...
   ![power automate, eylemleri kaldır](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.tr.png)
...
11. Daha önce oluşturduğunuz **Tablo**yu seçin. Örneğin, **Fatura Bilgileri** tablosunu seçebilirsiniz. Önceki eylemden dinamik içeriği seçerek aşağıdaki alanları doldurun:
    ...
    ![power automate satır ekle](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.tr.png)
...
![bir istem oluştur](../../../translated_images/create-prompt-gpt.69d429300c2e870a.tr.png)
