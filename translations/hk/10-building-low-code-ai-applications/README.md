...
[![建立低代碼 AI 應用程式](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.hk.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![描述您想建立的應用程式](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.hk.png)
...
1. AI Copilot 會建議一個包含所需字段的 Dataverse 表格來存儲您希望追蹤的數據以及一些示例數據。您可以通過 AI Copilot 助理功能的對話式步驟來自定義表格以滿足您的需求。
   ...
   ![新表格中的建議字段](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.hk.png)
...
![新增一個字段](../../../translated_images/copilot-new-column.35e15ff21acaf274.hk.png)
...
![通過提示指令新增新界面](../../../translated_images/copilot-new-screen.2e0bef7132a17392.hk.png)
...
![選擇新表格](../../../translated_images/describe-new-table.0792373eb757281e.hk.png)

3. 在 **Describe the new Table** 頁面，使用文本框描述您想要創建的表格。例如，**_我想創建一個表格來存儲發票信息_**。點擊 **Send** 按鈕將提示發送給 AI Copilot。

![描述表格](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.hk.png)

4. AI Copilot 會建議一個包含您需要的字段的 Dataverse 表格來存儲您想要追蹤的數據，並提供一些示例數據。然後，您可以使用 AI Copilot 助手功能通過對話步驟自定義表格以滿足您的需求。

![建議的 Dataverse 表格](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.hk.png)
...
![AI builder 模型](../../../translated_images/ai-builder-models.8069423b84cfc47f.hk.png)
...
2. 在主頁的文本框中描述您想要構建的工作流程。例如，**_當我的郵箱收到發票時處理它_**。點擊 **Send** 按鈕將提示發送給 AI Copilot。
   ...
   ![Copilot power automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.hk.png)
...
8. 從流程中移除 **Condition** 操作，因為您不會使用它。流程應看起來像以下截圖：
   ...
   ![power automate, remove actions](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.hk.png)
...
11. 選擇您之前創建的 **Table**。例如，您可以選擇 **Invoice Information** 表格。從之前的操作中選擇動態內容來填充以下字段：
    ...
    ![power automate add row](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.hk.png)
...
![創建提示](../../../translated_images/create-prompt-gpt.69d429300c2e870a.hk.png)
