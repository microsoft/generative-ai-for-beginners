...
1. AI Copilot 會建議一個包含所需字段的 Dataverse 表格來存儲您希望追蹤的數據以及一些示例數據。您可以通過 AI Copilot 助理功能的對話式步驟來自定義表格以滿足您的需求。
   ...
   ![新表格中的建議字段](../../../translated_images/zh-HK/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.webp)
...
![新增一個字段](../../../translated_images/zh-HK/copilot-new-column.35e15ff21acaf274.webp)
...
![通過提示指令新增新界面](../../../translated_images/zh-HK/copilot-new-screen.2e0bef7132a17392.webp)
...
![創建提示](../../../translated_images/zh-HK/create-prompt-gpt.69d429300c2e870a.webp)
