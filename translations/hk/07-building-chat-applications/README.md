...
![ChatGPT 中的自定義指令設置](../../../translated_images/zh-HK/custom-instructions.b96f59aa69356fcf.webp)

此「檔案」提示 ChatGPT 創建一個關於鏈表的課程計劃。注意，ChatGPT 根據用戶的經驗，提供了一個更深入的課程計劃。

![ChatGPT 中關於鏈表課程計劃的提示](../../../translated_images/zh-HK/lesson-plan-prompt.cc47c488cf1343df.webp)
