...
[![為人工智能應用設計用戶體驗](../../../translated_images/hk/12-lesson-banner.c53c3c7c802e8f56.png)](https://youtu.be/VKbCejSICA8?si=MKj7GQYHfXRZyWW6)
...
![展示人工智能中的用戶體驗考量的圖片](../../../translated_images/hk/uxinai.d5b4ed690f5cefff.png)
...
![一個應用程式登錄頁面，清楚地展示人工智能應用程式中的可解釋性](../../../translated_images/hk/explanability-in-ai.134426a96b498fbf.png)

另一個例子是人工智能如何使用用戶和個人數據。例如，一個具有學生角色的用戶可能會因其角色而受到限制。人工智能可能無法直接提供問題的答案，但可以幫助用戶思考如何解決問題。

![人工智能根據角色回答問題](../../../translated_images/hk/solving-questions.b7dea1604de0cbd2.png)

可解釋性的另一個重要部分是簡化解釋。學生和教師可能不是人工智能專家，因此應用程式的功能和限制的解釋應該簡單易懂。

![簡化人工智能能力的解釋](../../../translated_images/hk/simplified-explanations.4679508a406c3621.png)
...
![Bing 搜索結果，提供修改提示和輸出的選項](../../../translated_images/hk/bing1.293ae8527dbe2789.png)

Bing 的另一個功能是允許用戶控制應用程式使用的數據。例如，學校應用程式中的學生可能希望使用自己的筆記以及教師的資源作為複習材料。

![Bing 搜索結果，提供修改提示和輸出的選項](../../../translated_images/hk/bing2.309f4845528a88c2.png)
...
![提供反饋和處理錯誤](../../../translated_images/hk/feedback-loops.7955c134429a9466.png)
