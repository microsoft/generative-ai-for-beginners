...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:21:25+00:00",
...
| 04  | [理解提示工程的基礎知識](./04-prompt-engineering-fundamentals/README.md?WT.mc_id=academic-105485-koreyst)             | **學習：** 實踐提示工程的最佳做法                                           | [視頻](https://aka.ms/gen-ai-lesson4-gh?WT.mc_id=academic-105485-koreyst)  | [了解更多](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
特別感謝 [**John Aziz**](https://www.linkedin.com/in/john0isaac/) 為所有 GitHub Actions 和工作流程的創建所作出的貢獻。

[**Bernhard Merkle**](https://www.linkedin.com/in/bernhard-merkle-738b73/) 為每一課程提供了重要的改進，提升了學習者及程式碼的使用體驗。
