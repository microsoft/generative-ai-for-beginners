...
[![檢索增強生成 (RAG) 和向量數據庫](../../../translated_images/15-lesson-banner.ac49e59506175d4f.hk.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![展示 RAG 工作原理的圖示](../../../translated_images/how-rag-works.f5d0ff63942bd3a6.hk.png)
...
![展示 RAG 架構的圖示](../../../translated_images/encoder-decode.f2658c25d0eadee2.hk.png)
...
![嵌入單詞 cat 的示例](../../../translated_images/cat.74cbd7946bc9ca38.hk.png)
