...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T07:44:57+00:00",
...
90 年代出現了轉折點，開始將統計方法應用於文字分析，催生了新的演算法——機器學習，能夠從資料中學習模式，而不需明確編程。這種方法讓機器能模擬人類語言理解：透過訓練文字與標籤配對的統計模型，模型能將未知輸入文字分類到預先定義的意圖標籤。
