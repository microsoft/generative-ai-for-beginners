...
[![تولید تقویت‌شده با بازیابی (RAG) و پایگاه‌های داده برداری](../../../translated_images/15-lesson-banner.ac49e59506175d4f.fa.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![تصویری که نشان می‌دهد RAG‌ها چگونه کار می‌کنند](../../../translated_images/how-rag-works.f5d0ff63942bd3a6.fa.png)
...
![تصویری که نشان می‌دهد معماری RAG‌ها چگونه است](../../../translated_images/encoder-decode.f2658c25d0eadee2.fa.png)
...
![یک تعبیه از کلمه گربه](../../../translated_images/cat.74cbd7946bc9ca38.fa.png)
