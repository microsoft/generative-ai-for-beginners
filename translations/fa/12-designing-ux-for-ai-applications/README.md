...
[![طراحی تجربه کاربری برای برنامه‌های هوش مصنوعی](../../../translated_images/12-lesson-banner.c53c3c7c802e8f56.fa.png)](https://youtu.be/VKbCejSICA8?si=MKj7GQYHfXRZyWW6)
...
![تصویری که ملاحظات UX در هوش مصنوعی را نشان می‌دهد](../../../translated_images/uxinai.d5b4ed690f5cefff.fa.png)
...
![صفحه فرود یک برنامه با توضیح واضح در مورد توضیح‌پذیری در برنامه‌های هوش مصنوعی](../../../translated_images/explanability-in-ai.134426a96b498fbf.fa.png)
...
![هوش مصنوعی به سوالات بر اساس شخصیت پاسخ می‌دهد](../../../translated_images/solving-questions.b7dea1604de0cbd2.fa.png)
...
![توضیحات ساده در مورد قابلیت‌های هوش مصنوعی](../../../translated_images/simplified-explanations.4679508a406c3621.fa.png)
...
![نتایج جستجوی Bing با گزینه‌هایی برای تغییر درخواست و خروجی](../../../translated_images/bing1.293ae8527dbe2789.fa.png)
...
![نتایج جستجوی Bing با گزینه‌هایی برای تغییر درخواست و خروجی](../../../translated_images/bing2.309f4845528a88c2.fa.png)
...
![ارائه بازخورد و برخورد با خطاها](../../../translated_images/feedback-loops.7955c134429a9466.fa.png)
