...
[![مقدمه‌ای بر هوش مصنوعی مولد و مدل‌های زبانی بزرگ](../../../translated_images/01-lesson-banner.2424cfd092f43366.fa.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![پنج دانش‌آموز جوان در حال نگاه کردن به یک مانیتور - تصویر توسط DALLE2](../../../translated_images/students-by-DALLE2.b70fddaced1042ee.fa.png)
...
![هوش مصنوعی، یادگیری ماشین، یادگیری عمیق و هوش مصنوعی مولد](../../../translated_images/AI-diagram.c391fa518451a40d.fa.png)
...
![مثال توکن‌سازی](../../../translated_images/tokenizer-example.80a5c151ee7d1bd4.fa.png)
...
- یک **دستورالعمل** که نوع خروجی مورد انتظار از مدل را مشخص می‌کند. این دستورالعمل گاهی ممکن است شامل چند مثال یا داده‌های اضافی باشد.
  ...
  1. خلاصه‌سازی یک مقاله، کتاب، نظرات محصول و موارد دیگر، همراه با استخراج نکات از داده‌های غیرساختاریافته.
    ...
    ![مثال خلاصه‌سازی](../../../translated_images/summarization-example.7b7ff97147b3d790.fa.png)
  
  2. ایده‌پردازی خلاقانه و طراحی یک مقاله، انشا، تکلیف یا موارد دیگر.
      
     ![مثال نوشتن خلاقانه](../../../translated_images/creative-writing-example.e24a685b5a543ad1.fa.png)

- یک **سؤال**، که به صورت مکالمه با یک عامل پرسیده می‌شود.
  
  ![مثال مکالمه](../../../translated_images/conversation-example.60c2afc0f595fa59.fa.png)

- یک بخش **متن برای تکمیل**، که به طور ضمنی درخواست کمک برای نوشتن است.
  
  ![مثال تکمیل متن](../../../translated_images/text-completion-example.cbb0f28403d42752.fa.png)

- یک بخش **کد** همراه با درخواست توضیح و مستندسازی آن، یا یک نظر که درخواست تولید یک قطعه کد برای انجام یک وظیفه خاص را دارد.
  
  ![مثال کدنویسی](../../../translated_images/coding-example.50ebabe8a6afff20.fa.png)
