...
[![ساخت برنامه‌های هوش مصنوعی با کدنویسی کم](../../../translated_images/fa/10-lesson-banner.a01ac8fe3fd86310.webp)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![اضافه کردن یک فیلد جدید](../../../translated_images/fa/copilot-new-column.35e15ff21acaf274.webp)
...
![اضافه کردن یک صفحه جدید با دستور](../../../translated_images/fa/copilot-new-screen.2e0bef7132a17392.webp)
...
2. از قسمت متن در صفحه اصلی برای توصیف جریان کاری که می‌خواهید بسازید استفاده کنید. برای مثال، **_پردازش یک فاکتور وقتی به صندوق ایمیل من می‌رسد_**. روی دکمه **Send** کلیک کنید تا درخواست به AI Copilot ارسال شود.
   ...
   ![Copilot در Power Automate](../../../translated_images/fa/copilot-chat-prompt-powerautomate.f377e478cc8412de.webp)
...
8. اقدام **Condition** را از جریان حذف کنید زیرا از آن استفاده نخواهید کرد. باید به شکل تصویر زیر باشد:
   ...
   ![Power Automate، حذف اقدامات](../../../translated_images/fa/powerautomate-remove-actions.7216392fe684ceba.webp)
...
![ایجاد درخواست](../../../translated_images/fa/create-prompt-gpt.69d429300c2e870a.webp)
