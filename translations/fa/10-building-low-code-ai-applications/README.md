...
[![ساخت برنامه‌های هوش مصنوعی با کدنویسی کم](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.fa.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![توصیف برنامه‌ای که می‌خواهید بسازید](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.fa.png)
...
1. Copilot یک جدول Dataverse با فیلدهایی که برای ذخیره داده‌هایی که می‌خواهید ردیابی کنید و برخی داده‌های نمونه نیاز دارید، پیشنهاد می‌دهد. سپس می‌توانید جدول را با استفاده از ویژگی دستیار Copilot از طریق مراحل مکالمه‌ای سفارشی کنید.
   ...
   ![فیلدهای پیشنهادی در جدول جدید شما](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.fa.png)
...
![اضافه کردن یک فیلد جدید](../../../translated_images/copilot-new-column.35e15ff21acaf274.fa.png)
...
![اضافه کردن یک صفحه جدید با دستور](../../../translated_images/copilot-new-screen.2e0bef7132a17392.fa.png)
...
![انتخاب جدول جدید](../../../translated_images/describe-new-table.0792373eb757281e.fa.png)
...
![توصیف جدول](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.fa.png)
...
![جدول پیشنهادی Dataverse](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.fa.png)
...
![مدل‌های AI Builder](../../../translated_images/ai-builder-models.8069423b84cfc47f.fa.png)
...
2. از قسمت متن در صفحه اصلی برای توصیف جریان کاری که می‌خواهید بسازید استفاده کنید. برای مثال، **_پردازش یک فاکتور وقتی به صندوق ایمیل من می‌رسد_**. روی دکمه **Send** کلیک کنید تا درخواست به AI Copilot ارسال شود.
   ...
   ![Copilot در Power Automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.fa.png)
...
8. اقدام **Condition** را از جریان حذف کنید زیرا از آن استفاده نخواهید کرد. باید به شکل تصویر زیر باشد:
   ...
   ![Power Automate، حذف اقدامات](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.fa.png)
...
11. جدول ایجادشده قبلی را انتخاب کنید. برای مثال، می‌توانید جدول **Invoice Information** را انتخاب کنید. محتوای پویا از اقدام قبلی را برای پر کردن فیلدهای زیر انتخاب کنید:
    ...
    ![Power Automate افزودن ردیف](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.fa.png)
...
![ایجاد درخواست](../../../translated_images/create-prompt-gpt.69d429300c2e870a.fa.png)
