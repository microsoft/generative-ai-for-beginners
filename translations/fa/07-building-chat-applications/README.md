...
[![ساخت برنامه‌های چت مبتنی بر هوش مصنوعی مولد](../../../translated_images/fa/07-lesson-banner.a279b937f2843833.png)](https://youtu.be/R9V0ZY1BEQo?si=IHuU-fS9YWT8s4sA)
...
![تنظیمات دستورالعمل‌های سفارشی در ChatGPT](../../../translated_images/fa/custom-instructions.b96f59aa69356fcf.png)
...
![یک درخواست در ChatGPT برای برنامه درس درباره لیست‌های پیوندی](../../../translated_images/fa/lesson-plan-prompt.cc47c488cf1343df.png)
