...
[![ساخت برنامه‌های چت مبتنی بر هوش مصنوعی مولد](../../../translated_images/07-lesson-banner.a279b937f2843833.fa.png)](https://youtu.be/R9V0ZY1BEQo?si=IHuU-fS9YWT8s4sA)
...
![تنظیمات دستورالعمل‌های سفارشی در ChatGPT](../../../translated_images/custom-instructions.b96f59aa69356fcf.fa.png)
...
![یک درخواست در ChatGPT برای برنامه درس درباره لیست‌های پیوندی](../../../translated_images/lesson-plan-prompt.cc47c488cf1343df.fa.png)
