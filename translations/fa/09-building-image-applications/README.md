...
[![ساخت برنامه‌های تولید تصویر](../../../translated_images/09-lesson-banner.906e408c741f4411.fa.png)](https://youtu.be/B5VP0_J7cs8?si=5P3L5o7F_uS_QcG9)
...
![استارتاپ Edu4All، کلاس درباره بناهای تاریخی، برج ایفل](../../../translated_images/startup.94d6b79cc4bb3f5a.fa.png)
...
<div style="display: flex; justify-content: space-between; align-items: center; margin: 20px 0;">
  <img src="../../../translated_images/sunlit_lounge.a75a0cb61749db0e.fa.png" style="width: 30%; max-width: 200px; height: auto;">
  <img src="../../../translated_images/mask.1b2976ccec9e011e.fa.png" style="width: 30%; max-width: 200px; height: auto;">
  <img src="../../../translated_images/sunlit_lounge_result.76ae02957c0bbeb8.fa.png" style="width: 30%; max-width: 200px; height: auto;">
</div>
...
![خرگوش روی اسب در حال نگه داشتن آب‌نبات چوبی، نسخه 1](../../../translated_images/v1-generated-image.a295cfcffa3c13c2.fa.png)

حالا همان پرامپت را دوباره اجرا می‌کنیم تا ببینیم که تصویر یکسانی دریافت نمی‌کنیم:

![تصویر تولید شده خرگوش روی اسب](../../../translated_images/v2-generated-image.33f55a3714efe61d.fa.png)
...
- ![دما 0، نسخه 1](../../../translated_images/v1-temp-generated-image.a4346e1d2360a056.fa.png)
- ![دما 0، نسخه 2](../../../translated_images/v2-temp-generated-image.871d0c920dbfb0f1.fa.png)
