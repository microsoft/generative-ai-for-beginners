...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:38:14+00:00",
...
पाठ "सीखें" पाठ के रूप में लेबल किए गए हैं जो जनरेटिव AI की अवधारणा को समझाते हैं या "बनाएं" पाठ जो एक अवधारणा और कोड उदाहरणों को **Python** और **TypeScript** में समझाते हैं जब संभव हो।
...
हमने आपके विकास वातावरण को सेटअप करने में मदद करने के लिए **[कोर्स सेटअप](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)** पाठ बनाया है।
...
हमारे [आधिकारिक Azure AI Foundry Discord सर्वर](https://aka.ms/genai-discord?WT.mc_id=academic-105485-koreyst) में शामिल हों ताकि इस कोर्स को लेने वाले अन्य शिक्षार्थियों से मिलें और नेटवर्क बनाएं।
...
[Microsoft for Startups](https://www.microsoft.com/startups) पर जाएं और आज ही Azure क्रेडिट के साथ निर्माण शुरू करने के तरीके जानें।
...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 00  | [कोर्स सेटअप](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)                                                                 | **सीखें:** अपने विकास वातावरण को कैसे सेटअप करें                                            | वीडियो जल्द आ रहा है                                                                 | [अधिक जानें](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 14  | [जनरेटिव AI एप्लिकेशन लाइफसाइकिल](./14-the-generative-ai-application-lifecycle/README.md?WT.mc_id=academic-105485-koreyst)           | **जानें:** LLM लाइफसाइकिल और LLMOps को प्रबंधित करने के लिए उपकरण और मीट्रिक्स                         | [वीडियो](https://aka.ms/gen-ai-lesson14-gh?WT.mc_id=academic-105485-koreyst) | [अधिक जानें](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
[**John Aziz**](https://www.linkedin.com/in/john0isaac/) को सभी GitHub Actions और वर्कफ़्लो बनाने के लिए विशेष धन्यवाद।
...
- [शुरुआती लोगों के लिए मॉडल संदर्भ प्रोटोकॉल](https://github.com/microsoft/mcp-for-beginners)
- [शुरुआती लोगों के लिए AI एजेंट](https://github.com/microsoft/ai-agents-for-beginners)
...
- [AI पेयर्ड प्रोग्रामिंग के लिए GitHub Copilot में महारत हासिल करना](https://aka.ms/GitHubCopilotAI)
...
यदि आप अटक जाते हैं या AI एप्लिकेशन बनाने के बारे में कोई प्रश्न हैं, तो शामिल हों:
