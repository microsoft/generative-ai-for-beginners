...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:28:54+00:00",
...
_ऑटोरेग्रेसिव ट्रांसफॉर्मर_ परिभाषित करता है कि मॉडल टेक्स्ट विवरणों से इमेज कैसे जनरेट करता है। यह एक समय में एक पिक्सल जनरेट करता है और फिर जनरेट किए गए पिक्सल्स का उपयोग अगले पिक्सल को जनरेट करने के लिए करता है। यह प्रक्रिया तब तक चलती है जब तक इमेज पूरी नहीं हो जाती।
...
1. _.env_ नामक फाइल बनाएं और निम्नलिखित सामग्री जोड़ें:
   ...
   Azure OpenAI Foundry Portal में अपने संसाधन के "Deployments" सेक्शन में यह जानकारी ढूंढें।

1. ऊपर दी गई लाइब्रेरीज़ को _requirements.txt_ नामक फाइल में इस प्रकार जोड़ें:
...
## अपने एप्लिकेशन के लिए मेटाप्रॉम्प्ट्स के साथ सीमाएं कैसे परिभाषित करें
