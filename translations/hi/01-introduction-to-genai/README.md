...
[![जनरेटिव एआई और बड़े भाषा मॉडल का परिचय](../../../translated_images/01-lesson-banner.2424cfd092f43366.hi.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![पांच युवा छात्र एक मॉनिटर को देख रहे हैं - DALLE2 द्वारा बनाई गई छवि](../../../translated_images/students-by-DALLE2.b70fddaced1042ee.hi.png)
...
![एआई, एमएल, डीएल और जनरेटिव एआई](../../../translated_images/AI-diagram.c391fa518451a40d.hi.png)
...
![टोकनाइज़ेशन का उदाहरण](../../../translated_images/tokenizer-example.80a5c151ee7d1bd4.hi.png)
...
- एक **निर्देश** जो मॉडल से अपेक्षित आउटपुट के प्रकार को निर्दिष्ट करता है। यह निर्देश कभी-कभी कुछ उदाहरण या कुछ अतिरिक्त डेटा को भी शामिल कर सकता है।
  ...
  1. लेख, पुस्तक, उत्पाद समीक्षाओं और अधिक का सारांश, साथ ही असंरचित डेटा से अंतर्दृष्टि निकालना।
    ...
    ![सारांश का उदाहरण](../../../translated_images/summarization-example.7b7ff97147b3d790.hi.png)
  
  2. एक लेख, निबंध, असाइनमेंट या अधिक का रचनात्मक विचार और डिज़ाइन।
      
     ![रचनात्मक लेखन का उदाहरण](../../../translated_images/creative-writing-example.e24a685b5a543ad1.hi.png)

- एक **प्रश्न**, जो एक एजेंट के साथ बातचीत के रूप में पूछा गया हो।
  
  ![बातचीत का उदाहरण](../../../translated_images/conversation-example.60c2afc0f595fa59.hi.png)

- **पूरा करने के लिए टेक्स्ट का एक हिस्सा**, जो अप्रत्यक्ष रूप से लेखन सहायता के लिए एक अनुरोध है।
  
  ![टेक्स्ट कंप्लीशन का उदाहरण](../../../translated_images/text-completion-example.cbb0f28403d42752.hi.png)
...
- **कोड का एक हिस्सा** साथ ही इसे समझाने और दस्तावेज़ित करने का अनुरोध, या एक टिप्पणी जो एक विशिष्ट कार्य को पूरा करने वाले कोड का एक टुकड़ा उत्पन्न करने के लिए कहती है।
  ...
  ![कोडिंग का उदाहरण](../../../translated_images/coding-example.50ebabe8a6afff20.hi.png)
