...
अपने कंप्यूटर या Codespace पर सब कुछ सेटअप करने के विकल्प के रूप में, आप [कंटेनर](<https://en.wikipedia.org/wiki/Containerization_(computing)?WT.mc_id=academic-105485-koreyst>) का उपयोग कर सकते हैं। कोर्स रिपोजिटरी के भीतर खास `.devcontainer` फ़ोल्डर VS Code को कंटेनर के अंदर प्रोजेक्ट सेटअप करने की अनुमति देता है। Codespaces के बाहर, इसके लिए Docker स्थापित करना होगा, और यह थोड़ा काम माँगता है, इसलिए हम इसे केवल कंटेनर के साथ अनुभव रखने वालों को सलाह देते हैं।
