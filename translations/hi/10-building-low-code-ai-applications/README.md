...
[![लो कोड एआई एप्लिकेशन बनाना](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.hi.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![आप जो ऐप बनाना चाहते हैं उसका वर्णन करें](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.hi.png)
...
1. एआई कोपायलट आपके द्वारा ट्रैक करना चाहते हैं डेटा को स्टोर करने के लिए आवश्यक फ़ील्ड के साथ एक डेटावर्स टेबल और कुछ नमूना डेटा सुझाएगा। फिर आप बातचीत के चरणों के माध्यम से एआई कोपायलट सहायक सुविधा का उपयोग करके टेबल को अपनी आवश्यकताओं के अनुसार अनुकूलित कर सकते हैं।
   ...
   ![आपकी नई टेबल में सुझाए गए फ़ील्ड](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.hi.png)
...
![एक नया फ़ील्ड जोड़ना](../../../translated_images/copilot-new-column.35e15ff21acaf274.hi.png)
...
![प्रॉम्प्ट निर्देश के माध्यम से एक नई स्क्रीन जोड़ना](../../../translated_images/copilot-new-screen.2e0bef7132a17392.hi.png)
...
![नया टेबल चुनें](../../../translated_images/describe-new-table.0792373eb757281e.hi.png)
...
![टेबल का वर्णन करें](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.hi.png)
...
![सुझाए गए Dataverse टेबल](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.hi.png)
...
![AI builder models](../../../translated_images/ai-builder-models.8069423b84cfc47f.hi.png)
...
2. होम स्क्रीन पर टेक्स्ट क्षेत्र का उपयोग करके उस वर्कफ़्लो का वर्णन करें जिसे आप बनाना चाहते हैं। उदाहरण के लिए, **_जब चालान मेरे मेलबॉक्स में आए तो उसे प्रोसेस करें_**। AI Copilot को प्रॉम्प्ट भेजने के लिए **Send** बटन पर क्लिक करें।
   ...
   ![Copilot power automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.hi.png)
...
8. फ्लो से **Condition** क्रिया को हटा दें क्योंकि आप इसका उपयोग नहीं करेंगे। यह निम्नलिखित स्क्रीनशॉट की तरह दिखना चाहिए:
   ...
   ![power automate, क्रियाएं हटाएं](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.hi.png)
...
11. पहले बनाए गए **Table** को चुनें। उदाहरण के लिए, आप **Invoice Information** टेबल चुन सकते हैं। निम्नलिखित फ़ील्ड को भरने के लिए पिछले क्रिया से डायनामिक कंटेंट चुनें:
    ...
    ![power automate add row](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.hi.png)
...
![प्रॉम्प्ट बनाएं](../../../translated_images/create-prompt-gpt.69d429300c2e870a.hi.png)
