![Generative AI Para Iniciantes](../../translated_images/pt-BR/repo-thumbnailv4-fixed.11f1ce6a85d01461.webp)
...
> ```
> Isso te oferece tudo que precisa para completar o curso com um download muito mais rápido.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

# IA Generativa para Iniciantes (Versão 3) - Um Curso

Aprenda os fundamentos para construir aplicações de IA Generativa com nosso curso abrangente de 21 lições pelos Microsoft Cloud Advocates.

## 🌱 Começando

Este curso tem 21 lições. Cada lição cobre seu próprio tópico, então comece onde quiser!

As lições são rotuladas como lições "Aprender", explicando um conceito de IA Generativa, ou lições "Construir", que explicam um conceito e exemplos de código em **Python** e **TypeScript** sempre que possível.
...
- Uma conta no GitHub para [fazer um fork deste repositório completo](https://aka.ms/genai-beginners/github?WT.mc_id=academic-105485-koreyst) para sua própria conta no GitHub

Criamos uma lição **[Configuração do Curso](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)** para ajudar você a configurar seu ambiente de desenvolvimento.
...
Junte-se ao nosso [servidor oficial Discord do Azure AI Foundry](https://aka.ms/genai-discord?WT.mc_id=academic-105485-koreyst) para conhecer e fazer networking com outros estudantes deste curso e obter suporte.

Faça perguntas ou compartilhe feedback de produto em nosso [Fórum de Desenvolvedores do Azure AI Foundry](https://aka.ms/azureaifoundry/forum) no Github.

## 🚀 Construindo uma Startup?

Visite [Microsoft for Startups](https://www.microsoft.com/startups) para saber como começar a construir usando créditos do Azure hoje mesmo.
...
- Exemplos de código em Python e TypeScript com suporte para Azure OpenAI e OpenAI API
...
| 04  | [Compreendendo os Fundamentos da Engenharia de Prompt](./04-prompt-engineering-fundamentals/README.md?WT.mc_id=academic-105485-koreyst)             | **Aprenda:** Melhores práticas práticas de engenharia de prompt                                           | [Vídeo](https://aka.ms/gen-ai-lesson4-gh?WT.mc_id=academic-105485-koreyst)  | [Saiba Mais](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 08  | [Construindo Aplicações de Busca com Bancos de Dados Vetoriais](./08-building-search-applications/README.md?WT.mc_id=academic-105485-koreyst)                        | **Construa:** Uma aplicação de busca que usa Embeddings para procurar dados.                        | [Vídeo](https://aka.ms/gen-ai-lesson8-gh?WT.mc_id=academic-105485-koreyst)  | [Saiba Mais](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 10  | [Construindo Aplicações de IA Low Code](./10-building-low-code-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                       | **Construa:** Uma aplicação de IA Generativa usando ferramentas Low Code                                     | [Vídeo](https://aka.ms/gen-ai-lesson10-gh?WT.mc_id=academic-105485-koreyst) | [Saiba Mais](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 12  | [Design de UX para Aplicações de IA](./12-designing-ux-for-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                         | **Aprenda:** Como aplicar princípios de design de UX ao desenvolver Aplicações de IA Generativa         | [Vídeo](https://aka.ms/gen-ai-lesson12-gh?WT.mc_id=academic-105485-koreyst) | [Saiba Mais](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 13  | [Segurança em suas Aplicações de IA Generativa](./13-securing-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                         | **Aprenda:** As ameaças e riscos aos sistemas de IA e métodos para proteger esses sistemas.             | [Vídeo](https://aka.ms/gen-ai-lesson13-gh?WT.mc_id=academic-105485-koreyst) | [Saiba Mais](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 16  | [Modelos Open Source e Hugging Face](./16-open-source-models/README.md?WT.mc_id=academic-105485-koreyst)                                    | **Construa:** Uma aplicação usando modelos de código aberto disponíveis no Hugging Face                    | [Vídeo](https://aka.ms/gen-ai-lesson16-gh?WT.mc_id=academic-105485-koreyst) | [Saiba Mais](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
[**Bernhard Merkle**](https://www.linkedin.com/in/bernhard-merkle-738b73/) por fazer contribuições chave em cada aula para melhorar a experiência do aprendiz e do código.
