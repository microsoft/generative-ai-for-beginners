...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:26:10+00:00",
...
Вивчайте основи створення додатків на основі генеративного штучного інтелекту за допомогою нашого 21-урочного курсу від Microsoft Cloud Advocates.
...
Якщо ви шукаєте більш складні приклади коду, ознайомтеся з нашою [колекцією прикладів коду для генеративного штучного інтелекту](https://aka.ms/genai-beg-code?WT.mc_id=academic-105485-koreyst) на **Python** і **TypeScript**.
...
Є пропозиції або знайшли помилки в тексті чи коді? [Створіть issue](https://github.com/microsoft/generative-ai-for-beginners/issues?WT.mc_id=academic-105485-koreyst) або [створіть pull request](https://github.com/microsoft/generative-ai-for-beginners/pulls?WT.mc_id=academic-105485-koreyst).
...
| 18  | [Тонке налаштування LLM](./18-fine-tuning/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **Дізнайтеся:** Що, чому і як здійснювати тонке налаштування LLM                                            | [Відео](https://aka.ms/gen-ai-lesson18-gh?WT.mc_id=academic-105485-koreyst) | [Дізнатися більше](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
