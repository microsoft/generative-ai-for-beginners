...
[![Генерація з доповненням пошуку (RAG) та векторні бази даних](../../../translated_images/15-lesson-banner.ac49e59506175d4f.uk.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![схема роботи RAG](../../../translated_images/how-rag-works.f5d0ff63942bd3a6.uk.png)
...
![схема архітектури RAG](../../../translated_images/encoder-decode.f2658c25d0eadee2.uk.png)
...
![векторне представлення слова cat](../../../translated_images/cat.74cbd7946bc9ca38.uk.png)
