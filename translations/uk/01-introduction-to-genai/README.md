...
[![Вступ до генеративного штучного інтелекту та великих мовних моделей](../../../translated_images/uk/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![П’ятеро молодих студентів дивляться на монітор - зображення від DALLE2](../../../translated_images/uk/students-by-DALLE2.b70fddaced1042ee.png)
...
![ШІ, ML, DL та генеративний ШІ](../../../translated_images/uk/AI-diagram.c391fa518451a40d.png)
...
![Приклад токенізації](../../../translated_images/uk/tokenizer-example.80a5c151ee7d1bd4.png)
...
- **Інструкцію**, яка визначає тип виходу, який ми очікуємо від моделі. Ця інструкція іноді може містити приклади або додаткові дані.
  ...
  1. Резюме статті, книги, відгуків про продукт тощо, а також витяг інсайтів із неструктурованих даних.
    ...
    ![Приклад резюмування](../../../translated_images/uk/summarization-example.7b7ff97147b3d790.png)
  
  2. Творче генерування ідей та написання статті, есе, завдання тощо.
      
     ![Приклад творчого письма](../../../translated_images/uk/creative-writing-example.e24a685b5a543ad1.png)

- **Питання**, поставлене у формі розмови з агентом.
  
  ![Приклад розмови](../../../translated_images/uk/conversation-example.60c2afc0f595fa59.png)

- Фрагмент **тексту для завершення**, який імпліцитно є запитом на допомогу в написанні.
  
  ![Приклад завершення тексту](../../../translated_images/uk/text-completion-example.cbb0f28403d42752.png)
...
- Фрагмент **коду** разом із запитом на пояснення та документування його, або коментар із проханням згенерувати фрагмент коду для виконання конкретного завдання.
  ...
  ![Приклад кодування](../../../translated_images/uk/coding-example.50ebabe8a6afff20.png)
