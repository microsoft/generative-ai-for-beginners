...
[![Створення AI-додатків з низьким рівнем кодування](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.uk.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Опишіть додаток, який ви хочете створити](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.uk.png)
...
1. AI Copilot запропонує таблицю Dataverse з полями, які вам потрібні для зберігання даних, які ви хочете відстежувати, і деякими зразками даних. Ви можете налаштувати таблицю відповідно до ваших потреб, використовуючи функцію AI Copilot через розмовні кроки.
   ...
   ![Запропоновані поля у вашій новій таблиці](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.uk.png)
...
![Додавання нового поля](../../../translated_images/copilot-new-column.35e15ff21acaf274.uk.png)
...
![Додавання нового екрану через інструкцію підказки](../../../translated_images/copilot-new-screen.2e0bef7132a17392.uk.png)
...
![Виберіть нову таблицю](../../../translated_images/describe-new-table.0792373eb757281e.uk.png)
...
![Описати таблицю](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.uk.png)
...
![Запропонована таблиця Dataverse](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.uk.png)
...
![Моделі AI Builder](../../../translated_images/ai-builder-models.8069423b84cfc47f.uk.png)
...
2. Використовуйте текстове поле на головній сторінці, щоб описати робочий процес, який ви хочете створити. Наприклад, **_Обробити рахунок-фактуру, коли вона надходить у мою поштову скриньку_**. Натисніть кнопку **Send**, щоб надіслати запит AI Copilot.
   ...
   ![Copilot power automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.uk.png)
...
8. Видаліть дію **Condition** з потоку, оскільки ви її не використовуватимете. Потік повинен виглядати, як на наступному скріншоті:
   ...
   ![power automate, видалити дії](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.uk.png)
...
11. Виберіть таблицю, яку ви створили раніше. Наприклад, ви можете вибрати таблицю **Invoice Information**. Виберіть динамічний вміст із попередньої дії, щоб заповнити наступні поля:
    ...
    ![power automate додати рядок](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.uk.png)
...
![створити запит](../../../translated_images/create-prompt-gpt.69d429300c2e870a.uk.png)
