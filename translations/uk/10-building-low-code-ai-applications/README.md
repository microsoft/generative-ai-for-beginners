...
[![Створення AI-додатків з низьким рівнем кодування](../../../translated_images/uk/10-lesson-banner.a01ac8fe3fd86310.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Опишіть додаток, який ви хочете створити](../../../translated_images/uk/copilot-chat-prompt-powerapps.84250f341d060830.png)
...
1. AI Copilot запропонує таблицю Dataverse з полями, які вам потрібні для зберігання даних, які ви хочете відстежувати, і деякими зразками даних. Ви можете налаштувати таблицю відповідно до ваших потреб, використовуючи функцію AI Copilot через розмовні кроки.
   ...
   ![Запропоновані поля у вашій новій таблиці](../../../translated_images/uk/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.png)
...
![Додавання нового поля](../../../translated_images/uk/copilot-new-column.35e15ff21acaf274.png)
...
![Додавання нового екрану через інструкцію підказки](../../../translated_images/uk/copilot-new-screen.2e0bef7132a17392.png)
...
![Виберіть нову таблицю](../../../translated_images/uk/describe-new-table.0792373eb757281e.png)
...
![Описати таблицю](../../../translated_images/uk/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.png)
...
![Запропонована таблиця Dataverse](../../../translated_images/uk/copilot-dataverse-table.b3bc936091324d9d.png)
...
![Моделі AI Builder](../../../translated_images/uk/ai-builder-models.8069423b84cfc47f.png)
...
2. Використовуйте текстове поле на головній сторінці, щоб описати робочий процес, який ви хочете створити. Наприклад, **_Обробити рахунок-фактуру, коли вона надходить у мою поштову скриньку_**. Натисніть кнопку **Send**, щоб надіслати запит AI Copilot.
   ...
   ![Copilot power automate](../../../translated_images/uk/copilot-chat-prompt-powerautomate.f377e478cc8412de.png)
...
8. Видаліть дію **Condition** з потоку, оскільки ви її не використовуватимете. Потік повинен виглядати, як на наступному скріншоті:
   ...
   ![power automate, видалити дії](../../../translated_images/uk/powerautomate-remove-actions.7216392fe684ceba.png)
...
11. Виберіть таблицю, яку ви створили раніше. Наприклад, ви можете вибрати таблицю **Invoice Information**. Виберіть динамічний вміст із попередньої дії, щоб заповнити наступні поля:
    ...
    ![power automate додати рядок](../../../translated_images/uk/powerautomate-add-row.5edce45e5dd3d51e.png)
...
![створити запит](../../../translated_images/uk/create-prompt-gpt.69d429300c2e870a.png)
