...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-25T16:56:06+00:00",
  "source_file": "08-building-search-applications/scripts/README.md",
  "language_code": "da"
}
-->
# Transskriptionsdata forberedelse

Skripterne til forberedelse af transskriptionsdata downloader YouTube-videotransskriptioner og forbereder dem til brug med Semantic Search med OpenAI Embeddings og Functions-eksemplet.

Skripterne til forberedelse af transskriptionsdata er blevet testet på de nyeste udgivelser af Windows 11, macOS Ventura og Ubuntu 22.04 (og derover).
...
> [!NOTE]
> Til disse instruktioner bruger vi ressourcegruppen navngivet "semantic-video-search" i East US.
...
Følgende miljøvariabler er nødvendige for at køre YouTube-transskriptionsdata forberedelsesskripterne.

### På Windows

Vi anbefaler at tilføje variablerne til din `user` environment variables.
...
Vi anbefaler at tilføje følgende exports til din `~/.bashrc` or `~/.zshrc` fil.
...
1. Aktiver Python det virtuelle miljø.
...
## Kør YouTube-transskriptionsdata forberedelsesskripterne
