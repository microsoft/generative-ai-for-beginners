...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:54:22+00:00",
...
Midjourney fungerer på en lignende måde som DALL-E; det genererer billeder ud fra tekstprompts. Midjourney kan også bruges til at generere billeder ved hjælp af prompts som "en kat med en hat" eller "en hund med en mohawk".
...
1. Opret en fil _.env_ med følgende indhold:
   ...
   Find disse oplysninger i Azure OpenAI Foundry Portal for din ressource i sektionen "Deployments".
...
- Til sidst åbner vi billedet og bruger standard billedfremviseren til at vise det:
...
Her er et eksempel ved brug af GPT Image:
...
- **Skabe variationer**. Ideen er, at du tager et eksisterende billede og beder om, at der skabes variationer. For at skabe en variation giver du et billede og en tekstprompt og kode som følger:
...
![Kanin på hest, der holder en slikkepind, version 1](../../../translated_images/v1-generated-image.a295cfcffa3c13c2432eb1e41de7e49a78c814000fb1b462234be24b6e0db7ea.da.png)
...
For eksempel ønsker vi ikke at generere billeder, der ikke er passende til arbejdspladsen, eller som ikke er egnede for børn.

Vi kan gøre dette med _metaprompts_. Metaprompts er tekstprompts, der bruges til at kontrollere outputtet fra en Generativ AI-model. For eksempel kan vi bruge metaprompts til at kontrollere outputtet og sikre, at de genererede billeder er passende til arbejdspladsen eller egnede for børn.

### Hvordan fungerer det?

Hvordan fungerer metaprompts?

Metaprompts er tekstprompts, der bruges til at kontrollere outputtet fra en Generativ AI-model. De placeres før tekstprompten og bruges til at kontrollere modellens output og indlejres i applikationer for at kontrollere modellens output. De kombinerer promptinput og metapromptinput i en enkelt tekstprompt.
...
Eleverne vil skabe billeder til deres opgaver, der indeholder monumenter. Hvilke monumenter det er, er op til eleverne. Eleverne bliver bedt om at bruge deres kreativitet i denne opgave til at placere disse monumenter i forskellige kontekster.
