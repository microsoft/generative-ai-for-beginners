...
[![Rakentaminen vähäkoodisia tekoälysovelluksia](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.fi.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Kuvaile sovellus, jonka haluat rakentaa](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.fi.png)
...
1. Tekoäly-Copilot ehdottaa Dataverse-taulukkoa, jossa on tarvittavat kentät tietojen tallentamiseen ja joitakin esimerkkitietoja. Voit sen jälkeen mukauttaa taulukkoa tarpeidesi mukaan käyttämällä tekoäly-Copilotin avustajatoimintoa keskusteluvaiheiden kautta.
   ...
   ![Ehdotetut kentät uudessa taulukossasi](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.fi.png)
...
![Uuden kentän lisääminen](../../../translated_images/copilot-new-column.35e15ff21acaf274.fi.png)
...
![Uuden näytön lisääminen kehotteen avulla](../../../translated_images/copilot-new-screen.2e0bef7132a17392.fi.png)
...
![Valitse uusi taulukko](../../../translated_images/describe-new-table.0792373eb757281e.fi.png)
...
![Kuvaile taulukko](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.fi.png)
...
![Ehdotettu Dataverse-taulukko](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.fi.png)
...
![AI Builder -mallit](../../../translated_images/ai-builder-models.8069423b84cfc47f.fi.png)
...
2. Käytä aloitusnäytön tekstialuetta kuvaamaan työnkulku, jonka haluat rakentaa. Esimerkiksi **_Käsittele lasku, kun se saapuu postilaatikkooni_**. Napsauta **Send**-painiketta lähettääksesi kehotteen AI Copilotille.
   ...
   ![Copilot Power Automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.fi.png)
...
8. Poista **Condition**-toiminto työnkulusta, koska et käytä sitä. Sen pitäisi näyttää seuraavalta kuvakaappaukselta:
   ...
   ![Power Automate, poista toiminnot](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.fi.png)
...
11. Valitse aiemmin luomasi **Table**. Esimerkiksi voit valita **Invoice Information**-taulukon. Valitse aiemman toiminnon dynaaminen sisältö täyttääksesi seuraavat kentät:
    ...
    ![Power Automate lisää rivi](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.fi.png)
...
![Luo kehotus](../../../translated_images/create-prompt-gpt.69d429300c2e870a.fi.png)
