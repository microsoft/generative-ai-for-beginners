...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:57:36+00:00",
  "source_file": "09-building-image-applications/README.md",
  "language_code": "fi"
}
-->
# Kuvien luomiseen keskittyvien sovellusten rakentaminen

[![Kuvien luomiseen keskittyvien sovellusten rakentaminen](../../../translated_images/09-lesson-banner.906e408c741f44112ff5da17492a30d3872abb52b8530d6506c2631e86e704d0.fi.png)](https://aka.ms/gen-ai-lesson9-gh?WT.mc_id=academic-105485-koreyst)

LLM-malleilla voi tehdä muutakin kuin tuottaa tekstiä. Niiden avulla voidaan myös luoda kuvia tekstikuvauksista. Kuvien käyttö voi olla erittäin hyödyllistä monilla aloilla, kuten lääketeknologiassa, arkkitehtuurissa, matkailussa, pelikehityksessä ja muilla. Tässä luvussa tutustumme kahteen suosituimpaan kuvien luomiseen tarkoitettuun malliin: DALL-E ja Midjourney.

## Johdanto

Tässä oppitunnissa käsitellään:

- Kuvien luomista ja sen hyödyllisyyttä.
- DALL-E ja Midjourney: mitä ne ovat ja miten ne toimivat.
- Kuvien luomiseen keskittyvän sovelluksen rakentamista.

## Oppimistavoitteet

Oppitunnin jälkeen osaat:

- Rakentaa kuvien luomiseen keskittyvän sovelluksen.
- Määritellä sovelluksesi rajat metapromptien avulla.
- Työskennellä DALL-E:n ja Midjourneyn kanssa.

## Miksi rakentaa kuvien luomiseen keskittyvä sovellus?

Kuvien luomiseen keskittyvät sovellukset ovat erinomainen tapa tutkia generatiivisen tekoälyn mahdollisuuksia. Niitä voidaan käyttää esimerkiksi:

- **Kuvien muokkaamiseen ja synteesiin**. Voit luoda kuvia monenlaisiin käyttötarkoituksiin, kuten kuvien muokkaamiseen ja synteesiin.
...
Tässä oppitunnissa jatkamme työskentelyä startupin Edu4All kanssa. Oppilaat luovat kuvia arviointejaan varten. Kuvien sisältö on oppilaiden päätettävissä, mutta ne voivat olla esimerkiksi kuvituksia heidän omalle sadulleen, uuden hahmon luomista tarinaansa tai heidän ideoidensa ja konseptiensa visualisointia.

Esimerkiksi, jos Edu4All:n oppilaat työskentelevät luokassa monumenttien parissa, he voisivat luoda seuraavanlaisen kuvan:
...
[DALL-E](https://openai.com/dall-e-2?WT.mc_id=academic-105485-koreyst) ja [Midjourney](https://www.midjourney.com/?WT.mc_id=academic-105485-koreyst) ovat kaksi suosituinta kuvien luomiseen tarkoitettua mallia, jotka mahdollistavat kuvien luomisen tekstipromptien avulla.
...
- **Diffused attention** on malli, joka luo kuvia upotuksista. DALL-E on koulutettu kuvien ja tekstin datasetillä, ja sitä voidaan käyttää kuvien luomiseen tekstikuvauksista. Esimerkiksi DALL-E:llä voidaan luoda kuvia kissasta hatun kanssa tai koirasta, jolla on irokeesi.

### Midjourney

Midjourney toimii samalla tavalla kuin DALL-E: se luo kuvia tekstipromptien avulla. Midjourney:tä voidaan myös käyttää kuvien luomiseen promptien avulla, kuten "kissa hatun kanssa" tai "koira irokeesilla".
...
Tämän prosessin avulla DALL-E hallitsee kuvan ominaisuuksia, objekteja, piirteitä ja muuta. DALL-E 2 ja 3 tarjoavat kuitenkin enemmän kontrollia luotuun kuvaan.

## Ensimmäisen kuvien luomiseen keskittyvän sovelluksen rakentaminen

Mitä tarvitaan kuvien luomiseen keskittyvän sovelluksen rakentamiseen? Tarvitset seuraavat kirjastot:
...
Jos et ole vielä tehnyt sitä, seuraa [Microsoft Learn](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/create-resource?pivots=web-portal)-sivun ohjeita luodaksesi Azure OpenAI -resurssin ja mallin. Valitse malliksi DALL-E 3.
...
- **temperature** on parametri, joka ohjaa generatiivisen tekoälymallin tuottaman sisällön satunnaisuutta. Temperature-arvo on välillä 0 ja 1, missä 0 tarkoittaa determinististä ja 1 satunnaista tulosta. Oletusarvo on 0.7.

Kuvien kanssa voi tehdä paljon muutakin, mitä käsittelemme seuraavassa osiossa.

## Kuvien luomisen lisäominaisuudet

Olet nähnyt, kuinka pystyimme luomaan kuvan muutamalla rivillä Python-koodia. Kuvien kanssa voi kuitenkin tehdä paljon muutakin.

Voit esimerkiksi:

- **Muokata kuvia**. Antamalla olemassa olevan kuvan, maskin ja promptin, voit muokata kuvaa. Esimerkiksi voit lisätä jotain tiettyyn osaan kuvaa. Kuvittele pupukuvaamme: voit lisätä hatun pupulle. Tämä tehdään antamalla kuva, maski (joka määrittää muokattavan alueen) ja tekstiprompti, joka kertoo, mitä muutoksia tehdään.
...
- **Luoda variaatioita**. Idea on, että otat olemassa olevan kuvan ja pyydät luomaan siitä variaatioita. Variaation luomiseksi annat kuvan ja tekstipromptin sekä koodin seuraavasti:
...
Kokeillaan tehdä vastauksesta deterministisempi. Huomasimme kahdesta luodusta kuvasta, että ensimmäisessä kuvassa on pupu ja toisessa kuvassa hevonen, joten kuvat eroavat toisistaan huomattavasti.
...
## Miten määritellä sovelluksesi rajat metapromptien avulla

Demonstraatiomme avulla voimme jo luoda kuvia asiakkaillemme. Meidän on kuitenkin luotava sovelluksellemme tietyt rajat.

Esimerkiksi emme halua luoda kuvia, jotka eivät ole soveliaita työympäristöön tai lapsille.

Tämä voidaan tehdä _metapromptien_ avulla. Metapromptit ovat tekstipromptit, joita käytetään generatiivisen tekoälymallin tuottaman sisällön ohjaamiseen. Esimerkiksi metapromptien avulla voidaan varmistaa, että luodut kuvat ovat soveliaita työympäristöön tai lapsille.

### Miten se toimii?

Miten metapromptit sitten toimivat?

Metapromptit ovat tekstipromptit, joita käytetään generatiivisen tekoälymallin tuottaman sisällön ohjaamiseen. Ne sijoitetaan ennen varsinaista tekstipromptia ja niitä käytetään mallin tuottaman sisällön ohjaamiseen. Ne upotetaan sovelluksiin ohjaamaan mallin tuottamaa sisältöä, yhdistäen promptin ja metapromptin yhdeksi tekstipromptiksi.
...
Esittelimme Edu4All:n oppitunnin alussa. Nyt on aika mahdollistaa oppilaiden kuvien luominen heidän arviointejaan varten.

Oppilaat luovat kuvia arviointejaan varten, jotka sisältävät monumentteja. Tarkat monumentit ovat oppilaiden päätettävissä. Oppilaita pyydetään käyttämään luovuuttaan tässä tehtävässä ja sijoittamaan monumentit erilaisiin konteksteihin.
...
Tämän oppitunnin jälkeen tutustu [Generatiivisen tekoälyn oppimiskokoelmaan](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) ja jatka generatiivisen tekoälyn tietämyksesi kehittämistä!
