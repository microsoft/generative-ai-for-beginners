...
[![లో కోడ్ AI అప్లికేషన్లు నిర్మించడం](../../../translated_images/te/10-lesson-banner.a01ac8fe3fd86310.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![మీరు నిర్మించదలచిన యాప్‌ను వివరించండి](../../../translated_images/te/copilot-chat-prompt-powerapps.84250f341d060830.png)
...
1. AI కోపైలట్ మీరు ట్రాక్ చేయదలచిన డేటాను నిల్వ చేయడానికి అవసరమైన ఫీల్డ్స్ మరియు కొన్ని నమూనా డేటాతో డేటావర్స్ టేబుల్‌ను సూచిస్తుంది. మీరు ఆ టేబుల్‌ను AI కోపైలట్ సహాయకుడు ఫీచర్ ద్వారా సంభాషణాత్మక దశలతో మీ అవసరాలకు అనుగుణంగా అనుకూలీకరించవచ్చు.
   ...
   ![మీ కొత్త టేబుల్‌లో సూచించిన ఫీల్డ్స్](../../../translated_images/te/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.png)
...
![కొత్త ఫీల్డ్ జోడించడం](../../../translated_images/te/copilot-new-column.35e15ff21acaf274.png)
...
![ప్రాంప్ట్ సూచన ద్వారా కొత్త స్క్రీన్ జోడించడం](../../../translated_images/te/copilot-new-screen.2e0bef7132a17392.png)
...
![Select new table](../../../translated_images/te/describe-new-table.0792373eb757281e.png)
...
![Describe the table](../../../translated_images/te/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.png)
...
![Suggested Dataverse table](../../../translated_images/te/copilot-dataverse-table.b3bc936091324d9d.png)
...
![AI builder models](../../../translated_images/te/ai-builder-models.8069423b84cfc47f.png)
...
2. హోమ్ స్క్రీన్‌లోని టెక్స్ట్ ఏరియాలో మీరు నిర్మించాలనుకునే వర్క్‌ఫ్లోను వివరించండి. ఉదాహరణకు, **_నా మెయిల్‌బాక్స్‌లో ఇన్వాయిస్ వచ్చినప్పుడు దాన్ని ప్రాసెస్ చేయండి_**. AI Copilot కు ప్రాంప్ట్ పంపడానికి **Send** బటన్ పై క్లిక్ చేయండి.
   ...
   ![Copilot power automate](../../../translated_images/te/copilot-chat-prompt-powerautomate.f377e478cc8412de.png)
...
8. ఫ్లో నుండి **Condition** చర్యను తీసివేయండి ఎందుకంటే మీరు దాన్ని ఉపయోగించరు. ఇది క్రింది స్క్రీన్‌షాట్‌లా కనిపించాలి:
   ...
   ![power automate, remove actions](../../../translated_images/te/powerautomate-remove-actions.7216392fe684ceba.png)
...
11. మీరు ముందుగా సృష్టించిన **Table** ను ఎంచుకోండి. ఉదాహరణకు, **Invoice Information** టేబుల్‌ను ఎంచుకోవచ్చు. క్రింది ఫీల్డ్స్‌ను పూరించడానికి గత చర్య నుండి డైనమిక్ కంటెంట్ ఎంచుకోండి:
    ...
    ![power automate add row](../../../translated_images/te/powerautomate-add-row.5edce45e5dd3d51e.png)
...
![create a prompt](../../../translated_images/te/create-prompt-gpt.69d429300c2e870a.png)
