...
[![జనరేటివ్ AI మరియు పెద్ద భాషా మోడల్స్ పరిచయం](../../../translated_images/01-lesson-banner.2424cfd092f43366.te.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![ఐదు యువ విద్యార్థులు మానిటర్‌ను చూస్తున్నారు - చిత్రం DALLE2 ద్వారా](../../../translated_images/students-by-DALLE2.b70fddaced1042ee.te.png)
...
![AI, ML, DL మరియు జనరేటివ్ AI](../../../translated_images/AI-diagram.c391fa518451a40d.te.png)
...
![టోకనైజేషన్ ఉదాహరణ](../../../translated_images/tokenizer-example.80a5c151ee7d1bd4.te.png)
...
- మోడల్ నుండి ఆశించే అవుట్‌పుట్ రకాన్ని సూచించే **సూచన**. ఈ సూచనలో కొన్నిసార్లు కొన్ని ఉదాహరణలు లేదా అదనపు డేటా ఉండవచ్చు.
  ...
  1. వ్యాసం, పుస్తకం, ఉత్పత్తి సమీక్షల సారాంశం మరియు మరిన్ని, అలాగే అసంఘటిత డేటా నుండి అవగాహనలను తీసుకోవడం.
    ...
    ![సారాంశం ఉదాహరణ](../../../translated_images/summarization-example.7b7ff97147b3d790.te.png)
  
  2. వ్యాసం, ఎస్సే, అసైన్‌మెంట్ లేదా మరిన్ని సృజనాత్మక ఆలోచనలు మరియు రూపకల్పన.
      
     ![సృజనాత్మక రచన ఉదాహరణ](../../../translated_images/creative-writing-example.e24a685b5a543ad1.te.png)

- ఏజెంట్‌తో సంభాషణ రూపంలో అడిగే **ప్రశ్న**.
  
  ![సంభాషణ ఉదాహరణ](../../../translated_images/conversation-example.60c2afc0f595fa59.te.png)

- పూర్తిచేయాల్సిన **టెక్స్ట్** భాగం, ఇది రాయడంలో సహాయం కోరడం.
  
  ![టెక్స్ట్ కంప్లీషన్ ఉదాహరణ](../../../translated_images/text-completion-example.cbb0f28403d42752.te.png)

- ఒక **కోడ్** భాగం, దాన్ని వివరించమని, డాక్యుమెంట్ చేయమని అడగడం, లేదా ఒక నిర్దిష్ట పని చేసే కోడ్‌ను సృష్టించమని వ్యాఖ్య.
  
  ![కోడింగ్ ఉదాహరణ](../../../translated_images/coding-example.50ebabe8a6afff20.te.png)
