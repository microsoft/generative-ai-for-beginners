...
[![Paggawa ng Low Code AI Applications](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.tl.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Ilarawan ang app na gusto mong gawin](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.tl.png)
...
1. Ang AI Copilot ay magmumungkahi ng Dataverse Table na may mga field na kailangan mo upang i-store ang data na gusto mong i-track at ilang sample data. Maaari mo itong i-customize upang matugunan ang iyong mga pangangailangan gamit ang AI Copilot assistant feature sa pamamagitan ng mga conversational steps.
   ...
   ![Mga mungkahing field sa iyong bagong table](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.tl.png)
...
![Pagdaragdag ng bagong field](../../../translated_images/copilot-new-column.35e15ff21acaf274.tl.png)
...
![Pagdaragdag ng bagong screen sa pamamagitan ng prompt instruction](../../../translated_images/copilot-new-screen.2e0bef7132a17392.tl.png)
...
![Piliin ang bagong talahanayan](../../../translated_images/describe-new-table.0792373eb757281e.tl.png)
...
![Ilarawan ang talahanayan](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.tl.png)
...
![Inirekomendang Dataverse table](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.tl.png)
...
![AI builder models](../../../translated_images/ai-builder-models.8069423b84cfc47f.tl.png)
...
2. Gamitin ang text area sa home screen upang ilarawan ang workflow na nais mong gawin. Halimbawa, **_Proseso ng invoice kapag dumating ito sa aking mailbox_**. I-click ang **Send** button upang ipadala ang prompt sa AI Copilot.
   ...
   ![Copilot power automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.tl.png)
...
8. Alisin ang **Condition** action mula sa flow dahil hindi mo ito gagamitin. Dapat itong magmukhang tulad ng sumusunod na screenshot:
   ...
   ![power automate, alisin ang mga aksyon](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.tl.png)
...
11. Piliin ang **Table** na ginawa mo kanina. Halimbawa, maaari mong piliin ang **Invoice Information** table. Piliin ang dynamic content mula sa nakaraang aksyon upang punan ang mga sumusunod na field:
    ...
    ![power automate add row](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.tl.png)
...
![gumawa ng prompt](../../../translated_images/create-prompt-gpt.69d429300c2e870a.tl.png)
