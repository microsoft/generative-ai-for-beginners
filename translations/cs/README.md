...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T16:41:15+00:00",
  "source_file": "README.md",
  "language_code": "cs"
}
-->
![Generative AI pro začátečníky](../../translated_images/cs/repo-thumbnailv4-fixed.11f1ce6a85d01461.webp)

### 21 lekcí, které vás naučí vše, co potřebujete vědět pro začátek vytváření aplikací Generativní AI
...
> ```
> Toto vám poskytne vše potřebné ke splnění kurzu a stahování bude mnohem rychlejší.
...
- GitHub účet pro [forknutí tohoto celého repozitáře](https://aka.ms/genai-beginners/github?WT.mc_id=academic-105485-koreyst) do vlastního GitHub účtu
...
Nezapomeňte [označit tento repozitář hvězdičkou (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst), abyste jej později snadněji našli.

## 🧠 Připraven na nasazení?

Pokud hledáte pokročilejší ukázky kódu, podívejte se na naši [sbírku kódových ukázek Generativní AI](https://aka.ms/genai-beg-code?WT.mc_id=academic-105485-koreyst) v **Pythonu** i **TypeScriptu**.

## 🗣️ Poznejte další studenty, získejte podporu

Připojte se k našemu [oficiálnímu Azure AI Foundry Discord serveru](https://aka.ms/genai-discord?WT.mc_id=academic-105485-koreyst), kde se můžete setkat a síťovat s dalšími studenty tohoto kurzu a získat podporu.

Pokládejte otázky nebo sdílejte zpětnou vazbu k produktu ve fóru [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum) na Githubu.

## 🚀 Stavíte startup?

Navštivte [Microsoft for Startups](https://www.microsoft.com/startups) a zjistěte, jak začít stavět s kredity Azure hned dnes.
...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 00  | [Nastavení kurzu](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **Learn:** Jak nastavit vývojové prostředí                                                   | Video brzy k dispozici                                                       | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 01  | [Úvod do Generativní AI a LLM](./01-introduction-to-genai/README.md?WT.mc_id=academic-105485-koreyst)                                         | **Learn:** Pochopení, co je Generativní AI a jak fungují velké jazykové modely (LLM).         | [Video](https://aka.ms/gen-ai-lesson-1-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 02  | [Prozkoumání a porovnání různých LLM](./02-exploring-and-comparing-different-llms/README.md?WT.mc_id=academic-105485-koreyst)                  | **Learn:** Jak vybrat správný model pro váš případ použití                                   | [Video](https://aka.ms/gen-ai-lesson2-gh?WT.mc_id=academic-105485-koreyst)  | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 03  | [Používání generativní AI odpovědně](./03-using-generative-ai-responsibly/README.md?WT.mc_id=academic-105485-koreyst)                         | **Learn:** Jak zodpovědně vytvářet aplikace Generativní AI                                  | [Video](https://aka.ms/gen-ai-lesson3-gh?WT.mc_id=academic-105485-koreyst)  | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 04  | [Pochopení základů Prompt Engineering](./04-prompt-engineering-fundamentals/README.md?WT.mc_id=academic-105485-koreyst)                        | **Learn:** Praktické osvědčené postupy Prompt Engineering                                   | [Video](https://aka.ms/gen-ai-lesson4-gh?WT.mc_id=academic-105485-koreyst)  | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 05  | [Vytváření pokročilých promptů](./05-advanced-prompts/README.md?WT.mc_id=academic-105485-koreyst)                                                | **Naučte se:** Jak aplikovat techniky prompt engineering, které zlepšují výsledky vašich promptů. | [Video](https://aka.ms/gen-ai-lesson5-gh?WT.mc_id=academic-105485-koreyst)  | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 06  | [Vytváření aplikací na generování textu](./06-text-generation-apps/README.md?WT.mc_id=academic-105485-koreyst)                                | **Postavte:** Aplikaci pro generování textu pomocí Azure OpenAI / OpenAI API                     | [Video](https://aka.ms/gen-ai-lesson6-gh?WT.mc_id=academic-105485-koreyst)  | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 07  | [Vytváření chatovacích aplikací](./07-building-chat-applications/README.md?WT.mc_id=academic-105485-koreyst)                                     | **Postavte:** Techniky pro efektivní vytváření a integraci chatovacích aplikací                  | [Video](https://aka.ms/gen-ai-lessons7-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 08  | [Vytváření vyhledávacích aplikací vektorových databází](./08-building-search-applications/README.md?WT.mc_id=academic-105485-koreyst)            | **Postavte:** Vyhledávací aplikaci, která používá embeddings pro hledání dat                      | [Video](https://aka.ms/gen-ai-lesson8-gh?WT.mc_id=academic-105485-koreyst)  | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 09  | [Vytváření aplikací pro generování obrázků](./09-building-image-applications/README.md?WT.mc_id=academic-105485-koreyst)                        | **Postavte:** Aplikaci pro generování obrázků                                                   | [Video](https://aka.ms/gen-ai-lesson9-gh?WT.mc_id=academic-105485-koreyst)  | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 10  | [Vytváření nízkokódových AI aplikací](./10-building-low-code-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                       | **Postavte:** Generativní AI aplikaci pomocí nástrojů Low Code                                  | [Video](https://aka.ms/gen-ai-lesson10-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 11  | [Integrace externích aplikací s voláním funkcí](./11-integrating-with-function-calling/README.md?WT.mc_id=academic-105485-koreyst)              | **Postavte:** Co je volání funkcí a případy jeho využití v aplikacích                           | [Video](https://aka.ms/gen-ai-lesson11-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 12  | [Návrh UX pro AI aplikace](./12-designing-ux-for-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                                     | **Naučte se:** Jak aplikovat zásady návrhu UX při vývoji generativních AI aplikací             | [Video](https://aka.ms/gen-ai-lesson12-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 13  | [Zabezpečení vašich generativních AI aplikací](./13-securing-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                         | **Naučte se:** Hrozby a rizika pro AI systémy a způsoby jejich zabezpečení                      | [Video](https://aka.ms/gen-ai-lesson13-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 15  | [Retrieval Augmented Generation (RAG) a vektorové databáze](./15-rag-and-vector-databases/README.md?WT.mc_id=academic-105485-koreyst)            | **Postavte:** Aplikaci využívající RAG framework pro načítání embeddings z vektorových databází | [Video](https://aka.ms/gen-ai-lesson15-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 16  | [Open source modely a Hugging Face](./16-open-source-models/README.md?WT.mc_id=academic-105485-koreyst)                                          | **Postavte:** Aplikaci využívající otevřené modely dostupné na Hugging Face                      | [Video](https://aka.ms/gen-ai-lesson16-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 17  | [AI agenti](./17-ai-agents/README.md?WT.mc_id=academic-105485-koreyst)                                                                         | **Postavte:** Aplikaci využívající AI Agent Framework                                          | [Video](https://aka.ms/gen-ai-lesson17-gh?WT.mc_id=academic-105485-koreyst) | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 19  | [Vytváření se SLM](./19-slm/README.md?WT.mc_id=academic-105485-koreyst)                                                                       | **Naučte se:** Výhody tvorby s malými jazykovými modely                                       | Video brzy k dispozici | [Zjistit více](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
[**Bernhardovi Merkleovi**](https://www.linkedin.com/in/bernhard-merkle-738b73/) za klíčové příspěvky do každé lekce ke zlepšení zkušenosti studentů i kódu.
