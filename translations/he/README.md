...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:59:47+00:00",
...
### 21 שיעורים שמלמדים את כל מה שצריך לדעת כדי להתחיל לבנות יישומי AI גנרטיבי
...
# AI גנרטיבי למתחילים (גרסה 3) - קורס

למדו את יסודות בניית יישומי AI גנרטיבי עם הקורס המקיף שלנו הכולל 21 שיעורים מאת Microsoft Cloud Advocates.

## 🌱 איך מתחילים?

הקורס כולל 21 שיעורים. כל שיעור מתמקד בנושא משלו, כך שתוכלו להתחיל מכל מקום שתרצו!

השיעורים מסומנים כ"שיעורי למידה" שמסבירים מושגי AI גנרטיבי או כ"שיעורי בנייה" שמסבירים מושגים ודוגמאות קוד ב-**Python** וב-**TypeScript** כאשר אפשרי.

למפתחים ב-.NET, בדקו את [AI גנרטיבי למתחילים (מהדורת .NET)](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)!
...
אם אתם מחפשים דוגמאות קוד מתקדמות יותר, בדקו את [אוסף דוגמאות הקוד של AI גנרטיבי](https://aka.ms/genai-beg-code?WT.mc_id=academic-105485-koreyst) ב-**Python** וב-**TypeScript**.
...
| 01  | [מבוא ל-AI גנרטיבי ול-LLMs](./01-introduction-to-genai/README.md?WT.mc_id=academic-105485-koreyst)                              | **למדו:** הבנת מהו AI גנרטיבי ואיך מודלים שפה גדולים (LLMs) עובדים.       | [וידאו](https://aka.ms/gen-ai-lesson-1-gh?WT.mc_id=academic-105485-koreyst) | [למידה נוספת](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 02  | [חקירה והשוואה בין LLMs שונים](./02-exploring-and-comparing-different-llms/README.md?WT.mc_id=academic-105485-koreyst)             | **למדו:** איך לבחור את המודל המתאים לשימוש שלכם                                      | [וידאו](https://aka.ms/gen-ai-lesson2-gh?WT.mc_id=academic-105485-koreyst)  | [למידה נוספת](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 03  | [שימוש אחראי ב-AI גנרטיבי](./03-using-generative-ai-responsibly/README.md?WT.mc_id=academic-105485-koreyst)                           | **למדו:** איך לבנות יישומי AI גנרטיבי בצורה אחראית                                  | [וידאו](https://aka.ms/gen-ai-lesson3-gh?WT.mc_id=academic-105485-koreyst)  | [למידה נוספת](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
