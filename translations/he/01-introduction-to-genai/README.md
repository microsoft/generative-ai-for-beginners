...
[![מבוא ל-AI גנרטיבי ומודלים לשוניים גדולים](../../../translated_images/he/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![חמישה תלמידים צעירים מסתכלים על מסך - תמונה מאת DALLE2](../../../translated_images/he/students-by-DALLE2.b70fddaced1042ee.png)
...
![AI, ML, DL ו-AI גנרטיבי](../../../translated_images/he/AI-diagram.c391fa518451a40d.png)
...
![דוגמה לטוקניזציה](../../../translated_images/he/tokenizer-example.80a5c151ee7d1bd4.png)
...
- **הוראה** שמפרטת את סוג הפלט שאנו מצפים מהמודל. ההוראה עשויה לעיתים לכלול דוגמאות או נתונים נוספים.
  ...
  1. סיכום של מאמר, ספר, ביקורות מוצרים ועוד, יחד עם הפקת תובנות מנתונים לא מובנים.
    ...
    ![דוגמה לסיכום](../../../translated_images/he/summarization-example.7b7ff97147b3d790.png)
  
  2. יצירת רעיונות ועיצוב יצירתי של מאמר, חיבור, משימה או יותר.
      
     ![דוגמה לכתיבה יצירתית](../../../translated_images/he/creative-writing-example.e24a685b5a543ad1.png)

- **שאלה**, שנשאלת בצורה של שיחה עם סוכן.
  
  ![דוגמה לשיחה](../../../translated_images/he/conversation-example.60c2afc0f595fa59.png)

- חלק של **טקסט להשלמה**, שמרמז על בקשה לעזרה בכתיבה.
  
  ![דוגמה להשלמת טקסט](../../../translated_images/he/text-completion-example.cbb0f28403d42752.png)

- חלק של **קוד** יחד עם בקשה להסבר ותיעוד שלו, או הערה שמבקשת לייצר קטע קוד שמבצע משימה ספציפית.
  
  ![דוגמה לקוד](../../../translated_images/he/coding-example.50ebabe8a6afff20.png)
