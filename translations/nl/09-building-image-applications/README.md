...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:59:12+00:00",
...
- **Afbeeldingsbewerking en synthese**. Je kunt afbeeldingen genereren voor verschillende toepassingen, zoals beeldbewerking en beeldsynthese.
...
- **Variaties maken**. Het idee is dat je een bestaande afbeelding neemt en vraagt om variaties te maken. Om een variatie te maken, geef je een afbeelding en een tekstprompt en code zoals hieronder:
...
De studenten zullen afbeeldingen maken voor hun opdrachten met monumenten. Welke monumenten ze kiezen, is aan de studenten. De studenten worden gevraagd hun creativiteit te gebruiken in deze taak om deze monumenten in verschillende contexten te plaatsen.
