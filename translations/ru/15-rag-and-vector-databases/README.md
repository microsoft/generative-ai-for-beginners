...
[![Генерация с дополнением извлечения (RAG) и векторные базы данных](../../../translated_images/ru/15-lesson-banner.ac49e59506175d4f.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![схема, показывающая, как работают RAG](../../../translated_images/ru/how-rag-works.f5d0ff63942bd3a6.png)
...
![схема архитектуры RAG](../../../translated_images/ru/encoder-decode.f2658c25d0eadee2.png)
...
![векторное представление слова cat](../../../translated_images/ru/cat.74cbd7946bc9ca38.png)
