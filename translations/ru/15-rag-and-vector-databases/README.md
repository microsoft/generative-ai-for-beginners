...
[![Генерация с дополнением извлечения (RAG) и векторные базы данных](../../../translated_images/15-lesson-banner.ac49e59506175d4f.ru.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![схема, показывающая, как работают RAG](../../../translated_images/how-rag-works.f5d0ff63942bd3a6.ru.png)
...
![схема архитектуры RAG](../../../translated_images/encoder-decode.f2658c25d0eadee2.ru.png)
...
![векторное представление слова cat](../../../translated_images/cat.74cbd7946bc9ca38.ru.png)
