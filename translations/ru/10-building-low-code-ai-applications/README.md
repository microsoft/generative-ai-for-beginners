...
[![Создание приложений с использованием низкого кода и искусственного интеллекта](../../../translated_images/ru/10-lesson-banner.a01ac8fe3fd86310.webp)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
1. Copilot предложит таблицу Dataverse с необходимыми полями для хранения данных, которые вы хотите отслеживать, и некоторыми примерами данных. Вы можете настроить таблицу под свои нужды, используя функцию Copilot через разговорные шаги.
   ...
   ![Предложенные поля в новой таблице](../../../translated_images/ru/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.webp)
...
![Добавление нового экрана через запрос](../../../translated_images/ru/copilot-new-screen.2e0bef7132a17392.webp)
...
![Выберите новую таблицу](../../../translated_images/ru/describe-new-table.0792373eb757281e.webp)
...
![Опишите таблицу](../../../translated_images/ru/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.webp)
...
![Предложенная таблица Dataverse](../../../translated_images/ru/copilot-dataverse-table.b3bc936091324d9d.webp)
...
8. Удалите действие **Condition** из потока, так как вы не будете его использовать. Это должно выглядеть как на следующем скриншоте:
   ...
   ![Power Automate, удаление действий](../../../translated_images/ru/powerautomate-remove-actions.7216392fe684ceba.webp)
...
11. Выберите таблицу, которую вы создали ранее. Например, вы можете выбрать таблицу **Invoice Information**. Выберите динамическое содержимое из предыдущего действия, чтобы заполнить следующие поля:
    ...
    ![Power Automate, добавление строки](../../../translated_images/ru/powerautomate-add-row.5edce45e5dd3d51e.webp)
