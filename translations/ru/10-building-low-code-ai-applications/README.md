...
[![Создание приложений с использованием низкого кода и искусственного интеллекта](../../../translated_images/ru/10-lesson-banner.a01ac8fe3fd86310.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Опишите приложение, которое хотите создать](../../../translated_images/ru/copilot-chat-prompt-powerapps.84250f341d060830.png)
...
1. Copilot предложит таблицу Dataverse с необходимыми полями для хранения данных, которые вы хотите отслеживать, и некоторыми примерами данных. Вы можете настроить таблицу под свои нужды, используя функцию Copilot через разговорные шаги.
   ...
   ![Предложенные поля в новой таблице](../../../translated_images/ru/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.png)
...
![Добавление нового поля](../../../translated_images/ru/copilot-new-column.35e15ff21acaf274.png)
...
![Добавление нового экрана через запрос](../../../translated_images/ru/copilot-new-screen.2e0bef7132a17392.png)
...
![Выберите новую таблицу](../../../translated_images/ru/describe-new-table.0792373eb757281e.png)
...
![Опишите таблицу](../../../translated_images/ru/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.png)
...
![Предложенная таблица Dataverse](../../../translated_images/ru/copilot-dataverse-table.b3bc936091324d9d.png)
...
![Модели AI Builder](../../../translated_images/ru/ai-builder-models.8069423b84cfc47f.png)
...
2. Используйте текстовое поле на главном экране, чтобы описать рабочий процесс, который вы хотите создать. Например, **_Обработать счет, когда он поступает в мой почтовый ящик_**. Нажмите кнопку **Send**, чтобы отправить запрос AI Copilot.
   ...
   ![Copilot Power Automate](../../../translated_images/ru/copilot-chat-prompt-powerautomate.f377e478cc8412de.png)
...
8. Удалите действие **Condition** из потока, так как вы не будете его использовать. Это должно выглядеть как на следующем скриншоте:
   ...
   ![Power Automate, удаление действий](../../../translated_images/ru/powerautomate-remove-actions.7216392fe684ceba.png)
...
11. Выберите таблицу, которую вы создали ранее. Например, вы можете выбрать таблицу **Invoice Information**. Выберите динамическое содержимое из предыдущего действия, чтобы заполнить следующие поля:
    ...
    ![Power Automate, добавление строки](../../../translated_images/ru/powerautomate-add-row.5edce45e5dd3d51e.png)
...
![Создание запроса](../../../translated_images/ru/create-prompt-gpt.69d429300c2e870a.png)
