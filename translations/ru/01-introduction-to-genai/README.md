...
[![Введение в генеративный ИИ и большие языковые модели](../../../translated_images/ru/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![Пять молодых студентов смотрят на монитор - изображение от DALLE2](../../../translated_images/ru/students-by-DALLE2.b70fddaced1042ee.png)
...
![ИИ, МО, ГЛ и генеративный ИИ](../../../translated_images/ru/AI-diagram.c391fa518451a40d.png)
...
![Пример токенизации](../../../translated_images/ru/tokenizer-example.80a5c151ee7d1bd4.png)
...
- **Инструкцию**, уточняющую тип ожидаемого от модели вывода. Эта инструкция иногда может содержать примеры или дополнительные данные.
  ...
  1. Резюмирование статьи, книги, отзывов о продукте и т.д., а также извлечение инсайтов из неструктурированных данных.
    ...
    ![Пример резюмирования](../../../translated_images/ru/summarization-example.7b7ff97147b3d790.png)
  
  2. Креативное создание и дизайн статьи, эссе, задания и т.д.
      
     ![Пример креативного письма](../../../translated_images/ru/creative-writing-example.e24a685b5a543ad1.png)

- **Вопрос**, заданный в форме беседы с агентом.
  
  ![Пример беседы](../../../translated_images/ru/conversation-example.60c2afc0f595fa59.png)

- Фрагмент **текста для завершения**, который подразумевает запрос на помощь в написании.
  
  ![Пример завершения текста](../../../translated_images/ru/text-completion-example.cbb0f28403d42752.png)
...
- Фрагмент **кода** вместе с запросом на его объяснение и документирование или комментарий с просьбой сгенерировать код для выполнения конкретной задачи.
  ...
  ![Пример кода](../../../translated_images/ru/coding-example.50ebabe8a6afff20.png)
