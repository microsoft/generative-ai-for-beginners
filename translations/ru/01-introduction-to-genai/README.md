...
[![Введение в генеративный ИИ и большие языковые модели](../../../translated_images/ru/01-lesson-banner.2424cfd092f43366.webp)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![Пять молодых студентов смотрят на монитор - изображение от DALLE2](../../../translated_images/ru/students-by-DALLE2.b70fddaced1042ee.webp)
...
![ИИ, МО, ГЛ и генеративный ИИ](../../../translated_images/ru/AI-diagram.c391fa518451a40d.webp)
...
- **Инструкцию**, уточняющую тип ожидаемого от модели вывода. Эта инструкция иногда может содержать примеры или дополнительные данные.
  ...
  2. Креативное создание и дизайн статьи, эссе, задания и т.д.
     ...
     ![Пример креативного письма](../../../translated_images/ru/creative-writing-example.e24a685b5a543ad1.webp)

- **Вопрос**, заданный в форме беседы с агентом.
  
  ![Пример беседы](../../../translated_images/ru/conversation-example.60c2afc0f595fa59.webp)

- Фрагмент **текста для завершения**, который подразумевает запрос на помощь в написании.
  
  ![Пример завершения текста](../../../translated_images/ru/text-completion-example.cbb0f28403d42752.webp)
