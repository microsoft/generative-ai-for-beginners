...
[![Създаване на AI приложения с нисък код](../../../translated_images/10-lesson-banner.a01ac8fe3fd86310.bg.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Опишете приложението, което искате да създадете](../../../translated_images/copilot-chat-prompt-powerapps.84250f341d060830.bg.png)
...
1. AI Copilot ще предложи таблица в Dataverse с полетата, които са ви необходими за съхранение на данните, които искате да проследявате, както и примерни данни. След това можете да персонализирате таблицата според вашите нужди, използвайки функцията AI Copilot асистент чрез разговорни стъпки.
   ...
   ![Предложени полета в новата ви таблица](../../../translated_images/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.bg.png)
...
![Добавяне на ново поле](../../../translated_images/copilot-new-column.35e15ff21acaf274.bg.png)
...
![Добавяне на нов екран чрез подканяща инструкция](../../../translated_images/copilot-new-screen.2e0bef7132a17392.bg.png)
...
![Select new table](../../../translated_images/describe-new-table.0792373eb757281e.bg.png)
...
![Describe the table](../../../translated_images/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.bg.png)
...
![Suggested Dataverse table](../../../translated_images/copilot-dataverse-table.b3bc936091324d9d.bg.png)
...
![AI builder models](../../../translated_images/ai-builder-models.8069423b84cfc47f.bg.png)
...
2. Използвайте текстовото поле на началния екран, за да опишете работния поток, който искате да създадете. Например, **_Обработи фактура, когато пристигне в моята пощенска кутия_**. Кликнете върху бутона **Send**, за да изпратите заявката към AI Copilot.
   ...
   ![Copilot power automate](../../../translated_images/copilot-chat-prompt-powerautomate.f377e478cc8412de.bg.png)
...
8. Премахнете действието **Condition** от потока, защото няма да го използвате. Трябва да изглежда като следния екран:
   ...
   ![power automate, remove actions](../../../translated_images/powerautomate-remove-actions.7216392fe684ceba.bg.png)
...
11. Изберете таблицата, която създадохте по-рано. Например, можете да изберете таблицата **Invoice Information**. Изберете динамичното съдържание от предишното действие, за да попълните следните полета:
    ...
    ![power automate add row](../../../translated_images/powerautomate-add-row.5edce45e5dd3d51e.bg.png)
...
![create a prompt](../../../translated_images/create-prompt-gpt.69d429300c2e870a.bg.png)
