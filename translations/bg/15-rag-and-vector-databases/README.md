...
[![Извличане с допълнително генериране (RAG) и векторни бази данни](../../../translated_images/bg/15-lesson-banner.ac49e59506175d4f.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![диаграма, показваща как работят RAG](../../../translated_images/bg/how-rag-works.f5d0ff63942bd3a6.png)
...
![диаграма, показваща архитектурата на RAG](../../../translated_images/bg/encoder-decode.f2658c25d0eadee2.png)
...
![вграждане на думата котка](../../../translated_images/bg/cat.74cbd7946bc9ca38.png)
