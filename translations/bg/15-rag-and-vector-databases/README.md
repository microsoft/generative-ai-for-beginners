...
[![Извличане с допълнително генериране (RAG) и векторни бази данни](../../../translated_images/bg/15-lesson-banner.ac49e59506175d4f.webp)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![диаграма, показваща как работят RAG](../../../translated_images/bg/how-rag-works.f5d0ff63942bd3a6.webp)
...
![диаграма, показваща архитектурата на RAG](../../../translated_images/bg/encoder-decode.f2658c25d0eadee2.webp)
