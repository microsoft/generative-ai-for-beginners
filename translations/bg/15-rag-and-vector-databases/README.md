...
[![Извличане с допълнително генериране (RAG) и векторни бази данни](../../../translated_images/15-lesson-banner.ac49e59506175d4f.bg.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![диаграма, показваща как работят RAG](../../../translated_images/how-rag-works.f5d0ff63942bd3a6.bg.png)
...
![диаграма, показваща архитектурата на RAG](../../../translated_images/encoder-decode.f2658c25d0eadee2.bg.png)
...
![вграждане на думата котка](../../../translated_images/cat.74cbd7946bc9ca38.bg.png)
