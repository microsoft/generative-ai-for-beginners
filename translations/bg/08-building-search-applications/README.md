...
[![Въведение в Генеративния AI и Големите Езикови Модели](../../../translated_images/08-lesson-banner.8fff48c566dad08a.bg.png)](https://youtu.be/W0-nzXjOjr0?si=GcsqiTTvd7RKbo7V)
...
![Семантично търсене за въпроса "Може ли да се използва rstudio с Azure ML"](../../../translated_images/query-results.bb0480ebf025fac6.bg.png)
...
![Поле за въвеждане на заявка от потребителя](../../../translated_images/notebook-search.1e320b9c7fcbb0bc.bg.png)
