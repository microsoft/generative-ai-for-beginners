...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-17T22:19:35+00:00",
...
[![Създаване на приложения за генериране на изображения](../../../translated_images/bg/09-lesson-banner.906e408c741f4411.png)](https://youtu.be/B5VP0_J7cs8?si=5P3L5o7F_uS_QcG9)
...
![Стартъп Edu4All, клас за паметници, Айфеловата кула](../../../translated_images/bg/startup.94d6b79cc4bb3f5a.png)
...
<div style="display: flex; justify-content: space-between; align-items: center; margin: 20px 0;">
  <img src="../../../translated_images/bg/sunlit_lounge.a75a0cb61749db0e.png" style="width: 30%; max-width: 200px; height: auto;">
  <img src="../../../translated_images/bg/mask.1b2976ccec9e011e.png" style="width: 30%; max-width: 200px; height: auto;">
  <img src="../../../translated_images/bg/sunlit_lounge_result.76ae02957c0bbeb8.png" style="width: 30%; max-width: 200px; height: auto;">
</div>
...
![Зайче на кон, държащо близалка, версия 1](../../../translated_images/bg/v1-generated-image.a295cfcffa3c13c2.png)

Сега нека изпълним същия промпт отново, за да видим, че няма да получим едно и също изображение два пъти:

![Генерирано изображение на зайче на кон](../../../translated_images/bg/v2-generated-image.33f55a3714efe61d.png)
...
- ![Температура 0, версия 1](../../../translated_images/bg/v1-temp-generated-image.a4346e1d2360a056.png)
- ![Температура 0, версия 2](../../../translated_images/bg/v2-temp-generated-image.871d0c920dbfb0f1.png)
