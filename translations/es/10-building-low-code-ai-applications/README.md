...
[![Construcción de Aplicaciones de IA con Bajo Código](../../../translated_images/es/10-lesson-banner.a01ac8fe3fd86310.webp)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Describe la aplicación que deseas construir](../../../translated_images/es/copilot-chat-prompt-powerapps.84250f341d060830.webp)
...
1. El asistente de IA Copilot sugerirá una tabla de Dataverse con los campos que necesitas para almacenar los datos que deseas rastrear y algunos datos de muestra. Luego puedes personalizar la tabla para satisfacer tus necesidades utilizando la función de asistente de IA Copilot a través de pasos conversacionales.
   ...
   ![Campos sugeridos en tu nueva tabla](../../../translated_images/es/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.webp)
...
![Agregando un nuevo campo](../../../translated_images/es/copilot-new-column.35e15ff21acaf274.webp)
...
![Agregando una nueva pantalla mediante una instrucción de prompt](../../../translated_images/es/copilot-new-screen.2e0bef7132a17392.webp)
...
![Seleccionar nueva tabla](../../../translated_images/es/describe-new-table.0792373eb757281e.webp)
...
![Tabla sugerida de Dataverse](../../../translated_images/es/copilot-dataverse-table.b3bc936091324d9d.webp)
...
![Crear un mensaje](../../../translated_images/es/create-prompt-gpt.69d429300c2e870a.webp)
