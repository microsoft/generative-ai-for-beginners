...
### 21 Μαθήματα που διδάσκουν όλα όσα χρειάζεται να ξέρετε για να ξεκινήσετε να δημιουργείτε εφαρμογές Generative AI
...
Μάθετε τα βασικά για την κατασκευή εφαρμογών Generative AI με το ολοκληρωμένο μάθημά μας 21 μαθημάτων από τους Microsoft Cloud Advocates.

## 🌱 Ξεκινώντας

Αυτό το μάθημα έχει 21 μαθήματα. Κάθε μάθημα καλύπτει το δικό του θέμα, οπότε ξεκινήστε από όποιο σημείο θέλετε!

Τα μαθήματα είναι επισημασμένα είτε ως "Μάθετε" που εξηγούν μια έννοια Generative AI είτε ως "Κατασκευάστε" που εξηγούν μια έννοια και παραδείγματα κώδικα σε **Python** και **TypeScript** όπου είναι δυνατόν.

Για προγραμματιστές .NET δείτε το [Generative AI για Αρχάριους (Έκδοση .NET)](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)!
...
- Έναν λογαριασμό GitHub για να [κλωνοποιήσετε ολόκληρο αυτό το repo](https://aka.ms/genai-beginners/github?WT.mc_id=academic-105485-koreyst) στον δικό σας λογαριασμό GitHub

Έχουμε δημιουργήσει ένα μάθημα **[Ρύθμισης Μαθήματος](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)** για να σας βοηθήσουμε με την προετοιμασία του περιβάλλοντος ανάπτυξής σας.

Μην ξεχάσετε να [βαθμολογήσετε (🌟) αυτό το repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) για να το βρείτε πιο εύκολα αργότερα.

## 🧠 Έτοιμοι για Ανάπτυξη;

Αν ψάχνετε για πιο προχωρημένα παραδείγματα κώδικα, δείτε τη [συλλογή μας με παραδείγματα κώδικα Generative AI](https://aka.ms/genai-beg-code?WT.mc_id=academic-105485-koreyst) σε **Python** και **TypeScript**.

## 🗣️ Γνωρίστε Άλλους Μαθητές, Πάρτε Υποστήριξη

Ενταχθείτε στον [επίσημο server Discord Azure AI Foundry](https://aka.ms/genai-discord?WT.mc_id=academic-105485-koreyst) για να γνωρίσετε και να δικτυωθείτε με άλλους μαθητές που παρακολουθούν αυτό το μάθημα και να πάρετε υποστήριξη.
...
Έχετε προτάσεις ή βρήκατε λάθη στα ορθογραφικά ή στον κώδικα; [Δημιουργήστε issue](https://github.com/microsoft/generative-ai-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ή [Κάντε pull request](https://github.com/microsoft/generative-ai-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Συνδέσμους προς επιπλέον πόρους για να συνεχίσετε τη μάθησή σας

## 🗃️ Μαθήματα

| #   | **Σύνδεσμος Μαθήματος**                                                                                                                   | **Περιγραφή**                                                                                     | **Βίντεο**                                                                  | **Επιπλέον Μάθηση**                                                           |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 00  | [Ρύθμιση Μαθήματος](./00-course-setup/README.md?WT.mc_id=academic-105485-koreyst)                                                          | **Μάθετε:** Πώς να ρυθμίσετε το περιβάλλον ανάπτυξής σας                                          | Το βίντεο έρχεται σύντομα                                                      | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 01  | [Εισαγωγή στο Generative AI και LLMs](./01-introduction-to-genai/README.md?WT.mc_id=academic-105485-koreyst)                               | **Μάθετε:** Κατανόηση τι είναι το Generative AI και πώς λειτουργούν τα Μεγάλα Γλωσσικά Μοντέλα (LLMs) | [Βίντεο](https://aka.ms/gen-ai-lesson-1-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 04  | [Κατανόηση των Θεμελίων του Prompt Engineering](./04-prompt-engineering-fundamentals/README.md?WT.mc_id=academic-105485-koreyst)             | **Μάθετε:** Καλές Πρακτικές Prompt Engineering με πρακτική εμπειρία                                           | [Βίντεο](https://aka.ms/gen-ai-lesson4-gh?WT.mc_id=academic-105485-koreyst)  | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 05  | [Δημιουργία Προηγμένων Prompts](./05-advanced-prompts/README.md?WT.mc_id=academic-105485-koreyst)                                                | **Μάθετε:** Πώς να εφαρμόζετε τεχνικές prompt engineering που βελτιώνουν το αποτέλεσμα των prompts σας. | [Βίντεο](https://aka.ms/gen-ai-lesson5-gh?WT.mc_id=academic-105485-koreyst)  | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 07  | [Κατασκευή Εφαρμογών Συνομιλίας](./07-building-chat-applications/README.md?WT.mc_id=academic-105485-koreyst)                                     | **Κατασκευή:** Τεχνικές για την αποδοτική κατασκευή και ενσωμάτωση εφαρμογών συνομιλίας.               | [Βίντεο](https://aka.ms/gen-ai-lessons7-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 08  | [Κατασκευή Εφαρμογών Αναζήτησης Βάσει Διανυσματικών Βάσεων Δεδομένων](./08-building-search-applications/README.md?WT.mc_id=academic-105485-koreyst)                        | **Κατασκευή:** Μια εφαρμογή αναζήτησης που χρησιμοποιεί Ενσωματώσεις (Embeddings) για αναζήτηση δεδομένων.                        | [Βίντεο](https://aka.ms/gen-ai-lesson8-gh?WT.mc_id=academic-105485-koreyst)  | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 11  | [Ενσωμάτωση Εξωτερικών Εφαρμογών με Κλήσεις Συναρτήσεων](./11-integrating-with-function-calling/README.md?WT.mc_id=academic-105485-koreyst) | **Κατασκευή:** Τι είναι η κλήση συνάρτησης και οι χρήσεις της για εφαρμογές                          | [Βίντεο](https://aka.ms/gen-ai-lesson11-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 12  | [Σχεδίαση UX για Εφαρμογές Τεχνητής Νοημοσύνης](./12-designing-ux-for-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                         | **Μάθετε:** Πώς να εφαρμόζετε αρχές σχεδιασμού UX κατά την ανάπτυξη Εφαρμογών Γεννητικής Τεχνητής Νοημοσύνης         | [Βίντεο](https://aka.ms/gen-ai-lesson12-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 13  | [Ασφάλεια των Εφαρμογών Γεννητικής Τεχνητής Νοημοσύνης](./13-securing-ai-applications/README.md?WT.mc_id=academic-105485-koreyst)                         | **Μάθετε:** Οι απειλές και οι κίνδυνοι για τα συστήματα τεχνητής νοημοσύνης και οι μέθοδοι προστασίας τους.             | [Βίντεο](https://aka.ms/gen-ai-lesson13-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 14  | [Ο Κύκλος Ζωής Εφαρμογών Γεννητικής Τεχνητής Νοημοσύνης](./14-the-generative-ai-application-lifecycle/README.md?WT.mc_id=academic-105485-koreyst)           | **Μάθετε:** Τα εργαλεία και οι μετρήσεις για τη διαχείριση του κύκλου ζωής LLM και των LLMOps                         | [Βίντεο](https://aka.ms/gen-ai-lesson14-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 15  | [Ανάκτηση Εμπλουτισμένης Δημιουργίας (RAG) και Βάσεις Δεδομένων Διανυσμάτων](./15-rag-and-vector-databases/README.md?WT.mc_id=academic-105485-koreyst)        | **Κατασκευή:** Μια εφαρμογή που χρησιμοποιεί ένα πλαίσιο RAG για την ανάκτηση ενσωματώσεων από βάσεις δεδομένων διανυσμάτων  | [Βίντεο](https://aka.ms/gen-ai-lesson15-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 16  | [Ανοικτά Μοντέλα και Hugging Face](./16-open-source-models/README.md?WT.mc_id=academic-105485-koreyst)                                    | **Κατασκευή:** Μια εφαρμογή που χρησιμοποιεί ανοικτά μοντέλα διαθέσιμα στη Hugging Face                    | [Βίντεο](https://aka.ms/gen-ai-lesson16-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 17  | [Πράκτορες Τεχνητής Νοημοσύνης](./17-ai-agents/README.md?WT.mc_id=academic-105485-koreyst)                                                                       | **Κατασκευή:** Μια εφαρμογή που χρησιμοποιεί ένα πλαίσιο πράκτορα Τεχνητής Νοημοσύνης                                           | [Βίντεο](https://aka.ms/gen-ai-lesson17-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 18  | [Βελτιστοποίηση Μεγάλων Γλωσσικών Μοντέλων (LLMs)](./18-fine-tuning/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **Μάθετε:** Το τι, το γιατί και το πώς της βελτιστοποίησης μεγάλων γλωσσικών μοντέλων                                            | [Βίντεο](https://aka.ms/gen-ai-lesson18-gh?WT.mc_id=academic-105485-koreyst) | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 19  | [Κατασκευή με Μικρά Γλωσσικά Μοντέλα (SLMs)](./19-slm/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **Μάθετε:** Τα οφέλη της κατασκευής με Μικρά Γλωσσικά Μοντέλα                                            | Έρχεται Βίντεο | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 20  | [Κατασκευή με Μοντέλα Mistral](./20-mistral/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **Μάθετε:** Τα χαρακτηριστικά και οι διαφορές των Μοντέλων Οικογένειας Mistral                                           | Έρχεται Βίντεο | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
| 21  | [Κατασκευή με Μοντέλα Meta](./21-meta/README.md?WT.mc_id=academic-105485-koreyst)                                                              | **Μάθετε:** Τα χαρακτηριστικά και οι διαφορές των Μοντέλων Οικογένειας Meta                                           | Έρχεται Βίντεο | [Μάθετε Περισσότερα](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
### Σειρά Copilot
[![Copilot για Προγραμματισμό σε Ζευγάρια με ΤΝ](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Αν κολλήσετε ή έχετε οποιεσδήποτε απορίες σχετικά με την κατασκευή εφαρμογών Τεχνητής Νοημοσύνης, συμμετάσχετε σε συζητήσεις με άλλους εκπαιδευόμενους και έμπειρους προγραμματιστές για το MCP. Είναι μια υποστηρικτική κοινότητα όπου οι ερωτήσεις γίνονται ευπρόσδεκτες και η γνώση μοιράζεται ελεύθερα.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Εάν έχετε σχόλια προϊόντος ή αντιμετωπίζετε σφάλματα κατά την ανάπτυξη, επισκεφτείτε:
