...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-17T18:29:23+00:00",
...
[![Θεμελιώδεις Αρχές της Μηχανικής Προτροπών](../../../translated_images/el/04-lesson-banner.a2c90deba7fedacd.png)](https://youtu.be/GElCu2kUlRs?si=qrXsBvXnCW12epb8)
...
![Εικονογραφημένος Οδηγός για τη Μηχανική Προτροπών](../../../translated_images/el/04-prompt-engineering-sketchnote.d5f33336957a1e4f.png)
...
![Tokenization](../../../translated_images/el/04-tokenizer-example.e71f0a0f70356c5c.png)
...
![Base LLM Chat Completion](../../../translated_images/el/04-playground-chat-base.65b76fcfde0caa67.png)
...
![Instruction Tuned LLM Chat Completion](../../../translated_images/el/04-playground-chat-instructions.b30bbfbdf92f2d05.png)
...
![Απάντηση 1](../../../translated_images/el/04-fabrication-oai.5818c4e0b2a2678c.png)

> **Απάντηση 2**: Azure OpenAI Playground (GPT-35)

![Απάντηση 2](../../../translated_images/el/04-fabrication-aoai.b14268e9ecf25caf.png)

> **Απάντηση 3**: Hugging Face Chat Playground (LLama-2)

![Απάντηση 3](../../../translated_images/el/04-fabrication-huggingchat.faf82a0a51278956.png)
...
Στα παραπάνω παραδείγματα, η ερώτηση ήταν ακόμα αρκετά ανοιχτή, επιτρέποντας στο LLM να αποφασίσει ποιο μέρος του προ-εκπαιδευμένου συνόλου δεδομένων ήταν σχετικό. Με το _σχέδιο κύριου περιεχομένου_, το εισαγωγικό κείμενο χωρίζεται σε δύο μέρη:
