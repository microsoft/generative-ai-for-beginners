...
[![Θεμελιώδεις Αρχές της Μηχανικής Προτροπών](../../../translated_images/04-lesson-banner.a2c90deba7fedacd.el.png)](https://youtu.be/GElCu2kUlRs?si=qrXsBvXnCW12epb8)
...
![Εικονογραφημένος Οδηγός για τη Μηχανική Προτροπών](../../../translated_images/04-prompt-engineering-sketchnote.d5f33336957a1e4f.el.png)
...
![Tokenization](../../../translated_images/04-tokenizer-example.e71f0a0f70356c5c.el.png)
...
![Base LLM Chat Completion](../../../translated_images/04-playground-chat-base.65b76fcfde0caa67.el.png)
...
![Instruction Tuned LLM Chat Completion](../../../translated_images/04-playground-chat-instructions.b30bbfbdf92f2d05.el.png)
...
![Απάντηση 1](../../../translated_images/04-fabrication-oai.5818c4e0b2a2678c.el.png)

> **Απάντηση 2**: Azure OpenAI Playground (GPT-35)

![Απάντηση 2](../../../translated_images/04-fabrication-aoai.b14268e9ecf25caf.el.png)

> **Απάντηση 3**: Hugging Face Chat Playground (LLama-2)

![Απάντηση 3](../../../translated_images/04-fabrication-huggingchat.faf82a0a51278956.el.png)
