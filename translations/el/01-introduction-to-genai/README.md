...
[![Εισαγωγή στην Παραγωγική Τεχνητή Νοημοσύνη και τα Μεγάλα Γλωσσικά Μοντέλα](../../../translated_images/01-lesson-banner.2424cfd092f43366.el.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![Πέντε νέοι μαθητές κοιτάζουν μια οθόνη - εικόνα από DALLE2](../../../translated_images/students-by-DALLE2.b70fddaced1042ee.el.png)
...
![AI, ML, DL και Παραγωγική Τεχνητή Νοημοσύνη](../../../translated_images/AI-diagram.c391fa518451a40d.el.png)
...
![Παράδειγμα tokenization](../../../translated_images/tokenizer-example.80a5c151ee7d1bd4.el.png)
...
- Μια **οδηγία** που καθορίζει τον τύπο εξαγωγής που περιμένουμε από το μοντέλο. Αυτή η οδηγία μπορεί μερικές φορές να περιλαμβάνει παραδείγματα ή πρόσθετα δεδομένα.
  ...
  1. Περίληψη ενός άρθρου, βιβλίου, κριτικών προϊόντων και άλλα, μαζί με εξαγωγή πληροφοριών από μη δομημένα δεδομένα.
    ...
    ![Παράδειγμα περίληψης](../../../translated_images/summarization-example.7b7ff97147b3d790.el.png)
  
  2. Δημιουργική ιδέα και σχεδιασμός ενός άρθρου, δοκιμίου, εργασίας ή άλλου.
      
     ![Παράδειγμα δημιουργικής γραφής](../../../translated_images/creative-writing-example.e24a685b5a543ad1.el.png)

- Μια **ερώτηση**, που τίθεται με τη μορφή συνομιλίας με έναν πράκτορα.
  
  ![Παράδειγμα συνομιλίας](../../../translated_images/conversation-example.60c2afc0f595fa59.el.png)
