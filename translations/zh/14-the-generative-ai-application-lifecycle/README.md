...
-->
[![与函数调用集成](../../../translated_images/14-lesson-banner.066d74a31727ac12.zh.png)](https://youtu.be/ewtQY_RJrzs?si=dyJ2bjiljH7UUHCh)
...
![LLMOps 与 MLOps 对比](../../../translated_images/01-llmops-shift.29bc933cb3bb0080.zh.png)
...
![LLMOps 信息图](../../../translated_images/02-llmops.70a942ead05a7645.zh.png)
...
![LLMOps 工作流程](../../../translated_images/03-llm-stage-flows.3a1e1c401235a6cf.zh.png)
...
![Azure AI 可能性](../../../translated_images/04-azure-ai-platform.80203baf03a12fa8.zh.png)

Azure AI 允许您使用多种资源，管理您的运营、服务、项目、向量搜索和数据库需求。

![使用 Azure AI 的 LLMOps](../../../translated_images/05-llm-azure-ai-prompt.a5ce85cdbb494bdf.zh.png)
...
![使用 PromptFlow 的 LLMOps](../../../translated_images/06-llm-promptflow.a183eba07a3a7fdf.zh.png)
