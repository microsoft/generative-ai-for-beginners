...
[![检索增强生成 (RAG) 和向量数据库](../../../translated_images/15-lesson-banner.ac49e59506175d4f.zh.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![展示 RAG 工作原理的图示](../../../translated_images/how-rag-works.f5d0ff63942bd3a6.zh.png)
...
![展示 RAG 架构的图示](../../../translated_images/encoder-decode.f2658c25d0eadee2.zh.png)
...
![“cat”一词的嵌入示例](../../../translated_images/cat.74cbd7946bc9ca38.zh.png)
