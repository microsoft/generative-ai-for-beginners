...
[![生成式 AI 和大型语言模型简介](../../../translated_images/08-lesson-banner.8fff48c566dad08a.zh.png)](https://youtu.be/W0-nzXjOjr0?si=GcsqiTTvd7RKbo7V)
...
![关于问题“可以在 Azure ML 中使用 RStudio 吗？”的语义查询示例](../../../translated_images/query-results.bb0480ebf025fac6.zh.png)
...
![用户输入查询的输入框](../../../translated_images/notebook-search.1e320b9c7fcbb0bc.zh.png)
