...
<<<<<<< HEAD
  ...
  "translation_date": "2025-09-29T23:40:59+00:00",
=======
...
Šis kursas turi 21 pamoką. Kiekviena pamoka apima atskirą temą, todėl galite pradėti nuo bet kurios!
...
Prisijunkite prie mūsų [oficialaus Azure AI Foundry Discord serverio](https://aka.ms/genai-discord?WT.mc_id=academic-105485-koreyst), kad susipažintumėte ir bendrautumėte su kitais šio kurso mokiniais bei gautumėte pagalbos.
...
| 08  | [Paieškos programų kūrimas su vektorinėmis duomenų bazėmis](./08-building-search-applications/README.md?WT.mc_id=academic-105485-koreyst)                        | **Kurkite:** Paieškos programą, naudojančią įterpinius duomenų paieškai.                        | [Vaizdo įrašas](https://aka.ms/gen-ai-lesson8-gh?WT.mc_id=academic-105485-koreyst)  | [Sužinokite daugiau](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
...
| 15  | [RAG (Retrieval Augmented Generation) ir vektorinės duomenų bazės](./15-rag-and-vector-databases/README.md?WT.mc_id=academic-105485-koreyst)        | **Kurkite:** Programą, naudojančią RAG sistemą įterpinių paieškai vektorinėse duomenų bazėse  | [Vaizdo įrašas](https://aka.ms/gen-ai-lesson15-gh?WT.mc_id=academic-105485-koreyst) | [Sužinokite daugiau](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) |
