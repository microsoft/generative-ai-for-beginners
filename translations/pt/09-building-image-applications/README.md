...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:40:04+00:00",
...
Aqui está um exemplo do que os alunos da Edu4All poderiam gerar se estivessem a trabalhar em sala de aula sobre monumentos:
...
- **Criar variações**. A ideia é pegar numa imagem existente e pedir que sejam criadas variações. Para criar uma variação, fornece uma imagem e um prompt textual e usa código como este:
...
Vamos, portanto, alterar o nosso código e definir a temperatura para 0, assim:
...
No prompt acima, pode ver como todas as imagens criadas consideram o metaprompt.
...
Depois de concluir esta lição, explore a nossa [coleção de Aprendizagem de IA Generativa](https://aka.ms/genai-collection?WT.mc_id=academic-105485-koreyst) para continuar a aprofundar os seus conhecimentos sobre IA Generativa!
