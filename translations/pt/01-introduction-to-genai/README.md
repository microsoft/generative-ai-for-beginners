...
[![Introdução à IA Generativa e Modelos de Linguagem de Grande Escala](../../../translated_images/pt/01-lesson-banner.2424cfd092f43366.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![Cinco jovens estudantes olhando para um monitor - imagem por DALLE2](../../../translated_images/pt/students-by-DALLE2.b70fddaced1042ee.png)
...
![IA, ML, DL e IA Generativa](../../../translated_images/pt/AI-diagram.c391fa518451a40d.png)
...
![Exemplo de tokenização](../../../translated_images/pt/tokenizer-example.80a5c151ee7d1bd4.png)
...
- Uma **instrução** especificando o tipo de saída que esperamos do modelo. Essa instrução às vezes pode incluir alguns exemplos ou dados adicionais.
  ...
  1. Resumo de um artigo, livro, avaliações de produtos e mais, juntamente com a extração de insights de dados não estruturados.
    ...
    ![Exemplo de resumo](../../../translated_images/pt/summarization-example.7b7ff97147b3d790.png)
  
  2. Ideação criativa e design de um artigo, ensaio, tarefa ou mais.
      
     ![Exemplo de escrita criativa](../../../translated_images/pt/creative-writing-example.e24a685b5a543ad1.png)

- Uma **pergunta**, feita na forma de uma conversa com um agente.
  
  ![Exemplo de conversa](../../../translated_images/pt/conversation-example.60c2afc0f595fa59.png)

- Um pedaço de **texto para completar**, que implicitamente é um pedido de assistência na escrita.
  
  ![Exemplo de conclusão de texto](../../../translated_images/pt/text-completion-example.cbb0f28403d42752.png)
...
- Um pedaço de **código** junto com o pedido de explicá-lo e documentá-lo, ou um comentário pedindo para gerar um trecho de código que execute uma tarefa específica.
  ...
  ![Exemplo de código](../../../translated_images/pt/coding-example.50ebabe8a6afff20.png)
