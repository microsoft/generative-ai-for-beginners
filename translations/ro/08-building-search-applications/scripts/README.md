...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-25T16:59:29+00:00",
...
Scripturile pentru pregătirea datelor de transcriere descarcă transcrierile video de pe YouTube și le pregătesc pentru utilizarea cu exemplul de Căutare Semantică folosind OpenAI Embeddings și Funcții.

Scripturile pentru pregătirea datelor de transcriere au fost testate pe cele mai recente versiuni de Windows 11, macOS Ventura și Ubuntu 22.04 (și mai sus).
...
> verificați [tabelul de disponibilitate al modelului](https://aka.ms/oai/models?WT.mc_id=academic-105485-koreyst).
...
Următoarele variabile de mediu sunt necesare pentru a rula scripturile de pregătire a datelor de transcriere de pe YouTube.
...
1. Dintr-o fereastră `Terminal`, clonați exemplul în folderul de repo preferat.
...
## Rulați scripturile de pregătire a datelor de transcriere de pe YouTube
