...
[![探索與比較不同的LLM](../../../translated_images/zh-TW/02-lesson-banner.ef94c84979f97f60.webp)](https://youtu.be/KIRUeDKscfI?si=8BHX1zvwzQBn-PlK)
...
![基礎模型與LLM的區別](../../../translated_images/zh-TW/FoundationModel.e4859dbb7a825c94.webp)
...
![嵌入](../../../translated_images/zh-TW/Embedding.c3708fe988ccf760.webp)
...
![文本和代碼生成](../../../translated_images/zh-TW/Text.a8c0cf139e5cc2a0.webp)
...
![模型目錄](../../../translated_images/zh-TW/AzureAIStudioModelCatalog.3cf8a499aa8ba031.webp)

- 查看模型卡，包括詳細的用途描述和訓練數據、代碼示例以及內部評估庫的評估結果。

![模型卡](../../../translated_images/zh-TW/ModelCard.598051692c6e400d.webp)
...
![模型基準測試](../../../translated_images/zh-TW/ModelBenchmarks.254cb20fbd06c03a.webp)

- 利用 Azure AI Studio 的實驗和追蹤功能，基於自定義訓練數據微調模型，以提高模型在特定工作負載中的性能。

![模型微調](../../../translated_images/zh-TW/FineTuning.aac48f07142e36fd.webp)
...
![模型部署](../../../translated_images/zh-TW/ModelDeploy.890da48cbd0bccdb.webp)
...
![LLMs 部署](../../../translated_images/zh-TW/Deploy.18b2d27412ec8c02.webp)
