...
[![Wprowadzenie do generatywnej sztucznej inteligencji i dużych modeli językowych](../../../translated_images/01-lesson-banner.2424cfd092f43366.pl.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![Pięcioro młodych uczniów patrzących na monitor - obraz stworzony przez DALLE2](../../../translated_images/students-by-DALLE2.b70fddaced1042ee.pl.png)
...
![AI, ML, DL i generatywna AI](../../../translated_images/AI-diagram.c391fa518451a40d.pl.png)
...
![Przykład tokenizacji](../../../translated_images/tokenizer-example.80a5c151ee7d1bd4.pl.png)
...
- **Instrukcję** określającą rodzaj oczekiwanego wyjścia z modelu. Instrukcja ta czasami może zawierać przykłady lub dodatkowe dane.
  ...
  1. Podsumowanie artykułu, książki, recenzji produktów i innych, wraz z wyciąganiem wniosków z nieustrukturyzowanych danych.
    ...
    ![Przykład podsumowania](../../../translated_images/summarization-example.7b7ff97147b3d790.pl.png)
  
  2. Kreatywne pomysły i projektowanie artykułu, eseju, zadania lub innych treści.
      
     ![Przykład kreatywnego pisania](../../../translated_images/creative-writing-example.e24a685b5a543ad1.pl.png)

- **Pytanie**, zadane w formie rozmowy z agentem.
  
  ![Przykład rozmowy](../../../translated_images/conversation-example.60c2afc0f595fa59.pl.png)

- Fragment **tekstu do uzupełnienia**, który implikuje prośbę o pomoc w pisaniu.
  
  ![Przykład uzupełniania tekstu](../../../translated_images/text-completion-example.cbb0f28403d42752.pl.png)
...
- Fragment **kodu** wraz z prośbą o jego wyjaśnienie i dokumentację, lub komentarz z prośbą o wygenerowanie fragmentu kodu wykonującego określone zadanie.
  ...
  ![Przykład kodowania](../../../translated_images/coding-example.50ebabe8a6afff20.pl.png)
