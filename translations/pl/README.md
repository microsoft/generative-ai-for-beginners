...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:43:49+00:00",
...
Lekcje są oznaczone jako "Learn" (nauka), które wyjaśniają koncepcję Generative AI, lub "Build" (budowanie), które zawierają zarówno wyjaśnienia koncepcji, jak i przykłady kodu w **Pythonie** i **TypeScript**, jeśli to możliwe.
...
Zadaj pytania lub podziel się opinią o produkcie na naszym [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum) na GitHub.
...
[**Bernhard Merkle**](https://www.linkedin.com/in/bernhard-merkle-738b73/) za kluczowy wkład w każdą lekcję, aby poprawić doświadczenie nauki i kodowania.
