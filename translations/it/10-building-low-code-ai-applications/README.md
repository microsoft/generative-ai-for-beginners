...
[![Creare Applicazioni AI a Basso Codice](../../../translated_images/it/10-lesson-banner.a01ac8fe3fd86310.png)](https://youtu.be/1vzq3Nd8GBA?si=h6LHWJXdmqf6mhDg)
...
![Descrivi l'app che vuoi creare](../../../translated_images/it/copilot-chat-prompt-powerapps.84250f341d060830.png)
...
1. Copilot AI suggerirà una tabella Dataverse con i campi necessari per archiviare i dati che vuoi monitorare e alcuni dati di esempio. Puoi poi personalizzare la tabella per soddisfare le tue esigenze utilizzando la funzione di assistente AI Copilot attraverso passaggi conversazionali.
   ...
   ![Campi suggeriti nella tua nuova tabella](../../../translated_images/it/copilot-dataverse-table-powerapps.f4cc07b5d5f9327b.png)
...
![Aggiungere un nuovo campo](../../../translated_images/it/copilot-new-column.35e15ff21acaf274.png)
...
![Aggiungere una nuova schermata tramite un'istruzione prompt](../../../translated_images/it/copilot-new-screen.2e0bef7132a17392.png)
...
![Seleziona nuova tabella](../../../translated_images/it/describe-new-table.0792373eb757281e.png)
...
![Descrivi la tabella](../../../translated_images/it/copilot-chat-prompt-dataverse.feb2f81e5872b9d2.png)
...
![Tabella Dataverse suggerita](../../../translated_images/it/copilot-dataverse-table.b3bc936091324d9d.png)
...
![Modelli AI Builder](../../../translated_images/it/ai-builder-models.8069423b84cfc47f.png)
...
2. Utilizza l'area di testo nella schermata principale per descrivere il flusso di lavoro che desideri creare. Ad esempio, **_Elabora una fattura quando arriva nella mia casella di posta_**. Clicca sul pulsante **Invia** per inviare il prompt al Copilot AI.
   ...
   ![Copilot Power Automate](../../../translated_images/it/copilot-chat-prompt-powerautomate.f377e478cc8412de.png)
...
8. Rimuovi l'azione **Condition** dal flusso perché non la utilizzerai. Dovrebbe apparire come nello screenshot seguente:
   ...
   ![Power Automate, rimuovi azioni](../../../translated_images/it/powerautomate-remove-actions.7216392fe684ceba.png)
...
11. Seleziona la **Tabella** che hai creato in precedenza. Ad esempio, puoi selezionare la tabella **Informazioni sulle fatture**. Scegli il contenuto dinamico dall'azione precedente per popolare i seguenti campi:
    ...
    ![Power Automate aggiungi riga](../../../translated_images/it/powerautomate-add-row.5edce45e5dd3d51e.png)
...
![Crea un prompt](../../../translated_images/it/create-prompt-gpt.69d429300c2e870a.png)
