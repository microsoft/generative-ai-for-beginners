...
[![생성형 AI와 대규모 언어 모델 소개](../../../translated_images/01-lesson-banner.2424cfd092f43366.ko.png)](https://youtu.be/lFXQkBvEe0o?si=6ZBcQTwLJJDpnX0K)
...
![다섯 명의 젊은 학생들이 모니터를 보고 있는 모습 - DALLE2 제작 이미지](../../../translated_images/students-by-DALLE2.b70fddaced1042ee.ko.png)
...
![AI, ML, DL 및 생성형 AI](../../../translated_images/AI-diagram.c391fa518451a40d.ko.png)
...
![토크나이저 예시](../../../translated_images/tokenizer-example.80a5c151ee7d1bd4.ko.png)
...
- **출력 유형을 지정하는 지침**. 이 지침은 때로는 몇 가지 예제나 추가 데이터를 포함할 수 있습니다.
  ...
  1. 기사, 책, 제품 리뷰 등의 요약 및 비정형 데이터에서 통찰력 추출.
    ...
    ![요약 예시](../../../translated_images/summarization-example.7b7ff97147b3d790.ko.png)
  
  2. 기사, 에세이, 과제 등의 창의적 아이디어 및 디자인.
      
     ![창의적 글쓰기 예시](../../../translated_images/creative-writing-example.e24a685b5a543ad1.ko.png)

- **에이전트와의 대화 형태로 질문**.
  
  ![대화 예시](../../../translated_images/conversation-example.60c2afc0f595fa59.ko.png)

- **완성해야 할 텍스트 조각**, 이는 암묵적으로 글쓰기 지원 요청을 의미합니다.
  
  ![텍스트 완성 예시](../../../translated_images/text-completion-example.cbb0f28403d42752.ko.png)

- **코드 조각**과 함께 이를 설명하고 문서화하거나 특정 작업을 수행하는 코드 생성을 요청하는 주석.
  
  ![코딩 예시](../../../translated_images/coding-example.50ebabe8a6afff20.ko.png)
