...
[![다양한 LLM 탐구 및 비교](../../../translated_images/02-lesson-banner.ef94c84979f97f60.ko.png)](https://youtu.be/KIRUeDKscfI?si=8BHX1zvwzQBn-PlK)
...
![Foundation Models versus LLMs](../../../translated_images/FoundationModel.e4859dbb7a825c94.ko.png)
...
![Foundation Model](../../../translated_images/Multimodal.2c389c6439e0fc51.ko.png)
...
![Embedding](../../../translated_images/Embedding.c3708fe988ccf760.ko.png)
...
![Image generation](../../../translated_images/Image.349c080266a763fd.ko.png)
...
![Text and code generation](../../../translated_images/Text.a8c0cf139e5cc2a0.ko.png)
...
![모델 카탈로그](../../../translated_images/AzureAIStudioModelCatalog.3cf8a499aa8ba031.ko.png)

- 모델 카드 검토: 사용 의도와 학습 데이터, 코드 샘플, 내부 평가 라이브러리의 평가 결과에 대한 자세한 설명을 포함합니다.

![모델 카드](../../../translated_images/ModelCard.598051692c6e400d.ko.png)
...
![모델 벤치마크](../../../translated_images/ModelBenchmarks.254cb20fbd06c03a.ko.png)

- 특정 작업에서 모델 성능을 향상시키기 위해 사용자 지정 학습 데이터를 사용하여 모델을 미세 조정할 수 있습니다. Azure AI Studio의 실험 및 추적 기능을 활용합니다.

![모델 미세 조정](../../../translated_images/FineTuning.aac48f07142e36fd.ko.png)
...
![모델 배포](../../../translated_images/ModelDeploy.890da48cbd0bccdb.ko.png)
...
![LLMs 배포](../../../translated_images/Deploy.18b2d27412ec8c02.ko.png)
