...
[![다양한 LLM 탐구 및 비교](../../../translated_images/ko/02-lesson-banner.ef94c84979f97f60.png)](https://youtu.be/KIRUeDKscfI?si=8BHX1zvwzQBn-PlK)
...
![Foundation Models versus LLMs](../../../translated_images/ko/FoundationModel.e4859dbb7a825c94.png)
...
![Foundation Model](../../../translated_images/ko/Multimodal.2c389c6439e0fc51.png)
...
![Embedding](../../../translated_images/ko/Embedding.c3708fe988ccf760.png)
...
![Image generation](../../../translated_images/ko/Image.349c080266a763fd.png)
...
![Text and code generation](../../../translated_images/ko/Text.a8c0cf139e5cc2a0.png)
...
![모델 카탈로그](../../../translated_images/ko/AzureAIStudioModelCatalog.3cf8a499aa8ba031.png)

- 모델 카드 검토: 사용 의도와 학습 데이터, 코드 샘플, 내부 평가 라이브러리의 평가 결과에 대한 자세한 설명을 포함합니다.

![모델 카드](../../../translated_images/ko/ModelCard.598051692c6e400d.png)
...
![모델 벤치마크](../../../translated_images/ko/ModelBenchmarks.254cb20fbd06c03a.png)

- 특정 작업에서 모델 성능을 향상시키기 위해 사용자 지정 학습 데이터를 사용하여 모델을 미세 조정할 수 있습니다. Azure AI Studio의 실험 및 추적 기능을 활용합니다.

![모델 미세 조정](../../../translated_images/ko/FineTuning.aac48f07142e36fd.png)
...
![모델 배포](../../../translated_images/ko/ModelDeploy.890da48cbd0bccdb.png)
...
![LLMs 배포](../../../translated_images/ko/Deploy.18b2d27412ec8c02.png)
