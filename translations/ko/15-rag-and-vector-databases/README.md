...
[![검색 증강 생성(RAG) 및 벡터 데이터베이스](../../../translated_images/15-lesson-banner.ac49e59506175d4f.ko.png)](https://youtu.be/4l8zhHUBeyI?si=BmvDmL1fnHtgQYkL)
...
![RAG의 작동 방식을 보여주는 그림](../../../translated_images/how-rag-works.f5d0ff63942bd3a6.ko.png)
...
![RAG의 아키텍처를 보여주는 그림](../../../translated_images/encoder-decode.f2658c25d0eadee2.ko.png)
...
![단어 cat의 임베딩](../../../translated_images/cat.74cbd7946bc9ca38.ko.png)
